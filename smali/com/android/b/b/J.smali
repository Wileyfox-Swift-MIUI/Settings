...
# instance fields
.field private final aLk:Ljava/util/List;

.field private final aLl:Lcom/android/b/b/R;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/b/b/R;)V
    ...
    iput-object v0, p0, Lcom/android/b/b/J;->aLk:Ljava/util/List;

    .line 41
    iput-object p1, p0, Lcom/android/b/b/J;->mContext:Landroid/content/Context;

    .line 42
    iput-object p2, p0, Lcom/android/b/b/J;->aLl:Lcom/android/b/b/R;
...
# virtual methods
.method public declared-synchronized AQ()Ljava/util/Collection;
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/b/b/J;->aLk:Ljava/util/List;
...
.method public declared-synchronized AR()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/b/b/J;->aLk:Ljava/util/List;
...
.method public a(Lcom/android/b/b/Q;Lcom/android/b/b/U;Landroid/bluetooth/BluetoothDevice;)Lcom/android/b/b/H;
    ...
    .line 92
    :try_start_0
    iget-object v2, p0, Lcom/android/b/b/J;->aLk:Ljava/util/List;

    invoke-interface {v2, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 93
    iget-object v2, p0, Lcom/android/b/b/J;->aLl:Lcom/android/b/b/R;

    invoke-virtual {v2}, Lcom/android/b/b/R;->Bb()Lcom/android/b/b/t;
...
.method public declared-synchronized aC(Z)V
    .locals 3
...
.method public declared-synchronized bl(I)V
    ...
    .line 174
    :cond_0
    invoke-virtual {v0}, Lcom/android/b/b/H;->Ar()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public i(Lcom/android/b/b/H;)V
    ...
    .line 101
    invoke-virtual {p1}, Lcom/android/b/b/H;->Av()S
...
.method public o(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 57
    invoke-virtual {v0}, Lcom/android/b/b/H;->At()V
...
.method public declared-synchronized r(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 150
    invoke-virtual {v0}, Lcom/android/b/b/H;->Az()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized s(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 157
    invoke-virtual {v0}, Lcom/android/b/b/H;->AA()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
