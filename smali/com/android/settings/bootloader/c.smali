...
# static fields
.field private static final Tn:Landroid/net/Uri;

.field private static final To:Landroid/net/Uri;

.field private static Tp:Lcom/android/settings/bootloader/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/bootloader/c;->Tn:Landroid/net/Uri;

    .line 35
    sget-object v0, Lcom/android/settings/bootloader/c;->Tn:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/android/settings/bootloader/c;->To:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/android/settings/bootloader/c;->Tp:Lcom/android/settings/bootloader/d;
...
.method private static a(Landroid/content/Context;Ljava/util/Map;)V
    ...
    .line 207
    :try_start_0
    invoke-static {p0}, Lcom/android/settings/bootloader/Utils;->aF(Landroid/content/Context;)Lcom/xiaomi/accountsdk/account/data/ExtendedAuthToken;

    move-result-object v0

    .line 208
    invoke-static {p0}, Lcom/android/settings/bootloader/Utils;->aG(Landroid/content/Context;)Ljava/lang/String;
...
.method private static a(Lmiui/cloud/net/XHttpClient$HttpResponse;)Z
    ...
    .line 92
    sget-object v0, Lcom/android/settings/bootloader/c;->Tp:Lcom/android/settings/bootloader/d;

    iput v4, v0, Lcom/android/settings/bootloader/d;->Tq:I
    ...
    iput v2, v0, Lcom/android/settings/bootloader/d;->Tq:I
    ...
    .line 110
    :cond_3
    sget-object v2, Lcom/android/settings/bootloader/c;->Tp:Lcom/android/settings/bootloader/d;

    const/4 v3, 0x4

    iput v3, v2, Lcom/android/settings/bootloader/d;->Tq:I
    ...
    iput-object v0, v2, Lcom/android/settings/bootloader/d;->Tr:Ljava/lang/String;
    :try_end_0
...
.method private static aA(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 121
    invoke-static {p0}, Lcom/android/settings/bootloader/Utils;->aD(Landroid/content/Context;)Ljava/lang/String;
...
.method private static aB(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 178
    sget-object v1, Lcom/android/settings/bootloader/c;->To:Landroid/net/Uri;
...
.method public static az(Landroid/content/Context;)Lcom/android/settings/bootloader/d;
    .locals 6
    ...
    iput v1, v0, Lcom/android/settings/bootloader/d;->Tq:I
    ...
    invoke-static {p0}, Lcom/android/settings/bootloader/c;->aB(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/settings/bootloader/Utils;->d([B)Ljava/lang/String;
