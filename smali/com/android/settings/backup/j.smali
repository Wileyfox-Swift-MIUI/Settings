...
.field private QK:Lcom/android/internal/widget/ILockSettings;
...
.method private lT()Lcom/android/internal/widget/ILockSettings;
    .locals 1

    .prologue
    .line 52
    iget-object v0, p0, Lcom/android/settings/backup/j;->QK:Lcom/android/internal/widget/ILockSettings;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/j;->QK:Lcom/android/internal/widget/ILockSettings;
...
.method public a(Lcom/android/settings/backup/SettingProtos$LockSetting;)Z
    ...
    .line 192
    :try_start_0
    invoke-direct {p0}, Lcom/android/settings/backup/j;->lT()Lcom/android/internal/widget/ILockSettings;
...
.method public aA(Ljava/lang/String;)Lcom/android/settings/backup/SettingProtos$SecureSetting;
    .locals 8
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/n;->aF(Ljava/lang/String;)Lcom/android/settings/backup/n;
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/n;->aG(Ljava/lang/String;)Lcom/android/settings/backup/n;
    :try_end_1
    ...
    :cond_2
    :goto_3
    invoke-virtual {v7}, Lcom/android/settings/backup/n;->mB()Lcom/android/settings/backup/SettingProtos$SecureSetting;
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/n;->aH(Ljava/lang/String;)Lcom/android/settings/backup/n;
    :try_end_3
...
.method public az(Ljava/lang/String;)Lcom/android/settings/backup/SettingProtos$SystemSetting;
    .locals 8
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/r;->aJ(Ljava/lang/String;)Lcom/android/settings/backup/r;
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/r;->aK(Ljava/lang/String;)Lcom/android/settings/backup/r;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_2
    :goto_3
    invoke-virtual {v7}, Lcom/android/settings/backup/r;->nd()Lcom/android/settings/backup/SettingProtos$SystemSetting;
    ...
    invoke-virtual {v7, v2}, Lcom/android/settings/backup/r;->aL(Ljava/lang/String;)Lcom/android/settings/backup/r;
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public b(Ljava/util/HashMap;)V
    ...
    .prologue
    .line 260
    iput-object p1, p0, Lcom/android/settings/backup/j;->QJ:Ljava/util/HashMap;

    .line 261
    return-void
.end method

.method public bc(I)Ljava/io/File;
    .locals 3
...
.method public lU()Ljava/util/Vector;
    .locals 6
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings/backup/l;->aD(Ljava/lang/String;)Lcom/android/settings/backup/l;

    .line 142
    int-to-long v4, v0

    invoke-virtual {v2, v4, v5}, Lcom/android/settings/backup/l;->m(J)Lcom/android/settings/backup/l;

    .line 143
    invoke-virtual {v2}, Lcom/android/settings/backup/l;->mp()Lcom/android/settings/backup/SettingProtos$LockSetting;
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/backup/l;->aD(Ljava/lang/String;)Lcom/android/settings/backup/l;

    .line 148
    invoke-virtual {v0, v2, v3}, Lcom/android/settings/backup/l;->m(J)Lcom/android/settings/backup/l;

    .line 149
    invoke-virtual {v0}, Lcom/android/settings/backup/l;->mp()Lcom/android/settings/backup/SettingProtos$LockSetting;
...
.method public lV()Ljava/util/Vector;
    .locals 8
...
.method public lW()Ljava/util/Vector;
    .locals 8
...
.method public lX()V
    ...
    .line 264
    sget-object v2, Lcom/android/settings/backup/h;->QC:[Lcom/android/settings/backup/A;
    ...
    .line 265
    iget-object v0, p0, Lcom/android/settings/backup/j;->QJ:Ljava/util/HashMap;

    iget-object v5, v4, Lcom/android/settings/backup/A;->QW:Ljava/lang/String;
    ...
    .line 273
    iget-object v0, v4, Lcom/android/settings/backup/A;->QX:Ljava/lang/String;
    ...
    iget-object v6, v4, Lcom/android/settings/backup/A;->QX:Ljava/lang/String;
...
.method public lY()V
    ...
    .line 289
    invoke-virtual {v0, v1}, Lcom/android/settings/backup/i;->g(Ljava/io/File;)Z

    .line 290
    iget-object v1, v0, Lcom/android/settings/backup/i;->QD:Ljava/lang/String;
    ...
    .line 291
    iget-object v1, v0, Lcom/android/settings/backup/i;->QE:Ljava/lang/String;
    ...
    .line 292
    iget-object v1, v0, Lcom/android/settings/backup/i;->QF:Ljava/lang/String;
    ...
    .line 293
    iget-object v1, v0, Lcom/android/settings/backup/i;->QG:Ljava/lang/String;
    ...
    .line 294
    iget-object v0, v0, Lcom/android/settings/backup/i;->QH:Ljava/lang/String;
