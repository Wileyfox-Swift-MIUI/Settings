...
.field private QS:Lcom/android/settings/backup/j;

.field final synthetic QT:Lcom/android/settings/backup/t;

.field private Qo:Ljava/io/File;
...
.method private constructor <init>(Lcom/android/settings/backup/t;)V
    ...
    .prologue
    .line 181
    iput-object p1, p0, Lcom/android/settings/backup/v;->QT:Lcom/android/settings/backup/t;
...
.method public a(Landroid/os/ParcelFileDescriptor;)I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->QT:Lcom/android/settings/backup/t;

    iget-object v1, v1, Lcom/android/settings/backup/t;->QB:Lmiui/app/backup/FullBackupAgent;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->Qo:Ljava/io/File;

    .line 188
    iget-object v0, p0, Lcom/android/settings/backup/v;->Qo:Ljava/io/File;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;
    ...
    .line 194
    iget-object v0, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lV()Ljava/util/Vector;

    move-result-object v0

    .line 195
    iget-object v2, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v2}, Lcom/android/settings/backup/j;->lW()Ljava/util/Vector;

    move-result-object v2

    .line 196
    iget-object v3, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v3}, Lcom/android/settings/backup/j;->lU()Ljava/util/Vector;
    ...
    .line 199
    :try_start_0
    iget-object v5, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v5, v0}, Lcom/android/settings/backup/j;->az(Ljava/lang/String;)Lcom/android/settings/backup/SettingProtos$SystemSetting;
    ...
    .line 209
    :try_start_1
    iget-object v4, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v4, v0}, Lcom/android/settings/backup/j;->aA(Ljava/lang/String;)Lcom/android/settings/backup/SettingProtos$SecureSetting;
    ...
    .line 220
    :cond_5
    invoke-static {}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->nl()Lcom/android/settings/backup/y;

    move-result-object v0

    .line 221
    invoke-virtual {v1}, Lcom/android/settings/backup/p;->mP()Lcom/android/settings/backup/SettingProtos$Settings;
    ...
    .line 225
    :try_start_3
    invoke-virtual {v0}, Lcom/android/settings/backup/y;->nr()Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
    ...
    .line 233
    :cond_6
    sget-object v1, Lcom/android/settings/backup/h;->QC:[Lcom/android/settings/backup/A;
    ...
    .line 234
    iget-object v4, p0, Lcom/android/settings/backup/v;->QT:Lcom/android/settings/backup/t;

    iget-object v4, v4, Lcom/android/settings/backup/t;->QB:Lmiui/app/backup/FullBackupAgent;

    iget-object v3, v3, Lcom/android/settings/backup/A;->QX:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/backup/j;->bc(I)Ljava/io/File;
    ...
    iget-object v2, p0, Lcom/android/settings/backup/v;->Qo:Ljava/io/File;

    const-string v3, "settings_descript.xml"

    invoke-direct {v1, v2, v3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Lcom/android/settings/backup/i;->f(Ljava/io/File;)V

    .line 245
    iget-object v0, p0, Lcom/android/settings/backup/v;->QT:Lcom/android/settings/backup/t;

    iget-object v0, v0, Lcom/android/settings/backup/t;->QB:Lmiui/app/backup/FullBackupAgent;
...
.method public a(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;)I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->Qo:Ljava/io/File;
    ...
    :cond_2
    :try_start_6
    iget-object v2, p0, Lcom/android/settings/backup/v;->QJ:Ljava/util/HashMap;
...
.method public b(Landroid/os/ParcelFileDescriptor;)I
    ...
    .line 271
    invoke-virtual {v0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->nk()Lcom/android/settings/backup/SettingProtos$Settings;
    :try_end_1
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v2}, Lcom/android/settings/backup/SettingProtos$Settings;->mG()Ljava/util/List;
    ...
    :cond_4
    :try_start_5
    invoke-virtual {v2}, Lcom/android/settings/backup/SettingProtos$Settings;->mH()Ljava/util/List;
    ...
    .line 290
    :cond_5
    invoke-virtual {v2}, Lcom/android/settings/backup/SettingProtos$Settings;->mI()Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->QJ:Ljava/util/HashMap;
...
.method public ng()I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->QJ:Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lX()V

    .line 352
    iget-object v0, p0, Lcom/android/settings/backup/v;->QS:Lcom/android/settings/backup/j;

    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lY()V
