...
.field public final ajE:Lcom/android/settings/location/InjectedSetting;

.field public final ajF:Landroid/preference/Preference;
...
.method private constructor <init>(Lcom/android/settings/location/SettingsInjector;Lcom/android/settings/location/InjectedSetting;Landroid/preference/Preference;)V
    ...
    .prologue
    .line 435
    iput-object p1, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajD:Lcom/android/settings/location/SettingsInjector;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 436
    iput-object p2, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;

    .line 437
    iput-object p3, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajF:Landroid/preference/Preference;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;

    check-cast p1, Lcom/android/settings/location/SettingsInjector$Setting;

    iget-object v1, p1, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;
...
.method public sr()V
    ...
    .line 483
    iget-object v2, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;

    invoke-virtual {v2}, Lcom/android/settings/location/InjectedSetting;->sm()Landroid/content/Intent;
    ...
    iget-object v4, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;
    ...
    .line 496
    :goto_0
    iget-object v0, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajD:Lcom/android/settings/location/SettingsInjector;
    ...
    iget-object v1, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajE:Lcom/android/settings/location/InjectedSetting;

    iget-object v1, v1, Lcom/android/settings/location/InjectedSetting;->CL:Landroid/os/UserHandle;
...
.method public st()V
    ...
    .line 506
    invoke-virtual {p0}, Lcom/android/settings/location/SettingsInjector$Setting;->ss()J
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/location/SettingsInjector$Setting;->ajF:Landroid/preference/Preference;
