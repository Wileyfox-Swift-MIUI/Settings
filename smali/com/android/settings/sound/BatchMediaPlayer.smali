...
# instance fields
.field private asT:Lcom/android/settings/sound/a;

.field private asU:Landroid/media/AudioManager;

.field private asV:Lcom/android/settings/sound/v;

.field private asW:Ljava/util/ArrayList;

.field private asX:I

.field private asY:Lcom/android/settings/sound/BatchMediaPlayer$PlayState;

.field private final asZ:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 29
    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asT:Lcom/android/settings/sound/a;

    .line 31
    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asU:Landroid/media/AudioManager;

    .line 33
    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asV:Lcom/android/settings/sound/v;
    ...
    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asW:Ljava/util/ArrayList;

    .line 37
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asX:I

    .line 43
    sget-object v0, Lcom/android/settings/sound/BatchMediaPlayer$PlayState;->atb:Lcom/android/settings/sound/BatchMediaPlayer$PlayState;

    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asY:Lcom/android/settings/sound/BatchMediaPlayer$PlayState;
    ...
    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asZ:Ljava/lang/Runnable;
    ...
    .line 58
    invoke-direct {p0}, Lcom/android/settings/sound/BatchMediaPlayer;->vf()V
...
.method static synthetic a(Lcom/android/settings/sound/BatchMediaPlayer;)V
    ...
    .prologue
    .line 14
    invoke-direct {p0}, Lcom/android/settings/sound/BatchMediaPlayer;->vg()V
...
.method static synthetic b(Lcom/android/settings/sound/BatchMediaPlayer;)Ljava/lang/Runnable;
    ...
    .prologue
    .line 14
    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asZ:Ljava/lang/Runnable;
...
.method static synthetic e(Lcom/android/settings/sound/BatchMediaPlayer;)V
    ...
    .prologue
    .line 14
    invoke-direct {p0}, Lcom/android/settings/sound/BatchMediaPlayer;->vh()V
...
.method private vf()V
    ...
    .line 63
    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asT:Lcom/android/settings/sound/a;
...
.method private vg()V
    ...
    .line 145
    :try_start_0
    iget v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asX:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asX:I

    iget-object v1, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asW:Ljava/util/ArrayList;
    ...
    .line 146
    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asW:Ljava/util/ArrayList;

    iget v1, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asX:I
    ...
    invoke-static {v0}, Lcom/android/settings/sound/p;->cb(Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 148
    iget-object v2, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asT:Lcom/android/settings/sound/a;
...
.method private vh()V
    ...
    .line 162
    :cond_0
    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asU:Landroid/media/AudioManager;
    ...
    .line 166
    sget-object v0, Lcom/android/settings/sound/BatchMediaPlayer$PlayState;->atc:Lcom/android/settings/sound/BatchMediaPlayer$PlayState;

    iput-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asY:Lcom/android/settings/sound/BatchMediaPlayer$PlayState;

    .line 167
    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asV:Lcom/android/settings/sound/v;

    if-eqz v0, :cond_2

    .line 168
    iget-object v1, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asV:Lcom/android/settings/sound/v;

    iget-object v0, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asW:Ljava/util/ArrayList;

    iget v2, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asX:I
...
.method public a(Lcom/android/settings/sound/v;)V
    ...
    .prologue
    .line 98
    iput-object p1, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asV:Lcom/android/settings/sound/v;
...
.method public stop(I)V
    ...
    iget-object v1, p0, Lcom/android/settings/sound/BatchMediaPlayer;->asZ:Ljava/lang/Runnable;
    ...
    invoke-interface {v0, p1}, Lcom/android/settings/sound/v;->ck(I)V
