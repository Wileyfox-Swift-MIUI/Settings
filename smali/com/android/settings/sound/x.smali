...
# instance fields
.field private ate:Lcom/android/settings/sound/DataCache;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/sound/x;->ate:Lcom/android/settings/sound/DataCache;
...
.method protected a(Ljava/lang/String;Lcom/android/settings/sound/z;)Lcom/android/settings/sound/y;
    ...
    .line 121
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/sound/x;->vj()Lcom/android/settings/sound/y;
    ...
    iput-wide v2, v0, Lcom/android/settings/sound/y;->asR:J
...
.method protected a(Lcom/android/settings/sound/z;)Z
    ...
    .line 67
    :goto_0
    iget-wide v8, p1, Lcom/android/settings/sound/z;->asR:J

    cmp-long v2, v8, v4

    if-nez v2, :cond_0

    iget v2, p1, Lcom/android/settings/sound/z;->atf:I
    ...
    .line 77
    :cond_5
    iget-object v0, p1, Lcom/android/settings/sound/z;->atg:Ljava/util/Map;
    ...
    .line 82
    iget-wide v8, v0, Lcom/android/settings/sound/y;->asR:J
...
.method public cf(Ljava/lang/String;)Lcom/android/settings/sound/z;
    .locals 3

    .prologue
    .line 40
    invoke-static {p1}, Lcom/android/settings/sound/w;->ce(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .line 41
    iget-object v0, p0, Lcom/android/settings/sound/x;->ate:Lcom/android/settings/sound/DataCache;
    ...
    .line 45
    invoke-virtual {p0, v1}, Lcom/android/settings/sound/x;->ch(Ljava/lang/String;)Lcom/android/settings/sound/z;
    ...
    .line 47
    iget-object v2, p0, Lcom/android/settings/sound/x;->ate:Lcom/android/settings/sound/DataCache;
...
.method public cg(Ljava/lang/String;)Z
    ...
    .line 57
    iget-object v1, p0, Lcom/android/settings/sound/x;->ate:Lcom/android/settings/sound/DataCache;
...
.method protected ch(Ljava/lang/String;)Lcom/android/settings/sound/z;
    .locals 6
    ...
    .line 96
    invoke-virtual {p0}, Lcom/android/settings/sound/x;->vi()Lcom/android/settings/sound/z;
    ...
    iput-wide v4, v2, Lcom/android/settings/sound/z;->asR:J
    ...
    :goto_0
    iput v0, v2, Lcom/android/settings/sound/z;->atf:I

    .line 102
    new-instance v0, Ljava/util/HashMap;

    iget v4, v2, Lcom/android/settings/sound/z;->atf:I

    invoke-direct {v0, v4}, Ljava/util/HashMap;-><init>(I)V

    iput-object v0, v2, Lcom/android/settings/sound/z;->atg:Ljava/util/Map;
    ...
    .line 108
    iget-object v5, v2, Lcom/android/settings/sound/z;->atg:Ljava/util/Map;
...
.method protected vi()Lcom/android/settings/sound/z;
    .locals 1
...
.method protected vj()Lcom/android/settings/sound/y;
    .locals 1
