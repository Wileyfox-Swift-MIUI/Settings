...
.field private ab:Landroid/os/UserHandle;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ac:Landroid/content/ComponentName;
    ...
    .line 59
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ad:Landroid/appwidget/AppWidgetManager;

    iget v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->mAppWidgetId:I

    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ab:Landroid/os/UserHandle;

    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ac:Landroid/content/ComponentName;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;
    ...
    .line 72
    iget-object v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ad:Landroid/appwidget/AppWidgetManager;
    ...
    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ac:Landroid/content/ComponentName;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ab:Landroid/os/UserHandle;

    .line 98
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ab:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ac:Landroid/content/ComponentName;
    ...
    .line 126
    sget v3, Lcom/android/internal/R$layout;->always_use_checkbox:I
    ...
    sget v2, Lcom/android/internal/R$id;->alwaysUse:I
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;
    ...
    iget-object v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;

    invoke-virtual {v1}, Landroid/widget/CheckBox;->getPaddingLeft()I

    move-result v1

    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;

    invoke-virtual {v2}, Landroid/widget/CheckBox;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;

    invoke-virtual {v3}, Landroid/widget/CheckBox;->getPaddingRight()I

    move-result v3

    iget-object v4, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aa:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ad:Landroid/appwidget/AppWidgetManager;
    ...
    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ab:Landroid/os/UserHandle;
    ...
    .line 109
    iput-object v5, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ac:Landroid/content/ComponentName;
...
.method protected onPause()V
    ...
    iget-boolean v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Z
