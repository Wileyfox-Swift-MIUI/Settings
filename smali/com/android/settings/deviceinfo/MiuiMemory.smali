...
.super Lcom/android/settings/deviceinfo/PrivateVolumeSettings;
...
# instance fields
.field private Xm:Landroid/preference/ListPreference;

.field private final Xn:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>()V
    ...
    .prologue
    .line 52
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;-><init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xn:Landroid/content/BroadcastReceiver;
...
.method static synthetic a(Lcom/android/settings/deviceinfo/MiuiMemory;)V
    ...
    .prologue
    .line 52
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/MiuiMemory;->pA()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 63
    invoke-super {p0, p1}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;->onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xm:Landroid/preference/ListPreference;

    .line 66
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xm:Landroid/preference/ListPreference;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 134
    invoke-super {p0, p1}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
...
.method public onPause()V
    ...
    .prologue
    .line 97
    invoke-super {p0}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;->onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xn:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 106
    iget-object v1, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xm:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 145
    :cond_0
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Yb:Ljava/util/List;
    ...
    .line 146
    invoke-virtual {v0}, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->pC()Landroid/os/storage/VolumeInfo;
    ...
    .line 152
    invoke-virtual {v0, p2}, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->f(Landroid/preference/Preference;)Z
    ...
    .line 160
    :cond_3
    invoke-virtual {v0, p2}, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->g(Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/MiuiMemory;->getContext()Landroid/content/Context;

    move-result-object v3

    const-class v4, Lcom/android/settings/deviceinfo/StorageWizardFormatConfirm;
    ...
    .line 164
    invoke-virtual {p0, v0}, Lcom/android/settings/deviceinfo/MiuiMemory;->startActivity(Landroid/content/Intent;)V

    goto :goto_1

    .line 170
    :cond_4
    invoke-super {p0, p1, p2}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;->onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
...
.method public onResume()V
    ...
    .prologue
    .line 77
    invoke-super {p0}, Lcom/android/settings/deviceinfo/PrivateVolumeSettings;->onResume()V
    ...
    iget-object v2, p0, Lcom/android/settings/deviceinfo/MiuiMemory;->Xn:Landroid/content/BroadcastReceiver;
