...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;)I
    ...
    .prologue
    .line 33
    iget v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->ZG:I
...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;I)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 33
    invoke-direct {p0, p1}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->bF(I)Ljava/lang/CharSequence;
...
.method private bF(I)Ljava/lang/CharSequence;
    .locals 1
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 39
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->Xq:Landroid/os/storage/VolumeInfo;
    ...
    iput v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->ZG:I
    ...
    .line 47
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->Xi:Landroid/os/storage/StorageManager;

    iget-object v2, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->Xq:Landroid/os/storage/VolumeInfo;
    ...
    .line 49
    invoke-virtual {p0, v4}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->aL(Z)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->a(I[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->b(I[Ljava/lang/String;)V

    .line 53
    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->getNextButton()Landroid/widget/Button;
    ...
    iget v1, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->ZG:I

    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v2

    iget v3, p0, Lcom/android/settings/deviceinfo/StorageWizardMoveProgress;->ZG:I
