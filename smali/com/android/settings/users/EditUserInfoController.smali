...
# instance fields
.field private avB:Landroid/os/UserHandle;

.field private awc:Landroid/app/Dialog;

.field private awd:Landroid/graphics/Bitmap;

.field private awe:Lcom/android/settings/users/EditUserPhotoController;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/users/EditUserInfoController;->awf:Z
...
.method static synthetic a(Lcom/android/settings/users/EditUserInfoController;)Landroid/os/UserHandle;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->avB:Landroid/os/UserHandle;
...
.method static synthetic b(Lcom/android/settings/users/EditUserInfoController;)Landroid/os/UserManager;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->tE:Landroid/os/UserManager;
...
.method static synthetic c(Lcom/android/settings/users/EditUserInfoController;)Lcom/android/settings/users/EditUserPhotoController;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awe:Lcom/android/settings/users/EditUserPhotoController;
...
.method public a(Landroid/app/Fragment;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ILcom/android/settings/users/EditUserInfoController$OnContentChangedCallback;Landroid/os/UserHandle;)Landroid/app/Dialog;
    ...
    .line 106
    iput-object p6, p0, Lcom/android/settings/users/EditUserInfoController;->avB:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->tE:Landroid/os/UserManager;
    ...
    iget-object v1, p0, Lcom/android/settings/users/EditUserInfoController;->avB:Landroid/os/UserHandle;
    ...
    .line 120
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awd:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Lcom/android/settings/users/EditUserInfoController;->awd:Landroid/graphics/Bitmap;

    iget-boolean v5, p0, Lcom/android/settings/users/EditUserInfoController;->awf:Z
    ...
    iput-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awe:Lcom/android/settings/users/EditUserPhotoController;
    ...
    iput-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awc:Landroid/app/Dialog;

    .line 183
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awc:Landroid/app/Dialog;
    ...
    invoke-static {v7, v0, v1}, Lcom/android/settings/iH;->a(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
...
.method public clear()V
    ...
    .line 65
    iput-object v0, p0, Lcom/android/settings/users/EditUserInfoController;->awd:Landroid/graphics/Bitmap;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/android/settings/users/EditUserInfoController;->awe:Lcom/android/settings/users/EditUserPhotoController;
    ...
    .line 83
    :cond_0
    iget-boolean v0, p0, Lcom/android/settings/users/EditUserInfoController;->awf:Z
    ...
    iget-boolean v1, p0, Lcom/android/settings/users/EditUserInfoController;->awf:Z
