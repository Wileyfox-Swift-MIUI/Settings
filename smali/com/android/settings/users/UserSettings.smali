...
# instance fields
.field private awA:Lcom/android/settings/users/EditUserInfoController;

.field private awO:Landroid/preference/PreferenceGroup;

.field private awP:Lcom/android/settings/users/UserPreference;

.field private awQ:Lcom/android/settings/hp;

.field private awR:Landroid/preference/Preference;
...
.field private awV:Lcom/android/settings/users/UserSettings$UserCapabilities;

.field private final awW:Ljava/lang/Object;

.field private awX:Landroid/util/SparseArray;

.field private awY:Landroid/graphics/drawable/Drawable;

.field private awZ:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/users/UserSettings;->ix:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/users/UserSettings;->awS:I

    .line 137
    const/4 v0, 0x0

    iput v0, p0, Lcom/android/settings/users/UserSettings;->awT:I
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awW:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awX:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awA:Lcom/android/settings/users/EditUserInfoController;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awZ:Landroid/content/BroadcastReceiver;
...
.method private a(Landroid/content/pm/UserInfo;)V
    ...
    invoke-static {v0, p1}, Lcom/android/settings/iH;->a(Landroid/content/Context;Landroid/content/pm/UserInfo;)Z
...
.method private a(Landroid/preference/Preference;Landroid/content/pm/UserInfo;)V
    ...
    .prologue
    .line 909
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awX:Landroid/util/SparseArray;
    ...
    .line 911
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->b(Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wt()V
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;I)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->dh(I)V
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;IZ)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1, p2}, Lcom/android/settings/users/UserSettings;->n(IZ)V
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;Landroid/content/pm/UserInfo;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->a(Landroid/content/pm/UserInfo;)V
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;Ljava/lang/String;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->cp(Ljava/lang/String;)V
...
.method static synthetic a(Lcom/android/settings/users/UserSettings;Z)Z
    ...
    .prologue
    .line 88
    iput-boolean p1, p0, Lcom/android/settings/users/UserSettings;->awU:Z
...
.method static synthetic b(Lcom/android/settings/users/UserSettings;I)I
    ...
    .prologue
    .line 88
    iput p1, p0, Lcom/android/settings/users/UserSettings;->awS:I
...
.method private b(Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1}, Lcom/android/settings/c/a;->a(Landroid/content/Context;Landroid/graphics/Bitmap;)Lcom/android/settings/c/a;
...
.method private b(Landroid/content/pm/UserInfo;)V
    ...
    invoke-static {v0}, Lcom/android/settings/iH;->au(I)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 898
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->tE:Landroid/os/UserManager;
...
.method static synthetic c(Lcom/android/settings/users/UserSettings;I)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->di(I)V
...
.method private cp(Ljava/lang/String;)V
    ...
    .line 347
    :cond_1
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awP:Lcom/android/settings/users/UserPreference;
    ...
    .line 351
    iget-object v2, p0, Lcom/android/settings/users/UserSettings;->awP:Lcom/android/settings/users/UserPreference;

    invoke-direct {p0, v1}, Lcom/android/settings/users/UserSettings;->b(Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    ...
    .line 352
    iget-object v2, p0, Lcom/android/settings/users/UserSettings;->awX:Landroid/util/SparseArray;
...
.method static synthetic d(Lcom/android/settings/users/UserSettings;)Landroid/os/UserManager;
    ...
    .prologue
    .line 88
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->tE:Landroid/os/UserManager;
...
.method static synthetic d(Lcom/android/settings/users/UserSettings;I)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->dj(I)V
...
.method private df(I)V
    ...
    .prologue
    .line 382
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->awW:Ljava/lang/Object;

    monitor-enter v1

    .line 383
    :try_start_0
    iget v0, p0, Lcom/android/settings/users/UserSettings;->awS:I

    const/4 v2, -0x1

    if-ne v0, v2, :cond_0

    iget-boolean v0, p0, Lcom/android/settings/users/UserSettings;->awU:Z
    ...
    :pswitch_1
    :try_start_1
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wm()Z
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->di(I)V
...
.method private dh(I)V
    ...
    .prologue
    .line 477
    iput p1, p0, Lcom/android/settings/users/UserSettings;->awT:I
...
.method private di(I)V
    ...
    :try_start_0
    iput-boolean v0, p0, Lcom/android/settings/users/UserSettings;->awU:Z
...
.method static synthetic e(Lcom/android/settings/users/UserSettings;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wq()V
...
.method static synthetic e(Lcom/android/settings/users/UserSettings;I)V
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1}, Lcom/android/settings/users/UserSettings;->df(I)V
...
.method static synthetic f(Lcom/android/settings/users/UserSettings;)I
    ...
    .prologue
    .line 88
    iget v0, p0, Lcom/android/settings/users/UserSettings;->awT:I
...
.method static synthetic g(Lcom/android/settings/users/UserSettings;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wn()V
...
.method static synthetic h(Lcom/android/settings/users/UserSettings;)V
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->ws()V
...
.method static synthetic i(Lcom/android/settings/users/UserSettings;)Ljava/lang/Object;
    ...
    .prologue
    .line 88
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awW:Ljava/lang/Object;
...
.method static synthetic k(Lcom/android/settings/users/UserSettings;)Landroid/content/pm/UserInfo;
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wp()Landroid/content/pm/UserInfo;
...
.method static synthetic l(Lcom/android/settings/users/UserSettings;)Landroid/content/pm/UserInfo;
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wo()Landroid/content/pm/UserInfo;
...
.method private n(IZ)V
    ...
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awV:Lcom/android/settings/users/UserSettings$UserCapabilities;

    iget-boolean v0, v0, Lcom/android/settings/users/UserSettings$UserCapabilities;->axg:Z
    ...
    .line 462
    invoke-static {p0}, Lcom/android/settings/OwnerInfoSettings;->e(Landroid/app/Fragment;)V
...
.method private setUserName(Ljava/lang/String;)V
    ...
    .line 917
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awQ:Lcom/android/settings/hp;

    invoke-virtual {v0, p1}, Lcom/android/settings/hp;->setSummary(Ljava/lang/CharSequence;)V
...
.method private wl()V
    ...
    iget-boolean v0, v0, Lcom/android/settings/users/UserSettings$UserCapabilities;->axh:Z
    ...
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wv()Landroid/graphics/drawable/Drawable;
...
.method private wo()Landroid/content/pm/UserInfo;
    .locals 7
    ...
    .line 415
    iget-object v4, p0, Lcom/android/settings/users/UserSettings;->tE:Landroid/os/UserManager;
    ...
    .line 420
    iget-object v2, p0, Lcom/android/settings/users/UserSettings;->tE:Landroid/os/UserManager;
    ...
    .line 421
    invoke-direct {p0, v1}, Lcom/android/settings/users/UserSettings;->b(Landroid/content/pm/UserInfo;)V
...
.method private wp()Landroid/content/pm/UserInfo;
    .locals 3
    ...
    .line 437
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->b(Landroid/content/pm/UserInfo;)V
...
.method private wq()V
    ...
    .line 640
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wr()V
...
.method private wt()V
    ...
    .line 716
    invoke-static {v1}, Lcom/android/settings/iH;->Y(Landroid/content/Context;)Z
    ...
    .line 719
    iget-object v3, p0, Lcom/android/settings/users/UserSettings;->awP:Lcom/android/settings/users/UserPreference;
    ...
    .line 766
    :goto_2
    invoke-direct {p0, v6}, Lcom/android/settings/users/UserSettings;->c(Landroid/content/pm/UserInfo;)Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/users/UserPreference;->setSummary(I)V
    ...
    .line 776
    iget-object v3, p0, Lcom/android/settings/users/UserSettings;->awX:Landroid/util/SparseArray;
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/users/UserPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/users/UserPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/users/UserPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 793
    invoke-virtual {v0, v8}, Lcom/android/settings/users/UserPreference;->setEnabled(Z)V
    ...
    iget-boolean v0, v0, Lcom/android/settings/users/UserSettings$UserCapabilities;->axi:Z

    if-nez v0, :cond_11

    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wx()Landroid/content/pm/UserInfo;
    ...
    iget-object v4, p0, Lcom/android/settings/users/UserSettings;->awV:Lcom/android/settings/users/UserSettings$UserCapabilities;

    iget-boolean v4, v4, Lcom/android/settings/users/UserSettings$UserCapabilities;->axg:Z
    ...
    .line 812
    :cond_12
    sget-object v0, Lcom/android/settings/users/UserPreference;->awL:Ljava/util/Comparator;
    ...
    .line 818
    invoke-direct {p0, v10}, Lcom/android/settings/users/UserSettings;->D(Ljava/util/List;)V
    ...
    iget-boolean v0, v0, Lcom/android/settings/users/UserSettings$UserCapabilities;->axf:Z

    if-eqz v0, :cond_15

    .line 829
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awO:Landroid/preference/PreferenceGroup;
    ...
    .line 837
    invoke-virtual {v0, v14}, Lcom/android/settings/users/UserPreference;->setOrder(I)V
    ...
    iget-boolean v0, v0, Lcom/android/settings/users/UserSettings$UserCapabilities;->axe:Z
    ...
    .line 844
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->awR:Landroid/preference/Preference;
    ...
    .line 848
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awR:Landroid/preference/Preference;

    const v1, 0x7f0a092f

    new-array v2, v7, [Ljava/lang/Object;

    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wu()I
...
.method private wv()Landroid/graphics/drawable/Drawable;
    .locals 1

    .prologue
    .line 902
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awY:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awY:Landroid/graphics/drawable/Drawable;
...
.method private ww()V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->dj(I)V
...
.method private wx()Landroid/content/pm/UserInfo;
    .locals 3
...
.method public if()V
    ...
    .prologue
    .line 487
    invoke-super {p0}, Lcom/android/settings/SettingsPreferenceFragment;->if()V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 377
    :cond_1
    iget-object v0, p0, Lcom/android/settings/users/UserSettings;->awA:Lcom/android/settings/users/EditUserInfoController;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 998
    :pswitch_1
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->dg(I)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/users/UserSettings;->n(IZ)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 207
    invoke-static {v1}, Lcom/android/settings/users/UserSettings$UserCapabilities;->cx(Landroid/content/Context;)Lcom/android/settings/users/UserSettings$UserCapabilities;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awV:Lcom/android/settings/users/UserSettings$UserCapabilities;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->tE:Landroid/os/UserManager;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awO:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awP:Lcom/android/settings/users/UserPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserSettings;->awR:Landroid/preference/Preference;
    ...
    .line 234
    :cond_6
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->wl()V
    ...
    .line 238
    iget-object v4, p0, Lcom/android/settings/users/UserSettings;->awZ:Landroid/content/BroadcastReceiver;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget v1, p0, Lcom/android/settings/users/UserSettings;->awS:I
    ...
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->awP:Lcom/android/settings/users/UserPreference;

    invoke-virtual {v1}, Lcom/android/settings/users/UserPreference;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 284
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->awV:Lcom/android/settings/users/UserSettings$UserCapabilities;

    iget-boolean v1, v1, Lcom/android/settings/users/UserSettings$UserCapabilities;->axg:Z
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/users/UserSettings;->awZ:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 924
    iget-object v2, p0, Lcom/android/settings/users/UserSettings;->awV:Lcom/android/settings/users/UserSettings$UserCapabilities;

    iget-boolean v2, v2, Lcom/android/settings/users/UserSettings$UserCapabilities;->axh:Z
    ...
    .line 937
    invoke-direct {p0}, Lcom/android/settings/users/UserSettings;->ww()V
    ...
    .line 941
    invoke-direct {p0, v2}, Lcom/android/settings/users/UserSettings;->c(Landroid/content/pm/UserInfo;)Z
    ...
    .line 948
    :cond_6
    iget-object v2, p0, Lcom/android/settings/users/UserSettings;->awR:Landroid/preference/Preference;
    ...
    iget-boolean v2, v2, Lcom/android/settings/users/UserSettings$UserCapabilities;->axf:Z
    ...
    .line 954
    :cond_7
    invoke-direct {p0, v0}, Lcom/android/settings/users/UserSettings;->df(I)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Lcom/android/settings/users/UserSettings;->awT:I
...
.method public startActivityForResult(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v0}, Lcom/android/settings/users/EditUserInfoController;->wd()V
