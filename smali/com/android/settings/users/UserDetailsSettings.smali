...
# instance fields
.field private awF:Landroid/preference/SwitchPreference;

.field private awG:Landroid/preference/Preference;

.field private awH:Landroid/content/pm/UserInfo;

.field private awI:Z

.field private awJ:Landroid/os/Bundle;
...
.method bn(Z)V
    ...
    .line 139
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->awF:Landroid/preference/SwitchPreference;

    invoke-virtual {v2, p1}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 140
    iget-boolean v2, p0, Lcom/android/settings/users/UserDetailsSettings;->awI:Z

    if-eqz v2, :cond_2

    .line 141
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->awJ:Landroid/os/Bundle;
    ...
    .line 143
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awJ:Landroid/os/Bundle;
    ...
    .line 144
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->tE:Landroid/os/UserManager;
    ...
    .line 151
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->awJ:Landroid/os/Bundle;

    invoke-virtual {v0, v3}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    .line 152
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->tE:Landroid/os/UserManager;
    ...
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->awH:Landroid/content/pm/UserInfo;
    ...
    .line 157
    iget-object v4, p0, Lcom/android/settings/users/UserDetailsSettings;->tE:Landroid/os/UserManager;
    ...
    .line 159
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->tE:Landroid/os/UserManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->tE:Landroid/os/UserManager;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awF:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awG:Landroid/preference/Preference;
    ...
    iput-boolean v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awI:Z

    .line 91
    iget-boolean v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awI:Z
    ...
    iput-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->awH:Landroid/content/pm/UserInfo;

    .line 98
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->awF:Landroid/preference/SwitchPreference;
    ...
    .line 100
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awG:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/users/UserDetailsSettings;->X(Ljava/lang/String;)V

    .line 113
    :cond_1
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awF:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->awJ:Landroid/os/Bundle;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v1, p0, Lcom/android/settings/users/UserDetailsSettings;->awH:Landroid/content/pm/UserInfo;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 134
    :cond_1
    invoke-virtual {p0, v1}, Lcom/android/settings/users/UserDetailsSettings;->bn(Z)V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 118
    iget-object v1, p0, Lcom/android/settings/users/UserDetailsSettings;->awG:Landroid/preference/Preference;
...
.method removeUser()V
    ...
    .line 195
    invoke-virtual {p0}, Lcom/android/settings/users/UserDetailsSettings;->ie()V
