...
.field private final mh:Landroid/service/dreams/IDreamManager;

.field private final mi:Lcom/android/settings/cF;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/cD;->TAG:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 83
    iput-object p1, p0, Lcom/android/settings/cD;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/settings/cD;->mh:Landroid/service/dreams/IDreamManager;

    .line 86
    new-instance v0, Lcom/android/settings/cF;

    invoke-virtual {p0}, Lcom/android/settings/cD;->dN()Landroid/content/ComponentName;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/settings/cF;-><init>(Landroid/content/ComponentName;)V

    iput-object v0, p0, Lcom/android/settings/cD;->mi:Lcom/android/settings/cF;
    ...
    sget v1, Lcom/android/internal/R$bool;->config_dreamsEnabledByDefault:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/settings/cD;->mj:Z
    ...
    sget v1, Lcom/android/internal/R$bool;->config_dreamsActivatedOnSleepByDefault:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/settings/cD;->mk:Z
    ...
    sget v1, Lcom/android/internal/R$bool;->config_dreamsActivatedOnDockByDefault:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/settings/cD;->ml:Z
...
.method private static a(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
    ...
    .line 250
    :try_start_1
    sget-object v1, Lcom/android/settings/cD;->TAG:Ljava/lang/String;
...
.method private getBoolean(Ljava/lang/String;Z)Z
    ...
    .line 173
    iget-object v0, p0, Lcom/android/settings/cD;->mContext:Landroid/content/Context;
...
# virtual methods
.method public a(Lcom/android/settings/cE;)V
    .locals 3
    ...
    invoke-static {v0, v1}, Lcom/android/settings/cD;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 206
    if-eqz p1, :cond_0

    iget-object v0, p1, Lcom/android/settings/cE;->mo:Landroid/content/ComponentName;
    ...
    iget-object v2, p1, Lcom/android/settings/cE;->mo:Landroid/content/ComponentName;
...
.method public b(Landroid/content/ComponentName;)V
    ...
    .line 182
    iget-object v0, p0, Lcom/android/settings/cD;->mh:Landroid/service/dreams/IDreamManager;
    ...
    .line 186
    iget-object v1, p0, Lcom/android/settings/cD;->mh:Landroid/service/dreams/IDreamManager;
...
.method public dM()Ljava/util/List;
    ...
    .line 97
    invoke-virtual {p0}, Lcom/android/settings/cD;->dR()Landroid/content/ComponentName;
    ...
    .line 106
    new-instance v5, Lcom/android/settings/cE;

    invoke-direct {v5}, Lcom/android/settings/cE;-><init>()V
    ...
    iput-object v6, v5, Lcom/android/settings/cE;->mm:Ljava/lang/CharSequence;
    ...
    iput-object v6, v5, Lcom/android/settings/cE;->icon:Landroid/graphics/drawable/Drawable;

    .line 109
    invoke-static {v0}, Lcom/android/settings/cD;->b(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v6

    iput-object v6, v5, Lcom/android/settings/cE;->componentName:Landroid/content/ComponentName;

    .line 110
    iget-object v6, v5, Lcom/android/settings/cE;->componentName:Landroid/content/ComponentName;

    invoke-virtual {v6, v1}, Landroid/content/ComponentName;->equals(Ljava/lang/Object;)Z

    move-result v6

    iput-boolean v6, v5, Lcom/android/settings/cE;->mn:Z

    .line 111
    invoke-static {v2, v0}, Lcom/android/settings/cD;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v0

    iput-object v0, v5, Lcom/android/settings/cE;->mo:Landroid/content/ComponentName;
    ...
    .line 114
    :cond_1
    iget-object v0, p0, Lcom/android/settings/cD;->mi:Lcom/android/settings/cF;
...
.method public dN()Landroid/content/ComponentName;
    .locals 4
    ...
    .line 124
    sget-object v2, Lcom/android/settings/cD;->TAG:Ljava/lang/String;
...
.method public dO()Ljava/lang/CharSequence;
    .locals 4
    ...
    .line 132
    iget-object v2, p0, Lcom/android/settings/cD;->mContext:Landroid/content/Context;
...
.method public dP()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings/cD;->ml:Z

    invoke-direct {p0, v0, v1}, Lcom/android/settings/cD;->getBoolean(Ljava/lang/String;Z)Z
...
.method public dQ()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings/cD;->mk:Z
...
.method public dR()Landroid/content/ComponentName;
    .locals 4
...
.method public isEnabled()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings/cD;->mj:Z
...
.method public setEnabled(Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/settings/cD;->setBoolean(Ljava/lang/String;Z)V
