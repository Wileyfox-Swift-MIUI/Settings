...
.field private Gl:Lcom/android/settings/applications/AppOpsState;
...
.method private b(Landroid/content/pm/PackageInfo;)V
    ...
    .line 66
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->t:Landroid/content/pm/PackageManager;
...
.method private c(ZZ)V
    ...
    invoke-virtual {v0, p0, v2, v1}, Lcom/android/settings/hs;->finishPreferencePanel(Landroid/app/Fragment;ILandroid/content/Intent;)V
...
.method private jO()Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->FZ:Landroid/content/pm/PackageInfo;
    :try_end_0
    ...
    .line 88
    iput-object v2, p0, Lcom/android/settings/applications/AppOpsDetails;->FZ:Landroid/content/pm/PackageInfo;
...
.method private jP()Z
    ...
    .line 95
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->FZ:Landroid/content/pm/PackageInfo;
    ...
    .line 103
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->Gt:Landroid/widget/LinearLayout;
    ...
    .line 105
    sget-object v8, Lcom/android/settings/applications/AppOpsState;->GE:[Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    ...
    .line 106
    iget-object v1, p0, Lcom/android/settings/applications/AppOpsDetails;->Gl:Lcom/android/settings/applications/AppOpsState;

    iget-object v3, p0, Lcom/android/settings/applications/AppOpsDetails;->FZ:Landroid/content/pm/PackageInfo;

    iget-object v3, v3, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget v3, v3, Landroid/content/pm/ApplicationInfo;->uid:I

    iget-object v10, p0, Lcom/android/settings/applications/AppOpsDetails;->FZ:Landroid/content/pm/PackageInfo;

    iget-object v10, v10, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v1, v0, v3, v10}, Lcom/android/settings/applications/AppOpsState;->a(Lcom/android/settings/applications/AppOpsState$OpsTemplate;ILjava/lang/String;)Ljava/util/List;
    ...
    check-cast v1, Lcom/android/settings/applications/AppOpsState$AppOpEntry;

    .line 109
    invoke-virtual {v1, v5}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->aE(I)Landroid/app/AppOpsManager$OpEntry;
    ...
    iget-object v12, p0, Lcom/android/settings/applications/AppOpsDetails;->Gt:Landroid/widget/LinearLayout;
    ...
    .line 116
    :try_start_0
    iget-object v12, p0, Lcom/android/settings/applications/AppOpsDetails;->t:Landroid/content/pm/PackageManager;
    ...
    iget-object v13, p0, Lcom/android/settings/applications/AppOpsDetails;->t:Landroid/content/pm/PackageManager;
    ...
    iget-object v12, p0, Lcom/android/settings/applications/AppOpsDetails;->Gl:Lcom/android/settings/applications/AppOpsState;

    invoke-virtual {v1, v12}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->b(Lcom/android/settings/applications/AppOpsState;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v7, v4}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->a(Landroid/content/res/Resources;Z)Ljava/lang/CharSequence;
    ...
    .line 134
    iget-object v3, p0, Lcom/android/settings/applications/AppOpsDetails;->mAppOps:Landroid/app/AppOpsManager;

    invoke-virtual {v1}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->jV()Landroid/app/AppOpsManager$PackageOps;
    ...
    .line 136
    new-instance v3, Lcom/android/settings/applications/AppOpsDetails$1;

    invoke-direct {v3, p0, v11, v1}, Lcom/android/settings/applications/AppOpsDetails$1;-><init>(Lcom/android/settings/applications/AppOpsDetails;ILcom/android/settings/applications/AppOpsState$AppOpEntry;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->Gl:Lcom/android/settings/applications/AppOpsState;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->t:Landroid/content/pm/PackageManager;
    ...
    .line 167
    invoke-direct {p0}, Lcom/android/settings/applications/AppOpsDetails;->jO()Ljava/lang/String;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->Gt:Landroid/widget/LinearLayout;
...
.method public onResume()V
    ...
    .line 191
    invoke-direct {p0}, Lcom/android/settings/applications/AppOpsDetails;->jP()Z
    ...
    .line 192
    invoke-direct {p0, v1, v1}, Lcom/android/settings/applications/AppOpsDetails;->c(ZZ)V
