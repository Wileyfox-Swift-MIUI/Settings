...
# instance fields
.field private Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
...
.method private Y(Ljava/lang/String;)Z
    ...
    iput-object v2, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;

    .line 124
    iget-object v2, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;

    if-eqz v2, :cond_0

    .line 127
    invoke-virtual {p0, v1}, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->showDialog(I)V
    ...
    iget-object v3, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
...
.method static synthetic a(Lcom/android/settings/applications/MiuiSmsDefaultDialog;)I
    .locals 1

    .prologue
    .line 25
    iget v0, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Ln:I

    return v0
.end method

.method static synthetic a(Lcom/android/settings/applications/MiuiSmsDefaultDialog;I)I
    .locals 0

    .prologue
    .line 25
    iput p1, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Ln:I

    return p1
.end method

.method static synthetic b(Lcom/android/settings/applications/MiuiSmsDefaultDialog;)Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    .locals 1

    .prologue
    .line 25
    iget-object v0, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 40
    invoke-direct {p0, v0}, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Y(Ljava/lang/String;)Z
...
.method protected onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v4, p0, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->Bg:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/settings/applications/MiuiSmsDefaultDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v2, Lcom/android/settings/applications/MiuiSmsDefaultDialog$1;

    invoke-direct {v2, p0}, Lcom/android/settings/applications/MiuiSmsDefaultDialog$1;-><init>(Lcom/android/settings/applications/MiuiSmsDefaultDialog;)V
    ...
    new-instance v2, Lcom/android/settings/applications/MiuiSmsDefaultDialog$4;

    invoke-direct {v2, p0}, Lcom/android/settings/applications/MiuiSmsDefaultDialog$4;-><init>(Lcom/android/settings/applications/MiuiSmsDefaultDialog;)V
