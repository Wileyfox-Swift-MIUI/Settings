...
# instance fields
.field private final GL:Landroid/app/AppOpsManager$PackageOps;

.field private final GM:Ljava/util/ArrayList;

.field private final GN:Ljava/util/ArrayList;

.field private final GO:Lcom/android/settings/applications/AppOpsState$AppEntry;
...
.method public constructor <init>(Landroid/app/AppOpsManager$PackageOps;Landroid/app/AppOpsManager$OpEntry;Lcom/android/settings/applications/AppOpsState$AppEntry;I)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GM:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GN:Ljava/util/ArrayList;

    .line 312
    iput-object p1, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GL:Landroid/app/AppOpsManager$PackageOps;

    .line 313
    iput-object p3, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GO:Lcom/android/settings/applications/AppOpsState$AppEntry;

    .line 314
    iput p4, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GP:I

    .line 315
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GO:Lcom/android/settings/applications/AppOpsState$AppEntry;
    ...
    .line 316
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GM:Ljava/util/ArrayList;

    invoke-virtual {v0, p2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 317
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GN:Ljava/util/ArrayList;
...
.method public a(Lcom/android/settings/applications/AppOpsState;)Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lcom/android/settings/applications/AppOpsState;->Gx:[Ljava/lang/CharSequence;
...
.method public a(Landroid/app/AppOpsManager$OpEntry;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/applications/AppOpsState$AppEntry;->aD(I)Lcom/android/settings/applications/AppOpsState$AppOpEntry;
...
.method public aE(I)Landroid/app/AppOpsManager$OpEntry;
    .locals 1
...
.method public b(Lcom/android/settings/applications/AppOpsState;)Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lcom/android/settings/applications/AppOpsState;->Gy:[Ljava/lang/CharSequence;
...
.method public jT()Lcom/android/settings/applications/AppOpsState$AppEntry;
    .locals 1
...
.method public jU()I
    ...
    .prologue
    .line 351
    iget v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GP:I

    return v0
.end method

.method public jV()Landroid/app/AppOpsManager$PackageOps;
    .locals 1

    .prologue
    .line 355
    iget-object v0, p0, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->GL:Landroid/app/AppOpsManager$PackageOps;
