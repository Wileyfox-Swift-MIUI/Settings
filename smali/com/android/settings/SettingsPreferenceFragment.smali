...
.field private AN:Landroid/widget/ListAdapter;

.field private AO:Z

.field private AP:Landroid/view/ViewGroup;

.field private cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
...
.method public constructor <init>()V
    ...
    .line 75
    iput-boolean v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AM:Z

    .line 79
    iput-boolean v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AO:Z

    .line 80
    new-instance v0, Lcom/android/settings/hJ;

    invoke-direct {v0, p0}, Lcom/android/settings/hJ;-><init>(Lcom/android/settings/SettingsPreferenceFragment;)V
...
.method private V(Ljava/lang/String;)I
    ...
    .line 316
    invoke-direct {p0, v1, p1}, Lcom/android/settings/SettingsPreferenceFragment;->a(Landroid/widget/ListAdapter;Ljava/lang/String;)I
...
.method private W(Ljava/lang/String;)V
    ...
    .prologue
    .line 323
    invoke-direct {p0}, Lcom/android/settings/SettingsPreferenceFragment;->eC()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    .line 325
    invoke-direct {p0, p1}, Lcom/android/settings/SettingsPreferenceFragment;->V(Ljava/lang/String;)I
    ...
    .line 335
    new-instance v0, Lcom/android/settings/hK;

    invoke-direct {v0, p0, v4, v3, v2}, Lcom/android/settings/hK;-><init>(Lcom/android/settings/SettingsPreferenceFragment;Landroid/widget/ListView;ILandroid/graphics/drawable/Drawable;)V
...
.method static synthetic a(Lcom/android/settings/SettingsPreferenceFragment;)Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
    ...
    .prologue
    .line 58
    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
...
.method static synthetic a(Lcom/android/settings/SettingsPreferenceFragment;Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;)Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
    ...
    .prologue
    .line 58
    iput-object p1, p0, Lcom/android/settings/SettingsPreferenceFragment;->cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
...
.method private am()V
    ...
    .line 144
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->getActionBar()Lmiui/app/ActionBar;
...
.method private eC()Landroid/graphics/drawable/Drawable;
    .locals 2

    .prologue
    .line 298
    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->og:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->og:Landroid/graphics/drawable/Drawable;
...
.method private f(Landroid/os/Bundle;)V
    ...
    .line 133
    invoke-virtual {p0, v0}, Lcom/android/settings/SettingsPreferenceFragment;->setThemeRes(I)V
...
.method protected a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 169
    invoke-super {p0, p1, p2, p3}, Lcom/android/settings/InstrumentedPreferenceFragment;->onInflateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
...
.method public a(Landroid/app/Fragment;Ljava/lang/String;IILandroid/os/Bundle;)Z
    ...
    .line 672
    instance-of v1, v0, Lcom/android/settings/hs;
...
.method public ah(I)Landroid/view/View;
    ...
    .line 179
    iget-object v1, p0, Lcom/android/settings/SettingsPreferenceFragment;->AP:Landroid/view/ViewGroup;
    ...
    .line 181
    invoke-virtual {p0, v0}, Lcom/android/settings/SettingsPreferenceFragment;->f(Landroid/view/View;)V
...
.method public ai(I)Z
    ...
    .line 707
    iget-object v1, p0, Lcom/android/settings/SettingsPreferenceFragment;->cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/SettingsPreferenceFragment;->cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;

    invoke-virtual {v1}, Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;->ig()I
...
.method public f(Landroid/view/View;)V
    ...
    .prologue
    .line 189
    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AP:Landroid/view/ViewGroup;
...
.method protected getNextButton()Landroid/widget/Button;
    ...
    invoke-interface {v0}, Lcom/android/settings/an;->getNextButton()Landroid/widget/Button;
...
.method protected hasNextButton()Z
    ...
    invoke-interface {v0}, Lcom/android/settings/an;->hasNextButton()Z
...
.method public ib()V
    ...
    .prologue
    .line 271
    iget-boolean v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AO:Z

    if-nez v0, :cond_1

    .line 272
    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AN:Landroid/widget/ListAdapter;
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AN:Landroid/widget/ListAdapter;
...
.method public id()V
    ...
    iget-boolean v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AM:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AL:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/SettingsPreferenceFragment;->W(Ljava/lang/String;)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 211
    iget-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AK:Ljava/lang/String;
...
.method protected onBindPreferences()V
    ...
    .prologue
    .line 250
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->ib()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 104
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->aL()I
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AK:Ljava/lang/String;

    .line 109
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settings/SettingsPreferenceFragment;->f(Landroid/os/Bundle;)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iget-object v1, p0, Lcom/android/settings/SettingsPreferenceFragment;->AK:Ljava/lang/String;
    ...
    invoke-static {v0, p1, v1, v2}, Lcom/android/settings/dt;->a(Landroid/app/Activity;Landroid/view/Menu;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    .line 445
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->getMenuInflater()Landroid/view/MenuInflater;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lcom/android/settings/SettingsPreferenceFragment;->onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
...
.method public onDetach()V
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->cD:Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;
...
.method public onInflateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 162
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/settings/SettingsPreferenceFragment;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AP:Landroid/view/ViewGroup;
...
.method public onResume()V
    ...
    iput-object v0, p0, Lcom/android/settings/SettingsPreferenceFragment;->AL:Ljava/lang/String;

    .line 223
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->id()V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->getThemedContext()Landroid/content/Context;
    ...
    iget-boolean v1, p0, Lcom/android/settings/SettingsPreferenceFragment;->AM:Z
...
.method public onStart()V
    ...
    .prologue
    .line 435
    invoke-super {p0}, Lcom/android/settings/InstrumentedPreferenceFragment;->onStart()V

    .line 437
    invoke-direct {p0}, Lcom/android/settings/SettingsPreferenceFragment;->am()V
...
.method public onStop()V
    ...
    .line 262
    invoke-virtual {p0}, Lcom/android/settings/SettingsPreferenceFragment;->ic()V
...
.method protected removeDialog(I)V
    ...
    invoke-virtual {v0}, Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;->ig()I
...
.method protected showDialog(I)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/settings/SettingsPreferenceFragment$SettingsDialogFragment;-><init>(Lcom/android/settings/cv;I)V
