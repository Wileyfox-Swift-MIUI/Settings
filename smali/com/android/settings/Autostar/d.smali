...
.field ck:Landroid/view/View$OnClickListener;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->ck:Landroid/view/View$OnClickListener;
...
.method private ae()V
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/settings/Autostar/d;->cc:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    .line 73
    iget-object v0, p0, Lcom/android/settings/Autostar/d;->t:Landroid/content/pm/PackageManager;
    ...
    .line 78
    iget-object v2, p0, Lcom/android/settings/Autostar/d;->cc:Ljava/util/List;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->cf:Landroid/widget/TextView;

    .line 67
    iget-object v2, p0, Lcom/android/settings/Autostar/d;->cf:Landroid/widget/TextView;
...
.method af()V
    ...
    .line 94
    iget-object v0, p0, Lcom/android/settings/Autostar/d;->ca:Landroid/preference/PreferenceGroup;

    invoke-virtual {v0}, Landroid/preference/PreferenceGroup;->removeAll()V

    .line 95
    iget-object v0, p0, Lcom/android/settings/Autostar/d;->cb:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 96
    invoke-direct {p0}, Lcom/android/settings/Autostar/d;->ae()V
    ...
    iget-object v1, p0, Lcom/android/settings/Autostar/d;->t:Landroid/content/pm/PackageManager;
    ...
    .line 105
    iget-object v1, p0, Lcom/android/settings/Autostar/d;->cb:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 106
    iget-object v1, p0, Lcom/android/settings/Autostar/d;->ca:Landroid/preference/PreferenceGroup;
...
.method public getName()Ljava/lang/String;
    ...
    .prologue
    .line 58
    const-class v0, Lcom/android/settings/Autostar/d;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->t:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->ca:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->cc:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/d;->cb:Ljava/util/ArrayList;

    .line 120
    invoke-virtual {p0}, Lcom/android/settings/Autostar/d;->af()V
