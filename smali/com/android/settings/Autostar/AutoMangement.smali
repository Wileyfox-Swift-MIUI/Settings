...
# instance fields
.field ca:Landroid/preference/PreferenceGroup;

.field cb:Ljava/util/ArrayList;

.field private cc:Ljava/util/List;

.field cd:Landroid/app/Fragment;

.field ce:Landroid/widget/TextView;

.field cf:Landroid/widget/TextView;

.field cg:Landroid/widget/FrameLayout;

.field ch:Landroid/view/View$OnClickListener;
...
.field t:Landroid/content/pm/PackageManager;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->ch:Landroid/view/View$OnClickListener;
...
.method static synthetic a(Lcom/android/settings/Autostar/AutoMangement;)Ljava/util/List;
    ...
    .prologue
    .line 33
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cc:Ljava/util/List;
...
.method private ae()V
    ...
    .line 114
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->t:Landroid/content/pm/PackageManager;
    ...
    .line 119
    iget-object v2, p0, Lcom/android/settings/Autostar/AutoMangement;->cc:Ljava/util/List;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->cf:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->ce:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->cg:Landroid/widget/FrameLayout;

    .line 101
    iget-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->ch:Landroid/view/View$OnClickListener;
...
.method af()V
    ...
    .line 134
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->ca:Landroid/preference/PreferenceGroup;

    invoke-virtual {v0}, Landroid/preference/PreferenceGroup;->removeAll()V

    .line 135
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cb:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 136
    invoke-direct {p0}, Lcom/android/settings/Autostar/AutoMangement;->ae()V
    ...
    iget-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->t:Landroid/content/pm/PackageManager;
    ...
    .line 145
    iget-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->cb:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 146
    iget-object v1, p0, Lcom/android/settings/Autostar/AutoMangement;->ca:Landroid/preference/PreferenceGroup;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 108
    invoke-virtual {p0}, Lcom/android/settings/Autostar/AutoMangement;->af()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->t:Landroid/content/pm/PackageManager;

    .line 158
    iput-object p0, p0, Lcom/android/settings/Autostar/AutoMangement;->cd:Landroid/app/Fragment;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->ca:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cc:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cb:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/settings/Autostar/AutoMangement;->cc:Ljava/util/List;
...
.method public onResume()V
    ...
    .line 172
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->ce:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/android/settings/Autostar/AutoMangement;->cc:Ljava/util/List;
    ...
    .line 176
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cg:Landroid/widget/FrameLayout;

    invoke-virtual {v0, v5}, Landroid/widget/FrameLayout;->setVisibility(I)V

    .line 177
    iget-object v0, p0, Lcom/android/settings/Autostar/AutoMangement;->cf:Landroid/widget/TextView;
