...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/AccessControlFragment;->q:Landroid/database/ContentObserver;
...
.method private a(Landroid/preference/PreferenceScreen;)V
    ...
    iput-object v0, p0, Lcom/android/settings/AccessControlFragment;->o:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v3, p0, Lcom/android/settings/AccessControlFragment;->q:Landroid/database/ContentObserver;
...
.method static synthetic a(Lcom/android/settings/AccessControlFragment;)V
    ...
    .prologue
    .line 22
    invoke-direct {p0}, Lcom/android/settings/AccessControlFragment;->s()V
...
.method static synthetic b(Lcom/android/settings/AccessControlFragment;)Landroid/security/ChooseLockSettingsHelper;
    ...
    .prologue
    .line 22
    iget-object v0, p0, Lcom/android/settings/AccessControlFragment;->m:Landroid/security/ChooseLockSettingsHelper;
...
.method private s()V
    ...
    .prologue
    .line 87
    iget-object v0, p0, Lcom/android/settings/AccessControlFragment;->o:Landroid/preference/CheckBoxPreference;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/settings/AccessControlFragment;->o:Landroid/preference/CheckBoxPreference;

    iget-object v1, p0, Lcom/android/settings/AccessControlFragment;->m:Landroid/security/ChooseLockSettingsHelper;
...
.method public getName()Ljava/lang/String;
    ...
    .prologue
    .line 49
    const-class v0, Lcom/android/settings/AccessControlFragment;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/AccessControlFragment;->l:Z
    ...
    iput-object v0, p0, Lcom/android/settings/AccessControlFragment;->m:Landroid/security/ChooseLockSettingsHelper;
    ...
    iput-object v0, p0, Lcom/android/settings/AccessControlFragment;->n:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/AccessControlFragment;->p:Landroid/preference/CheckBoxPreference;
    ...
    .line 65
    iget-boolean v2, p0, Lcom/android/settings/AccessControlFragment;->l:Z
    ...
    .line 71
    iget-object v3, p0, Lcom/android/settings/AccessControlFragment;->n:Landroid/preference/CheckBoxPreference;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/AccessControlFragment;->q:Landroid/database/ContentObserver;
...
.method public onResume()V
    ...
    .line 95
    iget-object v1, p0, Lcom/android/settings/AccessControlFragment;->p:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v1, v0}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 96
    iget-boolean v1, p0, Lcom/android/settings/AccessControlFragment;->l:Z

    if-eqz v1, :cond_0

    .line 97
    iget-object v1, p0, Lcom/android/settings/AccessControlFragment;->n:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v1, v0}, Landroid/preference/CheckBoxPreference;->setChecked(Z)V

    .line 99
    :cond_0
    iget-object v0, p0, Lcom/android/settings/AccessControlFragment;->p:Landroid/preference/CheckBoxPreference;
