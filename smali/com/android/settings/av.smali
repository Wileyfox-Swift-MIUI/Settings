...
# instance fields
.field final synthetic dB:Landroid/content/pm/ApplicationInfo;

.field final synthetic dC:Z
...
.method constructor <init>(Lcom/android/settings/ChildrenModeSettings;Landroid/content/pm/ApplicationInfo;Z)V
    ...
    .prologue
    .line 242
    iput-object p1, p0, Lcom/android/settings/av;->dx:Lcom/android/settings/ChildrenModeSettings;

    iput-object p2, p0, Lcom/android/settings/av;->dB:Landroid/content/pm/ApplicationInfo;

    iput-boolean p3, p0, Lcom/android/settings/av;->dC:Z
...
.method public run()V
    ...
    .prologue
    .line 244
    iget-object v0, p0, Lcom/android/settings/av;->dx:Lcom/android/settings/ChildrenModeSettings;
    ...
    .line 246
    iget-object v0, p0, Lcom/android/settings/av;->dB:Landroid/content/pm/ApplicationInfo;

    iget-object v2, p0, Lcom/android/settings/av;->dx:Lcom/android/settings/ChildrenModeSettings;
    ...
    iget-object v2, p0, Lcom/android/settings/av;->dB:Landroid/content/pm/ApplicationInfo;

    iget-object v3, p0, Lcom/android/settings/av;->dx:Lcom/android/settings/ChildrenModeSettings;
    ...
    .line 259
    iget-boolean v0, p0, Lcom/android/settings/av;->dC:Z
    ...
    invoke-static {v0}, Lcom/android/settings/ChildrenModeSettings;->d(Lcom/android/settings/ChildrenModeSettings;)Landroid/preference/PreferenceGroup;
