...
# instance fields
.field private J:Lcom/android/settings/l;
...
.method protected a(Landroid/content/Intent;Ljava/util/List;)V
    ...
    .line 191
    new-instance v5, Lcom/android/settings/m;

    invoke-direct {v5, p0, v2, v0}, Lcom/android/settings/m;-><init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)V
...
.method protected e(I)Landroid/content/Intent;
    ...
    .prologue
    .line 129
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->J:Lcom/android/settings/l;

    invoke-virtual {v0, p1}, Lcom/android/settings/l;->getItem(I)Ljava/lang/Object;
    ...
    .line 130
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->K:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Lcom/android/settings/m;->a(Landroid/content/Intent;)Landroid/content/Intent;
...
.method protected getItems()Ljava/util/List;
    ...
    .line 167
    :goto_1
    new-instance v8, Lcom/android/settings/m;

    invoke-direct {v8, p0, v0, v1}, Lcom/android/settings/m;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 172
    :cond_0
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->K:Landroid/content/Intent;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 111
    invoke-virtual {p0, p2}, Lcom/android/settings/ActivityPicker;->e(I)Landroid/content/Intent;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/ActivityPicker;->K:Landroid/content/Intent;
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/settings/l;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object v2, p0, Lcom/android/settings/ActivityPicker;->J:Lcom/android/settings/l;

    .line 101
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->J:Lcom/android/settings/l;
