...
# instance fields
.field private final mA:Landroid/widget/Spinner;

.field private final mB:Ljava/util/ArrayList;

.field private mC:Lcom/android/settings/cR;

.field private final mContext:Landroid/content/Context;

.field private mSelectedPosition:I

.field private final mz:Landroid/widget/ArrayAdapter;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Lcom/android/settings/DropDownPreference;->mB:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/settings/DropDownPreference;->mz:Landroid/widget/ArrayAdapter;
    ...
    iput-object v1, p0, Lcom/android/settings/DropDownPreference;->mA:Landroid/widget/Spinner;

    .line 53
    iget-object v1, p0, Lcom/android/settings/DropDownPreference;->mA:Landroid/widget/Spinner;
    ...
    iget-object v2, p0, Lcom/android/settings/DropDownPreference;->mz:Landroid/widget/ArrayAdapter;
    ...
    invoke-direct {v2, p0}, Lcom/android/settings/cP;-><init>(Lcom/android/settings/DropDownPreference;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/cQ;-><init>(Lcom/android/settings/DropDownPreference;)V
    ...
    .line 76
    sget-object v1, Lcom/android/settings/gC;->xw:[I
...
.method static synthetic a(Lcom/android/settings/DropDownPreference;)Landroid/widget/Spinner;
    ...
    .prologue
    .line 32
    iget-object v0, p0, Lcom/android/settings/DropDownPreference;->mA:Landroid/widget/Spinner;
...
.method public a(Lcom/android/settings/cR;)V
    .locals 0

    .prologue
    .line 91
    iput-object p1, p0, Lcom/android/settings/DropDownPreference;->mC:Lcom/android/settings/cR;
...
.method public b(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .prologue
    .line 125
    iget-object v0, p0, Lcom/android/settings/DropDownPreference;->mz:Landroid/widget/ArrayAdapter;

    invoke-virtual {v0, p1}, Landroid/widget/ArrayAdapter;->add(Ljava/lang/Object;)V

    .line 126
    iget-object v0, p0, Lcom/android/settings/DropDownPreference;->mB:Ljava/util/ArrayList;
...
.method public g(IZ)V
    ...
    .line 103
    iget-object v0, p0, Lcom/android/settings/DropDownPreference;->mC:Lcom/android/settings/cR;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/settings/DropDownPreference;->mC:Lcom/android/settings/cR;

    invoke-interface {v0, p1, v1}, Lcom/android/settings/cR;->b(ILjava/lang/Object;)Z
