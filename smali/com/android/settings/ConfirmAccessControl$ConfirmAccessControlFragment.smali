...
.field private fo:Landroid/os/IBinder;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fn:Landroid/widget/Button;

    .line 113
    return-void
.end method

.method static synthetic a(Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;)Z
    .locals 1

    .prologue
    .line 101
    iget-boolean v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fp:Z
...
.method private aT()V
    ...
    .line 146
    iget v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fm:I

    if-ne v0, v3, :cond_1

    .line 147
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->m:Landroid/security/ChooseLockSettingsHelper;
...
.method static synthetic b(Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;)Landroid/os/IBinder;
    .locals 1

    .prologue
    .line 101
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fo:Landroid/os/IBinder;
...
.method protected a(Lcom/android/settings/ConfirmLockPattern$Stage;)V
    ...
    .prologue
    .line 299
    invoke-super {p0, p1}, Lcom/android/settings/ConfirmLockPattern$ConfirmLockPatternFragment;->a(Lcom/android/settings/ConfirmLockPattern$Stage;)V

    .line 300
    sget-object v0, Lcom/android/settings/aN;->fl:[I
    ...
    .line 302
    :pswitch_1
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fP:Landroid/widget/Button;
...
.method protected a(Ljava/util/List;)V
    ...
    .prologue
    .line 282
    invoke-direct {p0}, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->aT()V
    ...
    .line 284
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->y:Lmiui/security/SecurityManager;
...
.method protected aU()V
    ...
    .prologue
    .line 161
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fx:Landroid/security/MiuiLockPatternUtils;
...
.method protected b(J)J
    ...
    .line 243
    sget-wide v2, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fq:J
    ...
    sput-wide v0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fq:J

    .line 246
    :cond_1
    sget-wide v0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fq:J
...
.method protected c(J)V
    ...
    .prologue
    .line 251
    sput-wide p1, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fq:J
...
.method protected d(J)V
    ...
    .prologue
    .line 257
    invoke-super {p0, p1, p2}, Lcom/android/settings/ConfirmLockPattern$ConfirmLockPatternFragment;->d(J)V
...
.method protected f(Landroid/content/Intent;)V
    ...
    .line 174
    iput-object v3, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->mIntent:Landroid/content/Intent;

    .line 175
    iput-object v3, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fo:Landroid/os/IBinder;

    .line 176
    iput-boolean v1, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fp:Z
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->mPackageName:Ljava/lang/String;
    ...
    iput v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fm:I
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fo:Landroid/os/IBinder;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fp:Z
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->getString(I)Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fQ:Ljava/lang/CharSequence;
    ...
    invoke-static {v0, v3}, Lcom/android/settings/ConfirmAccessControl;->a(Lcom/android/settings/ConfirmAccessControl;Z)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->m:Landroid/security/ChooseLockSettingsHelper;
    ...
    iput-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->y:Lmiui/security/SecurityManager;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 127
    iget-object v0, p0, Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;->fn:Landroid/widget/Button;

    new-instance v2, Lcom/android/settings/aO;

    invoke-direct {v2, p0}, Lcom/android/settings/aO;-><init>(Lcom/android/settings/ConfirmAccessControl$ConfirmAccessControlFragment;)V
