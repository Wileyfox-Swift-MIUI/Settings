...
# instance fields
.field protected UD:Lorg/json/JSONObject;

.field protected UE:Ljava/net/URL;

.field protected UF:Lcom/android/settings/cloud/network/b;
...
.method private a(Ljava/lang/String;Ljava/lang/String;ZZLjava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/cloud/network/Connection;->bp(I)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 304
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->UL:Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_7
    ...
    .line 250
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->UK:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method private a(Ljava/net/URL;)V
    ...
    .line 89
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->UG:Z

    .line 90
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->UH:Z

    .line 91
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->UI:Z
    ...
    .line 93
    iput-object p1, p0, Lcom/android/settings/cloud/network/Connection;->UE:Ljava/net/URL;
...
.method private bp(I)Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 3
    ...
    .line 361
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->UJ:Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 364
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->UP:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method protected a(Ljava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .prologue
    .line 187
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->UE:Ljava/net/URL;
    ...
    .line 192
    :cond_0
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->UF:Lcom/android/settings/cloud/network/b;
    ...
    iput-object v0, p0, Lcom/android/settings/cloud/network/Connection;->UF:Lcom/android/settings/cloud/network/b;

    .line 196
    :cond_1
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->UH:Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/cloud/network/b;->oO()V
    ...
    .line 210
    iget-boolean v1, p0, Lcom/android/settings/cloud/network/Connection;->UG:Z
    ...
    .line 214
    iget-object v1, p0, Lcom/android/settings/cloud/network/Connection;->UE:Ljava/net/URL;
    ...
    .line 233
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->UG:Z
    ...
    .line 237
    :cond_4
    iget-boolean v3, p0, Lcom/android/settings/cloud/network/Connection;->UG:Z

    iget-boolean v4, p0, Lcom/android/settings/cloud/network/Connection;->UI:Z
...
.method public aF(Z)V
    ...
    .prologue
    .line 110
    iput-boolean p1, p0, Lcom/android/settings/cloud/network/Connection;->UG:Z
...
.method public i(Ljava/io/File;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 4
...
.method public oL()Lorg/json/JSONObject;
    .locals 1

    .prologue
    .line 98
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->UD:Lorg/json/JSONObject;

    return-object v0
.end method

.method public oM()Lcom/android/settings/cloud/network/b;
    .locals 1
...
.method public oN()Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 5
    ...
    iput-object v2, p0, Lcom/android/settings/cloud/network/Connection;->UD:Lorg/json/JSONObject;
    :try_end_0
    ...
    .line 135
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->UQ:Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_3
