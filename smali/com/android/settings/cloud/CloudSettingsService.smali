...
.method private a(Lcom/android/settings/cloud/network/a;)Ljava/io/File;
    ...
    .line 174
    :try_start_0
    invoke-virtual {v0, v1}, Lcom/android/settings/cloud/network/Connection;->i(Ljava/io/File;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_0
...
.method private c(Lorg/json/JSONObject;)Lcom/android/settings/cloud/network/a;
    ...
    iput-object v2, v1, Lcom/android/settings/cloud/network/a;->Uz:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/android/settings/cloud/network/a;->UA:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/android/settings/cloud/network/a;->UB:Ljava/lang/String;
    ...
    iput-wide v2, v1, Lcom/android/settings/cloud/network/a;->UC:J
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0

    .line 240
    iget-object v2, v1, Lcom/android/settings/cloud/network/a;->Uz:Ljava/lang/String;
    ...
    iget-object v2, v1, Lcom/android/settings/cloud/network/a;->UA:Ljava/lang/String;
    ...
    iget-object v2, v1, Lcom/android/settings/cloud/network/a;->UB:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/settings/cloud/network/a;->UC:J
...
.method private c(Lcom/android/settings/cloud/network/Connection;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/settings/cloud/network/Connection;->aF(Z)V
...
.method private h(Ljava/io/File;)I
    .locals 6
    ...
    sget-object v2, Lcom/android/settings/cloud/i;->Ux:Landroid/net/Uri;
...
.method private or()V
    ...
    .line 68
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->ot()Z
    ...
    sget-object v6, Lcom/android/settings/cloud/h;->TL:Ljava/lang/String;
    ...
    invoke-virtual {v6, v7, v8}, Lcom/android/settings/cloud/network/b;->r(Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/cloud/network/b;
    ...
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->ou()Ljava/lang/String;
    ...
    .line 99
    invoke-virtual {v5}, Lcom/android/settings/cloud/network/Connection;->oN()Lcom/android/settings/cloud/network/Connection$NetworkError;

    move-result-object v6

    sget-object v7, Lcom/android/settings/cloud/network/Connection$NetworkError;->UJ:Lcom/android/settings/cloud/network/Connection$NetworkError;

    if-ne v6, v7, :cond_0

    .line 102
    invoke-virtual {v5}, Lcom/android/settings/cloud/network/Connection;->oL()Lorg/json/JSONObject;
    ...
    .line 128
    :cond_4
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->os()Lcom/android/settings/cloud/network/a;
    ...
    .line 143
    iget-object v3, v0, Lcom/android/settings/cloud/network/a;->UB:Ljava/lang/String;
    ...
    :cond_8
    :try_start_1
    invoke-direct {p0, v1}, Lcom/android/settings/cloud/CloudSettingsService;->h(Ljava/io/File;)I
    :try_end_1
    ...
    iget-wide v2, v0, Lcom/android/settings/cloud/network/a;->UC:J
...
.method private os()Lcom/android/settings/cloud/network/a;
    .locals 7
    ...
    sget-object v2, Lcom/android/settings/cloud/h;->TK:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/settings/cloud/network/b;->r(Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/cloud/network/b;
    ...
    .line 219
    invoke-virtual {v1}, Lcom/android/settings/cloud/network/Connection;->oN()Lcom/android/settings/cloud/network/Connection$NetworkError;

    move-result-object v2

    sget-object v3, Lcom/android/settings/cloud/network/Connection$NetworkError;->UJ:Lcom/android/settings/cloud/network/Connection$NetworkError;

    if-ne v2, v3, :cond_0

    .line 220
    invoke-virtual {v1}, Lcom/android/settings/cloud/network/Connection;->oL()Lorg/json/JSONObject;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    .line 59
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->or()V
