...
.field private static volatile air:Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;


# instance fields
.field private final ais:Ljava/util/ArrayList;

.field private final ait:Ljava/util/HashMap;

.field private final aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;

.field private final aiv:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ais:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ait:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiv:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ait:Ljava/util/HashMap;

    iget-object v4, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ais:Ljava/util/ArrayList;

    invoke-static {}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->rX()I
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
    ...
    .line 78
    invoke-virtual {p0}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->rY()V

    .line 79
    return-void
.end method

.method static bM(Landroid/content/Context;)Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;
    .locals 2

    .prologue
    .line 54
    sget-object v0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->air:Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;
    ...
    sput-object v0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->air:Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;
...
.method private bO(Landroid/content/Context;)I
    .locals 3
    ...
    .line 158
    iget-object v1, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ait:Ljava/util/HashMap;

    monitor-enter v1

    .line 159
    :try_start_0
    iget-object v2, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
...
.method private rZ()V
    ...
    .prologue
    .line 96
    iget-object v2, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ait:Ljava/util/HashMap;

    monitor-enter v2

    .line 97
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiv:Ljava/util/HashSet;

    invoke-virtual {v0}, Ljava/util/HashSet;->clear()V

    .line 98
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
    ...
    .line 105
    iget-object v1, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiv:Ljava/util/HashSet;
...
.method a(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    .line 134
    :try_start_0
    iget-object v4, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
    ...
    .line 139
    invoke-direct {p0, p2}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->bO(Landroid/content/Context;)I
...
.method bN(Landroid/content/Context;)Ljava/lang/CharSequence;
    .locals 4
    ...
    .line 121
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ait:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->aiu:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
...
.method getInputMethodList()Ljava/util/List;
    ...
    .line 115
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ais:Ljava/util/ArrayList;
...
.method rY()V
    ...
    .line 86
    iget-object v2, p0, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->ais:Ljava/util/ArrayList;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->rZ()V
