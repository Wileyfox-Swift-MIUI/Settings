...
.field private final aig:Ljava/util/HashMap;

.field private final aih:Ljava/util/HashMap;

.field private aii:Ljava/util/List;

.field private bC:Ljava/text/Collator;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aig:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aih:Ljava/util/HashMap;

    return-void
.end method

.method static synthetic a(Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;)Ljava/text/Collator;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->bC:Ljava/text/Collator;
...
.method private a(Landroid/view/inputmethod/InputMethodInfo;Landroid/preference/PreferenceScreen;)V
    ...
    .line 181
    new-instance v7, Lcom/android/settings/inputmethod/SwitchWithNoTextPreference;

    invoke-direct {v7, v4}, Lcom/android/settings/inputmethod/SwitchWithNoTextPreference;-><init>(Landroid/content/Context;)V

    .line 182
    iget-object v1, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aih:Ljava/util/HashMap;
    ...
    .line 200
    :cond_1
    new-instance v10, Lcom/android/settings/inputmethod/InputMethodSubtypePreference;

    invoke-direct {v10, v4, v0, p1}, Lcom/android/settings/inputmethod/InputMethodSubtypePreference;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodSubtype;Landroid/view/inputmethod/InputMethodInfo;)V
    ...
    .line 205
    :cond_3
    new-instance v0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler$1;

    invoke-direct {v0, p0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler$1;-><init>(Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;)V
    ...
    .line 221
    :cond_4
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aig:Ljava/util/HashMap;
...
.method private a(Landroid/view/inputmethod/InputMethodInfo;Z)V
    ...
    .line 285
    iget-object v1, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->mImm:Landroid/view/inputmethod/InputMethodManager;
...
.method private b(Ljava/lang/String;Z)V
    ...
    .line 242
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aih:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aii:Ljava/util/List;

    iget-boolean v3, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aif:Z

    invoke-static {p0, v0, v1, v3}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->a(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V

    .line 262
    invoke-direct {p0, p1, v2}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->c(Ljava/lang/String;Z)V
...
.method private c(Ljava/lang/String;Z)V
    ...
    .prologue
    .line 268
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aii:Ljava/util/List;
    ...
    .line 277
    :cond_1
    invoke-direct {p0, v0, p2}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->a(Landroid/view/inputmethod/InputMethodInfo;Z)V
...
.method private rR()V
    ...
    .line 310
    invoke-direct {p0, v0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->bu(Ljava/lang/String;)Z

    move-result v2

    invoke-direct {p0, v0, v2}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->b(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->c(Ljava/lang/String;Z)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->bt(Ljava/lang/String;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aif:Z
    ...
    .line 80
    iget-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->mImm:Landroid/view/inputmethod/InputMethodManager;

    invoke-virtual {v0}, Landroid/view/inputmethod/InputMethodManager;->getInputMethodList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aii:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->bC:Ljava/text/Collator;
    ...
    .line 89
    :cond_0
    invoke-direct {p0, v0, v3}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->a(Landroid/view/inputmethod/InputMethodInfo;Landroid/preference/PreferenceScreen;)V
    ...
    .line 92
    :cond_3
    invoke-virtual {p0, v3}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
...
.method public onPause()V
    ...
    iget-boolean v2, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aif:Z
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 143
    iget-object v5, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aih:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->b(Ljava/lang/String;Z)V
    ...
    .line 154
    invoke-virtual {p1, v3}, Lcom/android/settings/inputmethod/InputMethodSubtypePreference;->setChecked(Z)V

    .line 155
    invoke-virtual {p1}, Lcom/android/settings/inputmethod/InputMethodSubtypePreference;->isChecked()Z
    ...
    .line 158
    invoke-direct {p0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->rR()V
...
.method public onResume()V
    ...
    invoke-static {v0}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->bM(Landroid/content/Context;)Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;
    ...
    iget-object v2, p0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeEnabler;->aig:Ljava/util/HashMap;
