...
# static fields
.field private static final ail:Landroid/text/TextUtils$SimpleStringSplitter;

.field private static final aim:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->ail:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sput-object v0, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->aim:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/util/HashSet;)V
    ...
    .prologue
    .line 137
    invoke-static {p0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->f(Landroid/content/ContentResolver;)Ljava/util/HashMap;
...
.method static a(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
    ...
    .prologue
    .line 290
    invoke-static {p1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->f(Landroid/content/ContentResolver;)Ljava/util/HashMap;
...
.method static a(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
    ...
    .line 165
    invoke-static/range {p1 .. p1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->d(Landroid/content/ContentResolver;)I

    move-result v9

    .line 166
    invoke-static/range {p1 .. p1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->f(Landroid/content/ContentResolver;)Ljava/util/HashMap;

    move-result-object v10

    .line 168
    invoke-static/range {p1 .. p1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->g(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    invoke-static {v2}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->bM(Landroid/content/Context;)Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->e(Landroid/content/ContentResolver;)Z
...
.method static bv(Ljava/lang/String;)Ljava/util/HashMap;
    .locals 4
    ...
    .line 118
    :cond_1
    sget-object v1, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->ail:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    .line 121
    sget-object v2, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->aim:Landroid/text/TextUtils$SimpleStringSplitter;

    invoke-virtual {v2, v1}, Landroid/text/TextUtils$SimpleStringSplitter;->setString(Ljava/lang/String;)V

    .line 122
    sget-object v1, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->aim:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    .line 126
    :goto_1
    sget-object v3, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->aim:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method private static d(Landroid/content/ContentResolver;)I
    .locals 1
...
.method private static e(Landroid/content/ContentResolver;)Z
    ...
    .prologue
    .line 94
    invoke-static {p0}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->d(Landroid/content/ContentResolver;)I
...
.method private static f(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    .locals 1
...
.method private static g(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    .locals 3
    ...
    .line 153
    :cond_1
    sget-object v2, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->ail:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static k(Landroid/preference/Preference;)V
    .locals 3
