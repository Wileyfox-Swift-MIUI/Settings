...
.field private wP:Landroid/preference/PreferenceScreen;

.field private wQ:Landroid/preference/CheckBoxPreference;

.field private wR:Landroid/preference/PreferenceScreen;

.field private wS:Lmiui/preference/ValuePreference;

.field private wT:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/android/settings/gr;-><init>()V

    sput-object v0, Lcom/android/settings/PrivacySettings;->ix:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/gq;-><init>(Lcom/android/settings/PrivacySettings;)V

    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->wT:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method private S(Ljava/lang/String;)V
    ...
    .line 210
    iget-object v0, p0, Lcom/android/settings/PrivacySettings;->wR:Landroid/preference/PreferenceScreen;
...
.method static synthetic a(Lcom/android/settings/PrivacySettings;)Landroid/preference/CheckBoxPreference;
    ...
    .prologue
    .line 55
    iget-object v0, p0, Lcom/android/settings/PrivacySettings;->wQ:Landroid/preference/CheckBoxPreference;
...
.method static synthetic b(Lcom/android/settings/PrivacySettings;)Landroid/app/backup/IBackupManager;
    ...
    .prologue
    .line 55
    iget-object v0, p0, Lcom/android/settings/PrivacySettings;->jr:Landroid/app/backup/IBackupManager;
...
.method private gO()V
    ...
    .line 174
    :try_start_0
    iget-object v1, p0, Lcom/android/settings/PrivacySettings;->jr:Landroid/app/backup/IBackupManager;
    ...
    .line 177
    :try_start_2
    iget-object v7, p0, Lcom/android/settings/PrivacySettings;->jr:Landroid/app/backup/IBackupManager;
    ...
    .line 179
    iget-object v7, p0, Lcom/android/settings/PrivacySettings;->wP:Landroid/preference/PreferenceScreen;
    ...
    .line 187
    :goto_1
    iget-object v7, p0, Lcom/android/settings/PrivacySettings;->wQ:Landroid/preference/CheckBoxPreference;
    ...
    .line 189
    iget-object v3, p0, Lcom/android/settings/PrivacySettings;->wQ:Landroid/preference/CheckBoxPreference;
    ...
    .line 192
    :goto_3
    iget-object v3, p0, Lcom/android/settings/PrivacySettings;->wR:Landroid/preference/PreferenceScreen;

    invoke-virtual {v3, v2}, Landroid/preference/PreferenceScreen;->setEnabled(Z)V

    .line 193
    iget-object v2, p0, Lcom/android/settings/PrivacySettings;->wR:Landroid/preference/PreferenceScreen;

    invoke-virtual {v2, v1}, Landroid/preference/PreferenceScreen;->setIntent(Landroid/content/Intent;)V

    .line 195
    invoke-direct {p0, v0}, Lcom/android/settings/PrivacySettings;->S(Ljava/lang/String;)V
    ...
    .line 201
    iget-object v0, p0, Lcom/android/settings/PrivacySettings;->wS:Lmiui/preference/ValuePreference;
    ...
    .line 184
    :goto_6
    iget-object v3, p0, Lcom/android/settings/PrivacySettings;->wP:Landroid/preference/PreferenceScreen;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->jr:Landroid/app/backup/IBackupManager;
    ...
    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->wP:Landroid/preference/PreferenceScreen;
    ...
    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->wQ:Landroid/preference/CheckBoxPreference;

    .line 111
    iget-object v0, p0, Lcom/android/settings/PrivacySettings;->wQ:Landroid/preference/CheckBoxPreference;

    iget-object v2, p0, Lcom/android/settings/PrivacySettings;->wT:Landroid/preference/Preference$OnPreferenceChangeListener;
    ...
    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->wR:Landroid/preference/PreferenceScreen;
    ...
    iput-object v0, p0, Lcom/android/settings/PrivacySettings;->wS:Lmiui/preference/ValuePreference;
    ...
    .line 128
    :cond_2
    invoke-direct {p0}, Lcom/android/settings/PrivacySettings;->gO()V
