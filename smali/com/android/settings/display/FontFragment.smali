...
# instance fields
.field private aak:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/display/FontFragment;->lU:Landroid/util/SparseArray;

    .line 43
    sget-object v0, Lcom/android/settings/display/FontFragment;->lU:Landroid/util/SparseArray;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/display/FontFragment;->aak:Ljava/util/ArrayList;
...
# virtual methods
.method public bs(Landroid/content/Context;)Ljava/lang/CharSequence;
    .locals 7
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v1}, Lcom/android/settings/display/FontFragment;->br(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 90
    sget-object v3, Lcom/android/settings/display/FontFragment;->lU:Landroid/util/SparseArray;
    ...
    :goto_3
    iput v0, p0, Lcom/android/settings/display/FontFragment;->aal:I
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/display/FontFragment;->bs(Landroid/content/Context;)Ljava/lang/CharSequence;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 112
    iget v0, p0, Lcom/android/settings/display/FontFragment;->aal:I

    if-eq v2, v0, :cond_0

    .line 113
    iget-object v0, p0, Lcom/android/settings/display/FontFragment;->aak:Ljava/util/ArrayList;

    iget v3, p0, Lcom/android/settings/display/FontFragment;->aal:I
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/dm;->setChecked(Z)V

    .line 114
    iput v2, p0, Lcom/android/settings/display/FontFragment;->aal:I

    .line 116
    sget-object v0, Lcom/android/settings/display/FontFragment;->lU:Landroid/util/SparseArray;

    sget-object v1, Lcom/android/settings/display/FontFragment;->lU:Landroid/util/SparseArray;
    ...
    invoke-static {v1, v0}, Lcom/android/settings/display/s;->n(Landroid/content/Context;I)Z
