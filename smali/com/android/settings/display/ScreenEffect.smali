...
# static fields
.field private static final abG:[Ljava/lang/String;
...
# instance fields
.field private Tl:Landroid/widget/Toast;

.field private abM:I

.field private abN:Lmiui/hareware/display/DisplayFeatureManager;

.field private abO:Lcom/android/settings/display/N;

.field private abP:Lcom/android/settings/display/M;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/display/ScreenEffect;->abG:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/display/ScreenEffect;->abH:[I
    ...
    sput v0, Lcom/android/settings/display/ScreenEffect;->abI:I
    ...
    sput-object v0, Lcom/android/settings/display/ScreenEffect;->abJ:[I
    ...
    sput-object v0, Lcom/android/settings/display/ScreenEffect;->abK:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/display/ScreenEffect;->abL:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/display/ScreenEffect;->abN:Lmiui/hareware/display/DisplayFeatureManager;
...
.method static synthetic a(Lcom/android/settings/display/ScreenEffect;)Landroid/widget/Toast;
    ...
    .prologue
    .line 52
    iget-object v0, p0, Lcom/android/settings/display/ScreenEffect;->Tl:Landroid/widget/Toast;
...
.method static synthetic a(Lcom/android/settings/display/ScreenEffect;I)V
    ...
    .prologue
    .line 52
    invoke-direct {p0, p1}, Lcom/android/settings/display/ScreenEffect;->bY(I)V
...
.method private bX(I)V
    ...
    check-cast v0, Lcom/android/settings/display/K;
    ...
    .line 290
    invoke-virtual {v0, v2}, Lcom/android/settings/display/K;->setEnabled(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/display/K;->setEnabled(Z)V

    .line 293
    invoke-virtual {v0, v2}, Lcom/android/settings/display/K;->setLevel(I)V
...
.method private bY(I)V
    ...
    .prologue
    .line 344
    iget-object v0, p0, Lcom/android/settings/display/ScreenEffect;->abN:Lmiui/hareware/display/DisplayFeatureManager;
...
.method private bZ(I)V
    ...
    .line 356
    iget v2, p0, Lcom/android/settings/display/ScreenEffect;->abM:I
    ...
    .line 359
    :cond_0
    iput p1, p0, Lcom/android/settings/display/ScreenEffect;->abM:I
    ...
    .line 363
    :pswitch_0
    iget-object v2, p0, Lcom/android/settings/display/ScreenEffect;->abN:Lmiui/hareware/display/DisplayFeatureManager;
    ...
    sget v3, Lcom/android/settings/display/ScreenEffect;->abI:I
    ...
    .line 379
    :pswitch_2
    iget-object v1, p0, Lcom/android/settings/display/ScreenEffect;->abN:Lmiui/hareware/display/DisplayFeatureManager;
...
.method static synthetic c(Lcom/android/settings/display/ScreenEffect;I)V
    ...
    .prologue
    .line 52
    invoke-direct {p0, p1}, Lcom/android/settings/display/ScreenEffect;->bZ(I)V
...
.method private qk()V
    ...
    sget-object v1, Lcom/android/settings/display/ScreenEffect;->abJ:[I
    ...
    invoke-direct {v2, p0}, Lcom/android/settings/display/K;-><init>(Landroid/content/Context;)V

    .line 182
    const-string v3, "screen_color_level"

    invoke-virtual {v2, v3}, Lcom/android/settings/display/K;->setKey(Ljava/lang/String;)V

    .line 183
    const v3, 0x7f0e00a2

    invoke-virtual {v2, v3}, Lcom/android/settings/display/K;->bU(I)V

    .line 184
    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/android/settings/display/K;->setPersistent(Z)V

    .line 185
    add-int/lit8 v0, v0, -0x1

    invoke-virtual {v2, v0}, Lcom/android/settings/display/K;->setLevel(I)V

    .line 186
    invoke-virtual {v2, p0}, Lcom/android/settings/display/K;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
...
.method private ql()V
    ...
    .line 198
    invoke-virtual {p0}, Lcom/android/settings/display/ScreenEffect;->qn()I

    move-result v0

    iput v0, p0, Lcom/android/settings/display/ScreenEffect;->abM:I
    ...
    .line 201
    sget v2, Lcom/android/settings/display/ScreenEffect;->abI:I

    if-nez v2, :cond_0

    const-string v2, "screen_optimize_standard"

    sget-object v6, Lcom/android/settings/display/ScreenEffect;->abG:[Ljava/lang/String;
    ...
    .line 205
    :cond_0
    new-instance v6, Lcom/android/settings/display/I;

    invoke-direct {v6, p0}, Lcom/android/settings/display/I;-><init>(Landroid/content/Context;)V

    .line 206
    sget-object v2, Lcom/android/settings/display/ScreenEffect;->abG:[Ljava/lang/String;

    aget-object v2, v2, v0

    invoke-virtual {v6, v2}, Lcom/android/settings/display/I;->setKey(Ljava/lang/String;)V

    .line 207
    aget-object v2, v4, v0

    invoke-virtual {v6, v2}, Lcom/android/settings/display/I;->setTitle(Ljava/lang/CharSequence;)V

    .line 208
    aget-object v2, v5, v0

    invoke-virtual {v6, v2}, Lcom/android/settings/display/I;->setSummary(Ljava/lang/CharSequence;)V

    .line 209
    invoke-virtual {v6, v1}, Lcom/android/settings/display/I;->setPersistent(Z)V

    .line 210
    invoke-virtual {v6, p0}, Lcom/android/settings/display/I;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 211
    invoke-virtual {v3, v6}, Landroid/preference/PreferenceCategory;->addPreference(Landroid/preference/Preference;)Z

    .line 212
    sget-object v2, Lcom/android/settings/display/ScreenEffect;->abH:[I

    aget v2, v2, v0

    iget v7, p0, Lcom/android/settings/display/ScreenEffect;->abM:I
    ...
    :goto_2
    invoke-virtual {v6, v2}, Lcom/android/settings/display/I;->setChecked(Z)V
...
.method private qm()V
    ...
    sget-object v2, Lcom/android/settings/display/ScreenEffect;->abL:[I
    ...
    .line 226
    sget-object v2, Lcom/android/settings/display/ScreenEffect;->abK:[Ljava/lang/String;
...
.method private x(Ljava/lang/String;Ljava/lang/String;)V
    ...
    check-cast v1, Lcom/android/settings/display/I;

    .line 275
    if-eqz v1, :cond_0

    .line 276
    invoke-virtual {v1}, Lcom/android/settings/display/I;->getKey()Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/android/settings/display/I;->setChecked(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/display/N;-><init>(Lcom/android/settings/display/ScreenEffect;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/settings/display/ScreenEffect;->abO:Lcom/android/settings/display/N;
    ...
    new-instance v1, Lcom/android/settings/display/L;

    invoke-direct {v1, p0}, Lcom/android/settings/display/L;-><init>(Lcom/android/settings/display/ScreenEffect;)V
    ...
    .line 135
    invoke-direct {p0}, Lcom/android/settings/display/ScreenEffect;->qk()V
    ...
    .line 140
    invoke-direct {p0}, Lcom/android/settings/display/ScreenEffect;->ql()V

    .line 141
    iget v0, p0, Lcom/android/settings/display/ScreenEffect;->abM:I

    invoke-direct {p0, v0}, Lcom/android/settings/display/ScreenEffect;->bX(I)V
    ...
    iput-object v0, p0, Lcom/android/settings/display/ScreenEffect;->Tl:Landroid/widget/Toast;

    .line 153
    new-instance v0, Lcom/android/settings/display/M;

    invoke-direct {v0, p0}, Lcom/android/settings/display/M;-><init>(Lcom/android/settings/display/ScreenEffect;)V

    iput-object v0, p0, Lcom/android/settings/display/ScreenEffect;->abP:Lcom/android/settings/display/M;

    .line 154
    iget-object v0, p0, Lcom/android/settings/display/ScreenEffect;->abP:Lcom/android/settings/display/M;

    invoke-virtual {v0}, Lcom/android/settings/display/M;->register()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/display/M;->onChange(Z)V
    ...
    .line 145
    invoke-direct {p0}, Lcom/android/settings/display/ScreenEffect;->qm()V
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/display/M;->unregister()V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 329
    :goto_0
    iget-object v6, p0, Lcom/android/settings/display/ScreenEffect;->abO:Lcom/android/settings/display/N;

    iget-object v7, p0, Lcom/android/settings/display/ScreenEffect;->abO:Lcom/android/settings/display/N;

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v8

    invoke-virtual {v7, v3, v8}, Lcom/android/settings/display/N;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/android/settings/display/N;->sendMessage(Landroid/os/Message;)Z

    .line 331
    if-ne v3, v4, :cond_0

    .line 332
    invoke-direct {p0, v1}, Lcom/android/settings/display/ScreenEffect;->bX(I)V

    .line 335
    :cond_0
    instance-of v1, p1, Lcom/android/settings/display/I;

    if-eqz v1, :cond_1

    .line 336
    invoke-direct {p0, v0, v5}, Lcom/android/settings/display/ScreenEffect;->x(Ljava/lang/String;Ljava/lang/String;)V
...
.method public qn()I
    ...
    .line 246
    sget v0, Lcom/android/settings/display/ScreenEffect;->abI:I
