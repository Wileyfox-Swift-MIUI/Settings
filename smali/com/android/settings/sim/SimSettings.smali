...
.field private aso:Ljava/util/List;

.field private asp:Landroid/preference/PreferenceScreen;

.field private asq:I

.field private final asr:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
...
.field private final yB:Landroid/telephony/PhoneStateListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/sim/SimSettings;->ix:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    .line 64
    iput-object v1, p0, Lcom/android/settings/sim/SimSettings;->aso:Ljava/util/List;

    .line 65
    iput-object v1, p0, Lcom/android/settings/sim/SimSettings;->ic:Ljava/util/List;

    .line 66
    iput-object v1, p0, Lcom/android/settings/sim/SimSettings;->YH:Ljava/util/List;

    .line 67
    iput-object v1, p0, Lcom/android/settings/sim/SimSettings;->asp:Landroid/preference/PreferenceScreen;
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->asr:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->yB:Landroid/telephony/PhoneStateListener;
...
.method static synthetic a(Lcom/android/settings/sim/SimSettings;)V
    ...
    .prologue
    .line 47
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uS()V
...
.method private bX()V
    ...
    .prologue
    .line 133
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uT()V

    .line 134
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uU()V
...
.method private uS()V
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->ic:Ljava/util/List;

    move v0, v1

    .line 109
    :goto_0
    iget v2, p0, Lcom/android/settings/sim/SimSettings;->asq:I

    if-ge v0, v2, :cond_1

    .line 110
    iget-object v2, p0, Lcom/android/settings/sim/SimSettings;->asp:Landroid/preference/PreferenceScreen;
    ...
    .line 112
    iget-object v3, p0, Lcom/android/settings/sim/SimSettings;->asp:Landroid/preference/PreferenceScreen;
    ...
    .line 115
    :cond_1
    iget-object v0, p0, Lcom/android/settings/sim/SimSettings;->aso:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    .line 116
    iget-object v0, p0, Lcom/android/settings/sim/SimSettings;->YH:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    .line 118
    :goto_1
    iget v0, p0, Lcom/android/settings/sim/SimSettings;->asq:I
    ...
    .line 122
    iget v3, p0, Lcom/android/settings/sim/SimSettings;->asq:I
    ...
    .line 124
    iget-object v2, p0, Lcom/android/settings/sim/SimSettings;->aso:Ljava/util/List;
    ...
    .line 126
    iget-object v2, p0, Lcom/android/settings/sim/SimSettings;->YH:Ljava/util/List;
    ...
    .line 129
    :cond_3
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->bX()V
...
.method private uT()V
    ...
    .prologue
    .line 138
    iget-object v0, p0, Lcom/android/settings/sim/SimSettings;->asp:Landroid/preference/PreferenceScreen;
...
.method private uU()V
    ...
    .prologue
    .line 148
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uW()V

    .line 149
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uX()V

    .line 150
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings;->uV()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput v0, p0, Lcom/android/settings/sim/SimSettings;->asq:I
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->asp:Landroid/preference/PreferenceScreen;

    .line 93
    new-instance v0, Ljava/util/ArrayList;

    iget v1, p0, Lcom/android/settings/sim/SimSettings;->asq:I

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(I)V

    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->aso:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings;->YH:Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/android/settings/sim/SimSelectNotification;->cu(Landroid/content/Context;)V
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings/sim/SimSettings;->asr:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    .line 211
    iget-object v1, p0, Lcom/android/settings/sim/SimSettings;->yB:Landroid/telephony/PhoneStateListener;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 243
    sget-object v2, Lcom/android/settings/sim/SimDialogActivity;->arU:Ljava/lang/String;
