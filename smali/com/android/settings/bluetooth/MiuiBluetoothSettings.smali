...
# instance fields
.field SO:Lmiui/bluetooth/ble/MiBleDeviceManager;

.field private SU:Lcom/android/settings/eP;

.field private SV:Lmiui/preference/ValuePreference;

.field SW:Z

.field private SX:Lcom/android/settings/bluetooth/GattProfile;

.field private SY:I

.field private SZ:Landroid/preference/Preference$OnPreferenceClickListener;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SW:Z

    .line 54
    const/16 v0, 0xa

    iput v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SY:I
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SZ:Landroid/preference/Preference$OnPreferenceClickListener;
...
.method static synthetic a(Lcom/android/settings/bluetooth/MiuiBluetoothSettings;)Lcom/android/settings/bluetooth/GattProfile;
    ...
    .prologue
    .line 41
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SX:Lcom/android/settings/bluetooth/GattProfile;
...
.method private og()V
    ...
    .line 146
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Rk:Lcom/android/b/b/Q;

    invoke-virtual {v1, v0}, Lcom/android/b/b/Q;->setName(Ljava/lang/String;)V

    .line 147
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SV:Lmiui/preference/ValuePreference;
...
.method public a(Lcom/android/b/b/H;I)V
    ...
    .prologue
    .line 244
    iput p2, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SY:I
    ...
    .line 246
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->nV()V
    ...
    .line 248
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Rk:Lcom/android/b/b/Q;

    invoke-virtual {v0}, Lcom/android/b/b/Q;->AV()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->bk(I)V
...
.method protected aD(Z)V
    ...
    .line 254
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SU:Lcom/android/settings/eP;
...
.method public b(Lcom/android/b/b/H;)V
    ...
    .prologue
    .line 262
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Sb:Ljava/util/WeakHashMap;
    ...
    .line 271
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SW:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SO:Lmiui/bluetooth/ble/MiBleDeviceManager;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SX:Lcom/android/settings/bluetooth/GattProfile;
    ...
    .line 282
    :cond_3
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RX:Lcom/android/b/b/n;

    sget-object v1, Lcom/android/b/b/h;->aKS:Lcom/android/b/b/n;
...
.method protected bk(I)V
    ...
    .line 152
    invoke-direct {p0}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->og()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RS:Landroid/preference/CheckBoxPreference;
    ...
    .line 173
    invoke-super {p0, p1}, Lcom/android/settings/bluetooth/BluetoothSettings;->bk(I)V
    ...
    .line 163
    :cond_2
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RL:Lcom/android/settings/bluetooth/MiuiBluetoothDiscoverableEnabler;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Rk:Lcom/android/b/b/Q;

    iget-object v3, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RS:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RL:Lcom/android/settings/bluetooth/MiuiBluetoothDiscoverableEnabler;
...
.method public bl(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->aD(Z)V
    ...
    .line 239
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->bk(I)V
...
.method c(Lcom/android/b/b/H;)V
    ...
    .prologue
    .line 188
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Sa:Landroid/preference/PreferenceGroup;
    ...
    .line 196
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Sa:Landroid/preference/PreferenceGroup;

    invoke-virtual {v1, v0}, Landroid/preference/PreferenceGroup;->addPreference(Landroid/preference/Preference;)Z

    .line 197
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->Sb:Ljava/util/WeakHashMap;
...
.method e(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    .line 311
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SO:Lmiui/bluetooth/ble/MiBleDeviceManager;
...
.method nT()V
    ...
    .line 113
    invoke-super {p0}, Lcom/android/settings/bluetooth/BluetoothSettings;->nT()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RM:Landroid/preference/CheckBoxPreference;

    .line 116
    new-instance v0, Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;

    iget-object v3, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RM:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RK:Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SV:Lmiui/preference/ValuePreference;

    .line 118
    iget-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SV:Lmiui/preference/ValuePreference;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SZ:Landroid/preference/Preference$OnPreferenceClickListener;
    ...
    .line 120
    iget-object v2, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SV:Lmiui/preference/ValuePreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RS:Landroid/preference/CheckBoxPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SU:Lcom/android/settings/eP;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SO:Lmiui/bluetooth/ble/MiBleDeviceManager;
    ...
    iget-object v3, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RZ:Lcom/android/b/b/R;

    invoke-virtual {v3}, Lcom/android/b/b/R;->Ba()Lcom/android/b/b/J;

    move-result-object v3

    iget-object v4, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RZ:Lcom/android/b/b/R;

    invoke-virtual {v4}, Lcom/android/b/b/R;->Bc()Lcom/android/b/b/U;

    move-result-object v4

    iget-object v5, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SO:Lmiui/bluetooth/ble/MiBleDeviceManager;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SX:Lcom/android/settings/bluetooth/GattProfile;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 211
    iget-object v4, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SU:Lcom/android/settings/eP;
    ...
    .line 215
    invoke-virtual {p0, v2}, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->aD(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 223
    :pswitch_0
    iget v0, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->SY:I
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 128
    iget-object v1, p0, Lcom/android/settings/bluetooth/MiuiBluetoothSettings;->RK:Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;
    ...
    invoke-virtual {v1, v0}, Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;->aE(Z)V
