...
.method private b(Landroid/bluetooth/BluetoothDevice;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sg:Z
    ...
    .line 181
    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sd:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Se:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Se:Ljava/lang/String;
...
.method public a(Lcom/android/b/b/H;I)V
    ...
    .line 161
    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->RY:Landroid/bluetooth/BluetoothDevice;
...
.method public bl(I)V
    ...
    .line 173
    iget-object v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Rk:Lcom/android/b/b/Q;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/b/b/Q;->bW(Z)V
...
.method d(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    invoke-static {v0, v1}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->p(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sc:Z

    if-nez v0, :cond_1

    .line 150
    :cond_0
    iget-object v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->RY:Landroid/bluetooth/BluetoothDevice;
...
.method nT()V
    ...
    iput-boolean v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sc:Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/bluetooth/DevicePickerFragment;->aQ(I)V
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sd:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Se:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sf:Z
    ...
    .line 111
    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Rk:Lcom/android/b/b/Q;
...
.method public onDestroy()V
    ...
    .line 132
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sg:Z
...
.method public onResume()V
    ...
    .line 118
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DevicePickerFragment;->nW()V

    .line 119
    iput-boolean v2, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sg:Z

    .line 120
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sf:Z
    ...
    .line 122
    iput-boolean v2, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->Sf:Z
