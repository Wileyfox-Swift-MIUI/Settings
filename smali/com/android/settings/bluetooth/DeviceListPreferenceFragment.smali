...
# instance fields
.field protected RX:Lcom/android/b/b/n;

.field RY:Landroid/bluetooth/BluetoothDevice;

.field RZ:Lcom/android/b/b/R;

.field Rk:Lcom/android/b/b/Q;

.field protected Sa:Landroid/preference/PreferenceGroup;

.field final Sb:Ljava/util/WeakHashMap;
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sb:Ljava/util/WeakHashMap;

    .line 71
    sget-object v0, Lcom/android/b/b/h;->aKR:Lcom/android/b/b/n;

    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RX:Lcom/android/b/b/n;
...
.method final a(Lcom/android/b/b/n;)V
    ...
    .prologue
    .line 75
    iput-object p1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RX:Lcom/android/b/b/n;
...
.method public aC(Z)V
    ...
    .prologue
    .line 217
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->aD(Z)V
...
.method protected aD(Z)V
    ...
    .prologue
    .line 223
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sa:Landroid/preference/PreferenceGroup;
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/bluetooth/BluetoothProgressCategory;->R(Z)V
...
.method final aQ(I)V
    ...
    .prologue
    .line 79
    invoke-static {p1}, Lcom/android/b/b/h;->dW(I)Lcom/android/b/b/n;
...
.method b(Landroid/preference/PreferenceGroup;)V
    ...
    .prologue
    .line 99
    iput-object p1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sa:Landroid/preference/PreferenceGroup;
...
.method public b(Lcom/android/b/b/H;)V
    ...
    .prologue
    .line 174
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sb:Ljava/util/WeakHashMap;
    ...
    .line 179
    :cond_1
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Rk:Lcom/android/b/b/Q;
    ...
    .line 181
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RX:Lcom/android/b/b/n;
...
.method public bl(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->aD(Z)V
...
.method c(Lcom/android/b/b/H;)V
    ...
    .line 197
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sa:Landroid/preference/PreferenceGroup;

    invoke-virtual {v1, v0}, Landroid/preference/PreferenceGroup;->addPreference(Landroid/preference/Preference;)Z

    .line 198
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sb:Ljava/util/WeakHashMap;
...
.method d(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    .prologue
    .line 170
    invoke-virtual {p1}, Lcom/android/settings/bluetooth/BluetoothDevicePreference;->ny()V
...
.method nV()V
    ...
    .line 136
    iget-object v2, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sa:Landroid/preference/PreferenceGroup;
...
.method nW()V
    ...
    .prologue
    .line 143
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RZ:Lcom/android/b/b/R;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RZ:Lcom/android/b/b/R;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Rk:Lcom/android/b/b/Q;

    .line 93
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->nT()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Sa:Landroid/preference/PreferenceGroup;
...
.method public onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->hz()Z
    ...
    .line 123
    :cond_1
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->nV()V
    ...
    invoke-virtual {v0}, Lcom/android/b/b/R;->Bb()Lcom/android/b/b/t;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 154
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->Rk:Lcom/android/b/b/Q;
    ...
    .line 160
    invoke-virtual {p2}, Lcom/android/settings/bluetooth/BluetoothDevicePreference;->nw()Lcom/android/b/b/H;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->RY:Landroid/bluetooth/BluetoothDevice;
