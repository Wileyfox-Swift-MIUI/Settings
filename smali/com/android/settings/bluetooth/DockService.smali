...
# instance fields
.field private Rk:Lcom/android/b/b/Q;
...
.field private final SE:Landroid/content/DialogInterface$OnMultiChoiceClickListener;

.field private final SF:Landroid/widget/CompoundButton$OnCheckedChangeListener;

.field private final SG:Landroid/content/DialogInterface$OnDismissListener;

.field private final SH:Landroid/content/DialogInterface$OnClickListener;

.field private Sj:Lcom/android/b/b/U;

.field private volatile St:Landroid/os/Looper;

.field private volatile Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;

.field private Sv:Ljava/lang/Runnable;

.field private Sw:Lcom/android/b/b/J;

.field private Sx:[Lcom/android/b/b/T;

.field private Sy:I

.field private Sz:Landroid/bluetooth/BluetoothDevice;
...
.method public constructor <init>()V
    ...
    .line 128
    iput v0, p0, Lcom/android/settings/bluetooth/DockService;->SB:I

    .line 129
    iput v0, p0, Lcom/android/settings/bluetooth/DockService;->SC:I
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->SE:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->SF:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->SG:Landroid/content/DialogInterface$OnDismissListener;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->SH:Landroid/content/DialogInterface$OnClickListener;
...
.method private a(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .prologue
    .line 333
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;
    ...
    .line 335
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;
...
.method private declared-synchronized a(Landroid/bluetooth/BluetoothDevice;Lcom/android/b/b/T;I)V
    ...
    .line 792
    invoke-direct {p0, v0}, Lcom/android/settings/bluetooth/DockService;->f(Landroid/bluetooth/BluetoothDevice;)Lcom/android/b/b/H;
...
.method private a(Landroid/content/Intent;I)V
    ...
    .line 698
    :try_start_0
    invoke-direct {p0, p2}, Lcom/android/settings/bluetooth/DockService;->bo(I)V
    ...
    .line 704
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DockService;->ob()Landroid/content/SharedPreferences;
    ...
    .line 711
    :try_start_1
    iget v0, p0, Lcom/android/settings/bluetooth/DockService;->SC:I
    ...
    .line 717
    :cond_3
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;

    if-eqz v0, :cond_4

    .line 718
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;

    invoke-virtual {v0}, Lcom/android/b/b/Q;->enable()Z

    .line 719
    iput p2, p0, Lcom/android/settings/bluetooth/DockService;->SB:I
...
.method private a(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    .line 340
    invoke-direct {p0, p1}, Lcom/android/settings/bluetooth/DockService;->e(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 350
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/DockService;->c(Landroid/bluetooth/BluetoothDevice;)Z
...
.method private a(Landroid/bluetooth/BluetoothDevice;IZ)[Ljava/lang/CharSequence;
    ...
    iput-object v2, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;
    ...
    .line 680
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;

    iget-object v2, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;

    invoke-virtual {v2}, Lcom/android/b/b/U;->Bh()Lcom/android/b/b/a;
    ...
    .line 664
    iget-object v2, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;

    iget-object v3, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;

    invoke-virtual {v3}, Lcom/android/b/b/U;->Bj()Lcom/android/b/b/K;
    ...
    invoke-virtual {v3}, Lcom/android/b/b/U;->Bh()Lcom/android/b/b/a;
    ...
    iget-object v3, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;
...
.method private declared-synchronized b(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 824
    iget-object v5, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;

    invoke-virtual {v5}, Lcom/android/b/b/Q;->AV()I

    move-result v5

    .line 830
    iget-object v6, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;
    ...
    .line 838
    :cond_2
    iput-object p1, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;

    .line 839
    iput p2, p0, Lcom/android/settings/bluetooth/DockService;->SA:I
    ...
    :try_start_2
    iput-object v2, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;

    .line 852
    invoke-direct {p0, p1}, Lcom/android/settings/bluetooth/DockService;->f(Landroid/bluetooth/BluetoothDevice;)Lcom/android/b/b/H;
    ...
    .line 854
    :goto_2
    iget-object v4, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;
    ...
    .line 866
    iget-object v5, p0, Lcom/android/settings/bluetooth/DockService;->Sx:[Lcom/android/b/b/T;
    ...
    invoke-virtual {v3, v0}, Lcom/android/b/b/H;->bU(Z)V
    :try_end_2
...
.method private b(Landroid/bluetooth/BluetoothDevice;II)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/bluetooth/DockService;->e(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 397
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;
    ...
    invoke-virtual {v1}, Lcom/android/b/b/U;->Bg()Z
    ...
    .line 401
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sv:Ljava/lang/Runnable;
...
.method private bn(I)Z
    ...
    .line 322
    iput p1, p0, Lcom/android/settings/bluetooth/DockService;->SC:I
...
.method private bo(I)V
    ...
    iget v1, p0, Lcom/android/settings/bluetooth/DockService;->SA:I

    invoke-direct {p0, v0, v1}, Lcom/android/settings/bluetooth/DockService;->b(Landroid/bluetooth/BluetoothDevice;I)V

    .line 739
    :cond_0
    iput-object v5, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;

    .line 740
    iget v0, p0, Lcom/android/settings/bluetooth/DockService;->SA:I
    ...
    :cond_1
    :goto_0
    iget v0, p0, Lcom/android/settings/bluetooth/DockService;->SB:I
    ...
    .line 769
    iput v3, p0, Lcom/android/settings/bluetooth/DockService;->SB:I
    ...
    .line 756
    invoke-direct {p0, v0}, Lcom/android/settings/bluetooth/DockService;->d(Landroid/bluetooth/BluetoothDevice;)V
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;
...
.method private c(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .line 512
    iput-object v8, p0, Lcom/android/settings/bluetooth/DockService;->SD:Landroid/widget/CheckBox;
    ...
    invoke-static {p0, v2}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->q(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v7, p0, Lcom/android/settings/bluetooth/DockService;->SE:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    invoke-static {p0, v2}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->r(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 534
    iget-object v2, p0, Lcom/android/settings/bluetooth/DockService;->SF:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/DockService;->SH:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v0, v1, v2}, Landroid/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    .line 561
    iput p3, p0, Lcom/android/settings/bluetooth/DockService;->Sy:I
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->SG:Landroid/content/DialogInterface$OnDismissListener;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->SD:Landroid/widget/CheckBox;
    ...
    .line 549
    :goto_4
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->SD:Landroid/widget/CheckBox;
    ...
    iget-object v4, p0, Lcom/android/settings/bluetooth/DockService;->SF:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method static synthetic d(Lcom/android/settings/bluetooth/DockService;)I
    ...
    .prologue
    .line 59
    iget v0, p0, Lcom/android/settings/bluetooth/DockService;->Sy:I
...
.method private declared-synchronized d(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 806
    invoke-virtual {v1}, Lcom/android/b/b/H;->AD()Ljava/util/List;
    ...
    invoke-virtual {v1, v0}, Lcom/android/b/b/H;->bU(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized d(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-static {p0, v0}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->r(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private declared-synchronized d(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 299
    :sswitch_4
    invoke-direct {p0, v4}, Lcom/android/settings/bluetooth/DockService;->bn(I)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method static synthetic e(Lcom/android/settings/bluetooth/DockService;)Landroid/widget/CheckBox;
    ...
    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->SD:Landroid/widget/CheckBox;
...
.method private declared-synchronized e(Landroid/bluetooth/BluetoothDevice;)V
    ...
    :try_start_0
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sv:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sz:Landroid/bluetooth/BluetoothDevice;
...
.method private f(Landroid/bluetooth/BluetoothDevice;)Lcom/android/b/b/H;
    ...
    .prologue
    .line 911
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sw:Lcom/android/b/b/J;
...
.method private ob()Landroid/content/SharedPreferences;
    .locals 2
...
.method private t(Landroid/content/Intent;)Landroid/os/Message;
    .locals 5
    ...
    .line 485
    :goto_1
    iget-object v3, p0, Lcom/android/settings/bluetooth/DockService;->Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;
...
.method declared-synchronized c(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-virtual {v0}, Lcom/android/b/b/J;->AQ()Ljava/util/Collection;
...
.method public onCreate()V
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Rk:Lcom/android/b/b/Q;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sw:Lcom/android/b/b/J;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->St:Landroid/os/Looper;

    .line 155
    new-instance v0, Lcom/android/settings/bluetooth/DockService$ServiceHandler;

    iget-object v1, p0, Lcom/android/settings/bluetooth/DockService;->St:Landroid/os/Looper;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;
...
.method public onDestroy()V
    ...
    .line 169
    :cond_1
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->St:Landroid/os/Looper;
    ...
    .line 175
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Sj:Lcom/android/b/b/U;

    .line 176
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->St:Landroid/os/Looper;

    .line 177
    iput-object v1, p0, Lcom/android/settings/bluetooth/DockService;->Su:Lcom/android/settings/bluetooth/DockService$ServiceHandler;
...
.method public declared-synchronized onServiceConnected()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/bluetooth/DockService;->Sv:Ljava/lang/Runnable;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-virtual {v1}, Lcom/android/b/b/U;->Bj()Lcom/android/b/b/K;

    move-result-object v1

    invoke-direct {p0, v0, v1, p3}, Lcom/android/settings/bluetooth/DockService;->a(Landroid/bluetooth/BluetoothDevice;Lcom/android/b/b/T;I)V
    ...
    invoke-virtual {v1}, Lcom/android/b/b/U;->Bh()Lcom/android/b/b/a;
    ...
    .line 235
    :cond_4
    invoke-direct {p0, p1}, Lcom/android/settings/bluetooth/DockService;->t(Landroid/content/Intent;)Landroid/os/Message;
