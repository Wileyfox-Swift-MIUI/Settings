...
.field final ayC:Landroid/net/IConnectivityManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->dF:Landroid/security/KeyStore;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->ayC:Landroid/net/IConnectivityManager;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->tE:Landroid/os/UserManager;
...
.method private cq(Ljava/lang/String;)Z
    ...
    .line 141
    invoke-virtual {p0}, Lcom/android/settings/vpn2/VpnManager;->wQ()Ljava/util/List;
...
.method public a(Lcom/android/internal/net/VpnProfile;Landroid/app/Activity;)V
    ...
    .line 164
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->ayC:Landroid/net/IConnectivityManager;
...
.method public varargs d([I)Ljava/util/List;
    ...
    .line 59
    iget-object v1, p0, Lcom/android/settings/vpn2/VpnManager;->dF:Landroid/security/KeyStore;
    ...
    .line 65
    iget-object v5, p0, Lcom/android/settings/vpn2/VpnManager;->dF:Landroid/security/KeyStore;
...
.method public wP()I
    ...
    .prologue
    .line 45
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->dF:Landroid/security/KeyStore;

    if-nez v0, :cond_0

    .line 46
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->TAG:Ljava/lang/String;

    const-string v1, "mKeyStore is null, something wrong"
    ...
    const-string v1, "keystore_is_null"
...
.method public wQ()Ljava/util/List;
    ...
    .line 79
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnManager;->tE:Landroid/os/UserManager;
...
.method public wR()I
    ...
    .line 124
    iget-object v3, p0, Lcom/android/settings/vpn2/VpnManager;->ayC:Landroid/net/IConnectivityManager;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/vpn2/VpnManager;->cq(Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
