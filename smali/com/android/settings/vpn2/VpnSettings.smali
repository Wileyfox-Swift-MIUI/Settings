...
# static fields
.field private static final ayp:Landroid/net/NetworkRequest;


# instance fields
.field protected final ayC:Landroid/net/IConnectivityManager;

.field ayD:Ljava/util/HashMap;

.field ayE:Ljava/util/HashMap;

.field protected ayF:Lcom/android/internal/net/LegacyVpnInfo;

.field ayG:Landroid/preference/PreferenceCategory;

.field protected ayH:Landroid/view/View$OnClickListener;

.field private ayn:Landroid/net/ConnectivityManager;

.field protected ayq:Landroid/os/Handler;

.field private ayr:Landroid/net/ConnectivityManager$NetworkCallback;

.field private bc:Z

.field final dF:Landroid/security/KeyStore;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/vpn2/VpnSettings;->ayp:Landroid/net/NetworkRequest;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayC:Landroid/net/IConnectivityManager;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->dF:Landroid/security/KeyStore;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayD:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayE:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayH:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayr:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method protected static l(ILjava/lang/String;)Ljava/lang/String;
    .locals 2
...
.method private wS()Ljava/util/List;
    ...
    .line 418
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->tE:Landroid/os/UserManager;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    .line 235
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayq:Landroid/os/Handler;

    invoke-virtual {v0, v8}, Landroid/os/Handler;->removeMessages(I)V

    .line 240
    iget-object v1, p0, Lcom/android/settings/vpn2/VpnSettings;->ayG:Landroid/preference/PreferenceCategory;

    .line 241
    invoke-virtual {v1}, Landroid/preference/PreferenceGroup;->removeAll()V

    .line 243
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayD:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 244
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayE:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 247
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->dF:Landroid/security/KeyStore;

    new-array v2, v8, [I

    invoke-static {v0, v2}, Lcom/android/settings/vpn2/VpnSettings;->a(Landroid/security/KeyStore;[I)Ljava/util/List;
    ...
    iget-object v5, p0, Lcom/android/settings/vpn2/VpnSettings;->ayH:Landroid/view/View$OnClickListener;
    ...
    .line 252
    new-instance v4, Lcom/android/settings/vpn2/VpnSettings$1;

    invoke-direct {v4, p0}, Lcom/android/settings/vpn2/VpnSettings$1;-><init>(Lcom/android/settings/vpn2/VpnSettings;)V

    invoke-virtual {v3, v4}, Lcom/android/settings/vpn2/ConfigPreference;->c(Landroid/view/View$OnClickListener;)V

    .line 261
    iget-object v4, p0, Lcom/android/settings/vpn2/VpnSettings;->ayD:Ljava/util/HashMap;
    ...
    .line 266
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/vpn2/VpnSettings;->wS()Ljava/util/List;
    ...
    invoke-static {v3, v4}, Lcom/android/settings/vpn2/VpnSettings;->l(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/settings/vpn2/VpnSettings;->ayH:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/vpn2/VpnSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayG:Landroid/preference/PreferenceCategory;
    ...
    :try_start_0
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayF:Lcom/android/internal/net/LegacyVpnInfo;

    .line 286
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayC:Landroid/net/IConnectivityManager;
    ...
    .line 291
    iput-object v1, p0, Lcom/android/settings/vpn2/VpnSettings;->ayF:Lcom/android/internal/net/LegacyVpnInfo;
    ...
    .line 297
    iget-object v2, p0, Lcom/android/settings/vpn2/VpnSettings;->ayC:Landroid/net/IConnectivityManager;
    ...
    invoke-static {v0, v2}, Lcom/android/settings/vpn2/VpnSettings;->l(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 300
    iget-object v2, p0, Lcom/android/settings/vpn2/VpnSettings;->ayE:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->tE:Landroid/os/UserManager;
    ...
    .line 135
    iput-boolean v2, p0, Lcom/android/settings/vpn2/VpnSettings;->bc:Z
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayn:Landroid/net/ConnectivityManager;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 171
    :goto_1
    iget-object v3, p0, Lcom/android/settings/vpn2/VpnSettings;->ayD:Ljava/util/HashMap;
    ...
    invoke-static {p0, v3, v2, v0}, Lcom/android/settings/vpn2/ConfigDialogFragment;->a(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    .line 179
    :pswitch_1
    invoke-static {p0}, Lcom/android/settings/vpn2/LockdownConfigFragment;->a(Lcom/android/settings/vpn2/VpnSettings;)V
...
.method public onPause()V
    ...
    .prologue
    .line 218
    iget-boolean v0, p0, Lcom/android/settings/vpn2/VpnSettings;->bc:Z
    ...
    .line 224
    :cond_0
    iget-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayn:Landroid/net/ConnectivityManager;

    iget-object v1, p0, Lcom/android/settings/vpn2/VpnSettings;->ayr:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p1}, Lcom/android/settings/vpn2/ConfigPreference;->wG()Lcom/android/internal/net/VpnProfile;

    move-result-object v2

    .line 320
    iget-object v3, p0, Lcom/android/settings/vpn2/VpnSettings;->ayF:Lcom/android/internal/net/LegacyVpnInfo;

    if-eqz v3, :cond_0

    iget-object v3, v2, Lcom/android/internal/net/VpnProfile;->key:Ljava/lang/String;

    iget-object v4, p0, Lcom/android/settings/vpn2/VpnSettings;->ayF:Lcom/android/internal/net/LegacyVpnInfo;
    ...
    .line 329
    :cond_0
    invoke-static {p0, v2, v1, v0}, Lcom/android/settings/vpn2/ConfigDialogFragment;->a(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    .line 352
    :cond_2
    invoke-virtual {p1}, Lcom/android/settings/vpn2/AppPreference;->wC()Landroid/content/pm/PackageInfo;
    ...
    invoke-static {p0, v3, v4, v1, v2}, Lcom/android/settings/vpn2/AppDialogFragment;->a(Lcom/android/settings/vpn2/VpnSettings;Landroid/content/pm/PackageInfo;Ljava/lang/String;ZZ)V
...
.method public onResume()V
    ...
    sget-object v1, Lcom/android/settings/vpn2/VpnSettings;->ayp:Landroid/net/NetworkRequest;

    iget-object v2, p0, Lcom/android/settings/vpn2/VpnSettings;->ayr:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/VpnSettings;->ayq:Landroid/os/Handler;
