...
# instance fields
.field protected final amo:Ljava/lang/String;

.field protected final amp:I

.field private final amq:[I

.field protected amr:Landroid/preference/TwoStatePreference;

.field protected ams:Lcom/android/settings/DropDownPreference;
...
.method public varargs constructor <init>(ILjava/lang/String;Ljava/lang/String;I[I)V
    ...
    .line 50
    iput-object p3, p0, Lcom/android/settings/notification/SettingPref;->amo:Ljava/lang/String;

    .line 51
    iput p4, p0, Lcom/android/settings/notification/SettingPref;->amp:I

    .line 52
    iput-object p5, p0, Lcom/android/settings/notification/SettingPref;->amq:[I

    .line 53
    iget v0, p0, Lcom/android/settings/notification/SettingPref;->mType:I

    iget-object v1, p0, Lcom/android/settings/notification/SettingPref;->amo:Ljava/lang/String;

    invoke-static {v0, v1}, Lcom/android/settings/notification/SettingPref;->i(ILjava/lang/String;)Landroid/net/Uri;
...
.method private static i(ILjava/lang/String;)Landroid/net/Uri;
    .locals 1
...
# virtual methods
.method public b(Lcom/android/settings/SettingsPreferenceFragment;)Landroid/preference/Preference;
    .locals 9
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/notification/SettingPref;->bX(Landroid/content/Context;)Z
    ...
    iput-object v0, p0, Lcom/android/settings/notification/SettingPref;->amr:Landroid/preference/TwoStatePreference;

    .line 79
    :cond_1
    invoke-virtual {p0, v3}, Lcom/android/settings/notification/SettingPref;->ca(Landroid/content/Context;)V

    .line 80
    iget-object v0, p0, Lcom/android/settings/notification/SettingPref;->amr:Landroid/preference/TwoStatePreference;
    ...
    .line 88
    iget-object v2, p0, Lcom/android/settings/notification/SettingPref;->amr:Landroid/preference/TwoStatePreference;
    ...
    .line 73
    :cond_3
    instance-of v0, v1, Lcom/android/settings/DropDownPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/SettingPref;->ams:Lcom/android/settings/DropDownPreference;

    .line 75
    iget-object v4, p0, Lcom/android/settings/notification/SettingPref;->amq:[I
    ...
    .line 76
    iget-object v7, p0, Lcom/android/settings/notification/SettingPref;->ams:Lcom/android/settings/DropDownPreference;

    invoke-virtual {v3}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v8

    invoke-virtual {p0, v8, v6}, Lcom/android/settings/notification/SettingPref;->b(Landroid/content/res/Resources;I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8, v6}, Lcom/android/settings/DropDownPreference;->b(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 90
    :cond_4
    iget-object v0, p0, Lcom/android/settings/notification/SettingPref;->ams:Lcom/android/settings/DropDownPreference;
    ...
    .line 97
    iget-object v2, p0, Lcom/android/settings/notification/SettingPref;->ams:Lcom/android/settings/DropDownPreference;
...
.method public ca(Landroid/content/Context;)V
    ...
    iget-object v2, p0, Lcom/android/settings/notification/SettingPref;->amo:Ljava/lang/String;

    iget v3, p0, Lcom/android/settings/notification/SettingPref;->amp:I
    ...
    .line 116
    iget-object v1, p0, Lcom/android/settings/notification/SettingPref;->amr:Landroid/preference/TwoStatePreference;
    ...
    .line 118
    :cond_2
    iget-object v1, p0, Lcom/android/settings/notification/SettingPref;->ams:Lcom/android/settings/DropDownPreference;
    ...
    invoke-virtual {v1, v0}, Lcom/android/settings/DropDownPreference;->o(Ljava/lang/Object;)V
...
.method protected t(Landroid/content/Context;I)Z
    .locals 3
