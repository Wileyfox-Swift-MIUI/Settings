...
# static fields
.field private static final amY:Ljava/util/Comparator;


# instance fields
.field private amT:Lcom/android/settings/DropDownPreference;

.field private amU:Lcom/android/settings/DropDownPreference;

.field private amV:Landroid/service/notification/ZenModeConfig$EventInfo;

.field private amW:Ljava/util/List;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amY:Ljava/util/Comparator;
...
.method static synthetic a(Lcom/android/settings/notification/ZenModeEventRuleSettings;)Landroid/service/notification/ZenModeConfig$EventInfo;
    ...
    .prologue
    .line 40
    iget-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amV:Landroid/service/notification/ZenModeConfig$EventInfo;
...
.method private static a(Lcom/android/settings/notification/ZenModeEventRuleSettings$CalendarInfo;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->j(ILjava/lang/String;)Ljava/lang/String;
...
.method private static cb(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 168
    invoke-static {v0, v1}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->g(Landroid/content/Context;Ljava/util/List;)V

    goto :goto_0

    .line 171
    :cond_1
    sget-object v0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amY:Ljava/util/Comparator;
...
.method private to()V
    ...
    invoke-static {v1}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->cb(Landroid/content/Context;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amW:Ljava/util/List;

    .line 81
    iget-object v1, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amT:Lcom/android/settings/DropDownPreference;

    invoke-virtual {v1}, Lcom/android/settings/DropDownPreference;->dW()V
    ...
    invoke-static {v2, v0}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->j(ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 83
    iget-object v1, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amV:Landroid/service/notification/ZenModeConfig$EventInfo;
    ...
    .line 85
    :goto_0
    iget-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amW:Ljava/util/List;
    ...
    .line 86
    iget-object v4, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amT:Lcom/android/settings/DropDownPreference;
    ...
    .line 92
    iget-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amT:Lcom/android/settings/DropDownPreference;

    iget-object v2, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amV:Landroid/service/notification/ZenModeConfig$EventInfo;

    iget v2, v2, Landroid/service/notification/ZenModeConfig$EventInfo;->userId:I

    invoke-static {v2, v1}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->j(ILjava/lang/String;)Ljava/lang/String;
...
.method protected b(Landroid/service/notification/ZenModeConfig$ZenRule;)Z
    ...
    :goto_0
    iput-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amV:Landroid/service/notification/ZenModeConfig$EventInfo;
...
.method public onResume()V
    ...
    .line 73
    iget-boolean v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amX:Z

    if-nez v0, :cond_0

    .line 74
    invoke-direct {p0}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->to()V

    .line 76
    :cond_0
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amX:Z
...
.method protected tp()V
    ...
    .line 98
    iput-boolean v3, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amX:Z
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amT:Lcom/android/settings/DropDownPreference;
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/DropDownPreference;->a(Lcom/android/settings/cR;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amU:Lcom/android/settings/DropDownPreference;

    .line 120
    iget-object v0, p0, Lcom/android/settings/notification/ZenModeEventRuleSettings;->amU:Lcom/android/settings/DropDownPreference;
    ...
    .line 138
    invoke-virtual {p0}, Lcom/android/settings/notification/ZenModeEventRuleSettings;->tq()V
