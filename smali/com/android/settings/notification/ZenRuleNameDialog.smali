...
# instance fields
.field private final akM:Lcom/android/settings/notification/ServiceListing;

.field private final amG:Lcom/android/settings/notification/ServiceListing$Callback;

.field private final anM:Landroid/view/View;

.field private final anN:Landroid/widget/RadioGroup;

.field private final anO:Landroid/content/res/ColorStateList;

.field private final anP:Landroid/content/res/ColorStateList;

.field private final anQ:Ljava/lang/String;

.field private final anR:Landroid/util/ArraySet;

.field private final anS:[Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;

.field private final anT:Z

.field private final mDialog:Landroid/app/AlertDialog;

.field private final rs:Landroid/widget/EditText;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settings/notification/ServiceListing;Ljava/lang/String;Landroid/util/ArraySet;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anS:[Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->amG:Lcom/android/settings/notification/ServiceListing$Callback;

    .line 64
    iput-object p2, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->akM:Lcom/android/settings/notification/ServiceListing;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anT:Z

    .line 66
    iput-object p3, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anQ:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anO:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->rs:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anM:Landroid/view/View;

    .line 71
    iget-boolean v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anT:Z

    if-nez v0, :cond_0

    .line 72
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->rs:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anP:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anN:Landroid/widget/RadioGroup;

    .line 79
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->akM:Lcom/android/settings/notification/ServiceListing;
    ...
    invoke-static {}, Lcom/android/settings/notification/ZenRuleNameDialog;->tE()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    invoke-static {}, Lcom/android/settings/notification/ZenRuleNameDialog;->tF()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    .line 82
    invoke-direct {p0}, Lcom/android/settings/notification/ZenRuleNameDialog;->tG()V

    .line 83
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->akM:Lcom/android/settings/notification/ServiceListing;

    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->amG:Lcom/android/settings/notification/ServiceListing$Callback;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anR:Landroid/util/ArraySet;
    ...
    .line 130
    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anR:Landroid/util/ArraySet;
    ...
    .line 86
    :cond_2
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anN:Landroid/widget/RadioGroup;
...
.method private a(ILcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;)V
    ...
    .line 148
    iget-object v1, p2, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->anV:Ljava/lang/String;
...
.method static synthetic b(Lcom/android/settings/notification/ZenRuleNameDialog;)Lcom/android/settings/notification/ServiceListing$Callback;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->amG:Lcom/android/settings/notification/ServiceListing$Callback;
...
.method static synthetic c(Lcom/android/settings/notification/ZenRuleNameDialog;)Ljava/lang/String;
    ...
    .prologue
    .line 46
    invoke-direct {p0}, Lcom/android/settings/notification/ZenRuleNameDialog;->tC()Ljava/lang/String;
...
.method static synthetic e(Lcom/android/settings/notification/ZenRuleNameDialog;)Ljava/lang/String;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anQ:Ljava/lang/String;
...
.method static synthetic f(Lcom/android/settings/notification/ZenRuleNameDialog;)Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    .prologue
    .line 46
    invoke-direct {p0}, Lcom/android/settings/notification/ZenRuleNameDialog;->tB()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
...
.method static synthetic g(Lcom/android/settings/notification/ZenRuleNameDialog;)V
    ...
    .prologue
    .line 46
    invoke-direct {p0}, Lcom/android/settings/notification/ZenRuleNameDialog;->tD()V
...
.method static synthetic h(Lcom/android/settings/notification/ZenRuleNameDialog;)[Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anS:[Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
...
.method private tB()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    .locals 2
    ...
    .line 157
    :cond_0
    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anN:Landroid/widget/RadioGroup;
...
.method private tD()V
    ...
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anR:Landroid/util/ArraySet;
    ...
    .line 172
    :goto_1
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anM:Landroid/view/View;
    ...
    .line 173
    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->rs:Landroid/widget/EditText;

    if-eqz v1, :cond_4

    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anO:Landroid/content/res/ColorStateList;
    ...
    .line 173
    :cond_4
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anP:Landroid/content/res/ColorStateList;

    goto :goto_3
.end method

.method private static tE()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    .locals 3
    ...
    iput-object v2, v1, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->anW:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->anX:Landroid/net/Uri;

    .line 184
    return-object v1
.end method

.method private static tF()Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    .locals 3
...
.method private tG()V
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleNameDialog;->anS:[Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
