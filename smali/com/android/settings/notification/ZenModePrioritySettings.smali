...
.field private anf:Landroid/preference/SwitchPreference;

.field private ang:Landroid/preference/SwitchPreference;

.field private anh:Lcom/android/settings/DropDownPreference;

.field private ani:Lcom/android/settings/DropDownPreference;

.field private anj:Landroid/preference/SwitchPreference;
...
.method static synthetic a(Lcom/android/settings/notification/ZenModePrioritySettings;)Z
    ...
    .prologue
    .line 32
    iget-boolean v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ane:Z
...
.method private qz()V
    ...
    .line 162
    iput-boolean v3, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ane:Z

    .line 163
    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ani:Lcom/android/settings/DropDownPreference;

    if-eqz v0, :cond_0

    .line 164
    iget-object v4, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ani:Lcom/android/settings/DropDownPreference;

    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->acm:Landroid/service/notification/ZenModeConfig;
    ...
    .line 166
    :cond_0
    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anh:Lcom/android/settings/DropDownPreference;

    iget-object v4, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->acm:Landroid/service/notification/ZenModeConfig;

    iget-boolean v4, v4, Landroid/service/notification/ZenModeConfig;->allowMessages:Z

    if-eqz v4, :cond_1

    iget-object v1, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->acm:Landroid/service/notification/ZenModeConfig;
    ...
    .line 167
    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anf:Landroid/preference/SwitchPreference;
    ...
    .line 168
    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ang:Landroid/preference/SwitchPreference;
    ...
    .line 169
    iget-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anj:Landroid/preference/SwitchPreference;
    ...
    .line 170
    iget-object v1, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anj:Landroid/preference/SwitchPreference;
    ...
    .line 172
    iput-boolean v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ane:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anf:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ang:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anh:Lcom/android/settings/DropDownPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->ani:Lcom/android/settings/DropDownPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->anj:Landroid/preference/SwitchPreference;
    ...
    sget v6, Lcom/android/internal/R$integer;->config_zen_repeat_callers_threshold:I
    ...
    .line 148
    invoke-direct {p0}, Lcom/android/settings/notification/ZenModePrioritySettings;->qz()V
