...
# instance fields
.field private Jj:Landroid/widget/ImageView;

.field private amu:I

.field private amv:Landroid/preference/SeekBarVolumizer;

.field private amw:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method static synthetic a(Lcom/android/settings/notification/VolumeSeekBarPreference;)Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amw:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method static synthetic b(Lcom/android/settings/notification/VolumeSeekBarPreference;)I
    ...
    .prologue
    .line 35
    iget v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amu:I
...
.method public a(Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;)V
    ...
    .prologue
    .line 67
    iput-object p1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amw:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method public cF(I)V
    ...
    .prologue
    .line 63
    iput p1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amu:I
...
.method public cG(I)V
    ...
    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->Jj:Landroid/widget/ImageView;
...
.method public onActivityStop()V
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amv:Landroid/preference/SeekBarVolumizer;
...
.method protected onBindView(Landroid/view/View;)V
    ...
    .line 86
    iget-object v1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->wH:Landroid/widget/SeekBar;

    if-eq v0, v1, :cond_0

    .line 87
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->wH:Landroid/widget/SeekBar;
    ...
    invoke-direct {p0}, Lcom/android/settings/notification/VolumeSeekBarPreference;->tf()Landroid/net/Uri;
    ...
    iget v3, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amu:I
    ...
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amv:Landroid/preference/SeekBarVolumizer;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->Jj:Landroid/widget/ImageView;

    .line 116
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amw:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;

    iget v1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->amu:I

    iget-object v2, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->wH:Landroid/widget/SeekBar;
