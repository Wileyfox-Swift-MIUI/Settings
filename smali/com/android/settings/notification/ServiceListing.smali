...
.field private final ami:Ljava/util/HashSet;
...
.field private final amm:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settings/notification/ManagedServiceSettings$Config;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ServiceListing;->ami:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ServiceListing;->amj:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ServiceListing;->amk:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ServiceListing;->xc:Landroid/database/ContentObserver;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ServiceListing;->amm:Landroid/content/BroadcastReceiver;

    .line 52
    iput-object p1, p0, Lcom/android/settings/notification/ServiceListing;->mContext:Landroid/content/Context;

    .line 53
    iput-object p2, p0, Lcom/android/settings/notification/ServiceListing;->akK:Lcom/android/settings/notification/ManagedServiceSettings$Config;
...
.method public static a(Lcom/android/settings/notification/ManagedServiceSettings$Config;Landroid/content/Context;)I
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ManagedServiceSettings$Config;->akQ:Ljava/lang/String;
...
.method private static a(Lcom/android/settings/notification/ManagedServiceSettings$Config;Ljava/util/List;Landroid/content/pm/PackageManager;)I
    ...
    iget-object v7, p0, Lcom/android/settings/notification/ManagedServiceSettings$Config;->akR:Ljava/lang/String;
...
.method private tc()V
    ...
    .line 141
    iget-object v0, p0, Lcom/android/settings/notification/ServiceListing;->ami:Ljava/util/HashSet;
    ...
    iget-object v0, p0, Lcom/android/settings/notification/ServiceListing;->akK:Lcom/android/settings/notification/ManagedServiceSettings$Config;

    iget-object v3, v0, Lcom/android/settings/notification/ManagedServiceSettings$Config;->akQ:Ljava/lang/String;
...
.method private td()V
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ServiceListing;->akK:Lcom/android/settings/notification/ManagedServiceSettings$Config;

    iget-object v1, v1, Lcom/android/settings/notification/ManagedServiceSettings$Config;->akQ:Ljava/lang/String;
    ...
    .line 161
    iget-object v3, p0, Lcom/android/settings/notification/ServiceListing;->ami:Ljava/util/HashSet;
...
.method public a(Landroid/content/ComponentName;Z)V
    ...
    .line 186
    :goto_0
    invoke-direct {p0}, Lcom/android/settings/notification/ServiceListing;->tc()V
...
.method public a(Lcom/android/settings/notification/ServiceListing$Callback;)V
    ...
    .prologue
    .line 58
    iget-object v0, p0, Lcom/android/settings/notification/ServiceListing;->amk:Ljava/util/List;
...
.method public setListening(Z)V
    ...
    .prologue
    .line 66
    iget-boolean v0, p0, Lcom/android/settings/notification/ServiceListing;->aml:Z
    ...
    .line 67
    :cond_0
    iput-boolean p1, p0, Lcom/android/settings/notification/ServiceListing;->aml:Z
    ...
    iget-object v2, p0, Lcom/android/settings/notification/ServiceListing;->amm:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, Lcom/android/settings/notification/ServiceListing;->xc:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ServiceListing;->amm:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ServiceListing;->xc:Landroid/database/ContentObserver;
...
.method public te()Ljava/util/List;
    ...
    .prologue
    .line 168
    invoke-direct {p0}, Lcom/android/settings/notification/ServiceListing;->td()V

    .line 169
    iget-object v0, p0, Lcom/android/settings/notification/ServiceListing;->akK:Lcom/android/settings/notification/ManagedServiceSettings$Config;

    iget-object v1, p0, Lcom/android/settings/notification/ServiceListing;->amj:Ljava/util/List;
    ...
    .line 171
    iget-object v2, p0, Lcom/android/settings/notification/ServiceListing;->amj:Ljava/util/List;

    invoke-interface {v0, v2}, Lcom/android/settings/notification/ServiceListing$Callback;->A(Ljava/util/List;)V

    goto :goto_0

    .line 173
    :cond_0
    iget-object v0, p0, Lcom/android/settings/notification/ServiceListing;->amj:Ljava/util/List;
