...
# instance fields
.field final synthetic ajW:Lcom/android/settings/d/c;

.field private final hQ:Landroid/net/NetworkTemplate;
...
.method public constructor <init>(Lcom/android/settings/d/c;Landroid/content/Context;Landroid/net/NetworkTemplate;)V
    ...
    .line 133
    iput-object p1, p0, Lcom/android/settings/d/e;->ajW:Lcom/android/settings/d/c;

    .line 134
    invoke-direct {p0, p2}, Landroid/preference/SwitchPreference;-><init>(Landroid/content/Context;)V

    .line 135
    iput-object p3, p0, Lcom/android/settings/d/e;->hQ:Landroid/net/NetworkTemplate;

    .line 137
    invoke-virtual {p0, v6}, Lcom/android/settings/d/e;->setPersistent(Z)V

    .line 139
    iput-boolean v7, p0, Lcom/android/settings/d/e;->if:Z
    ...
    .line 151
    :goto_0
    iput-boolean v6, p0, Lcom/android/settings/d/e;->if:Z
...
.method protected notifyChanged()V
    ...
    .line 157
    iget-boolean v0, p0, Lcom/android/settings/d/e;->if:Z

    if-nez v0, :cond_0

    .line 158
    iget-object v0, p0, Lcom/android/settings/d/e;->ajW:Lcom/android/settings/d/c;

    invoke-static {v0}, Lcom/android/settings/d/c;->a(Lcom/android/settings/d/c;)Lcom/android/settings/d/f;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings/d/e;->hQ:Landroid/net/NetworkTemplate;
