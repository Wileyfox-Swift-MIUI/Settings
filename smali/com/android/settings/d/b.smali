...
# instance fields
.field private final ajS:Landroid/net/INetworkStatsSession;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/INetworkStatsSession;Landroid/os/Bundle;)V
    ...
    .line 61
    iput-object p2, p0, Lcom/android/settings/d/b;->ajS:Landroid/net/INetworkStatsSession;
...
.method private a(Landroid/net/NetworkTemplate;IILandroid/net/NetworkStatsHistory;)Landroid/net/NetworkStatsHistory;
    ...
    .prologue
    .line 135
    iget-object v0, p0, Lcom/android/settings/d/b;->ajS:Landroid/net/INetworkStatsSession;
...
.method private b(Landroid/net/NetworkTemplate;Lcom/android/settings/DataUsageSummary$AppItem;I)Lcom/android/settings/d/a;
    ...
    iput-object v0, v2, Lcom/android/settings/d/a;->ajO:Landroid/net/NetworkStatsHistory;

    .line 91
    if-eqz p2, :cond_1

    .line 93
    iget-object v0, p2, Lcom/android/settings/DataUsageSummary$AppItem;->iB:Landroid/util/SparseBooleanArray;
    ...
    .line 95
    iget-object v4, p2, Lcom/android/settings/DataUsageSummary$AppItem;->iB:Landroid/util/SparseBooleanArray;
    ...
    .line 96
    iget-object v5, v2, Lcom/android/settings/d/a;->ajQ:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v5, v2, Lcom/android/settings/d/a;->ajQ:Landroid/net/NetworkStatsHistory;

    .line 98
    const/4 v5, 0x1

    iget-object v6, v2, Lcom/android/settings/d/a;->ajR:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v4, v2, Lcom/android/settings/d/a;->ajR:Landroid/net/NetworkStatsHistory;
    ...
    iget-object v1, v2, Lcom/android/settings/d/a;->ajR:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v0, v2, Lcom/android/settings/d/a;->ajP:Landroid/net/NetworkStatsHistory;

    .line 104
    iget-object v0, v2, Lcom/android/settings/d/a;->ajP:Landroid/net/NetworkStatsHistory;

    iget-object v1, v2, Lcom/android/settings/d/a;->ajQ:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v0, v2, Lcom/android/settings/d/a;->ajQ:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v0, v2, Lcom/android/settings/d/a;->ajR:Landroid/net/NetworkStatsHistory;
...
.method public synthetic loadInBackground()Ljava/lang/Object;
    ...
    .prologue
    .line 39
    invoke-virtual {p0}, Lcom/android/settings/d/b;->su()Lcom/android/settings/d/a;
...
.method public su()Lcom/android/settings/d/a;
    .locals 4
