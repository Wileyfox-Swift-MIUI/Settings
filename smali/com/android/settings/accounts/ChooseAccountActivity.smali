...
.field private Fe:Ljava/util/Map;

.field private Ff:[Landroid/accounts/AuthenticatorDescription;

.field private Fi:Ljava/util/HashMap;

.field private Fm:Landroid/preference/PreferenceGroup;

.field private final Fn:Ljava/util/ArrayList;

.field public Fo:Ljava/util/HashSet;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fn:Ljava/util/ArrayList;

    .line 67
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fi:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fe:Ljava/util/Map;
...
.method private am(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->CL:Landroid/os/UserHandle;
...
.method private jj()V
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ff:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 138
    invoke-virtual {p0, v4}, Lcom/android/settings/accounts/ChooseAccountActivity;->af(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v5

    .line 142
    invoke-virtual {p0, v4}, Lcom/android/settings/accounts/ChooseAccountActivity;->ad(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v6

    .line 144
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EF:[Ljava/lang/String;
    ...
    .line 146
    :goto_1
    iget-object v7, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EF:[Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fo:Ljava/util/HashSet;
    ...
    .line 158
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fn:Ljava/util/ArrayList;
    ...
    .line 166
    :cond_4
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fn:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/accounts/ChooseAccountActivity;->am(Ljava/lang/String;)V
    ...
    .line 171
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fm:Landroid/preference/PreferenceGroup;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/accounts/ChooseAccountActivity;->ae(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 181
    iget-object v3, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EF:[Ljava/lang/String;
...
.method private jl()V
    ...
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->CL:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ff:[Landroid/accounts/AuthenticatorDescription;

    .line 128
    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ff:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 129
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fe:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ff:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 131
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/accounts/ChooseAccountActivity;->jj()V
...
.method public ad(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 193
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fi:Ljava/util/HashMap;
    ...
    .line 195
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->CL:Landroid/os/UserHandle;
    ...
    .line 202
    iget-object v5, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fi:Ljava/util/HashMap;
...
.method protected ae(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 222
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fe:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->CL:Landroid/os/UserHandle;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EF:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fo:Ljava/util/HashSet;
    ...
    .line 111
    iget-object v4, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fo:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Fm:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->aY:Landroid/os/UserManager;
    ...
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->aY:Landroid/os/UserManager;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/settings/iH;->a(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->CL:Landroid/os/UserHandle;

    .line 118
    invoke-direct {p0}, Lcom/android/settings/accounts/ChooseAccountActivity;->jl()V
