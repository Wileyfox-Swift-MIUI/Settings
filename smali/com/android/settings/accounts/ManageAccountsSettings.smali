...
.field private Fr:Landroid/accounts/Account;
...
.method private a(Lcom/android/settings/i;)V
    .locals 7
    ...
    invoke-virtual {p1}, Lcom/android/settings/i;->getAccount()Landroid/accounts/Account;
    ...
    iget-object v1, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->CL:Landroid/os/UserHandle;
...
.method private a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    .line 565
    iget-object v1, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->tR:Lcom/android/settings/accounts/AuthenticatorHelper;

    iget-object v2, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/android/settings/accounts/AuthenticatorHelper;->ak(Ljava/lang/String;)Landroid/accounts/AuthenticatorDescription;
...
.method private ad(Z)V
    ...
    .line 234
    iget-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->CL:Landroid/os/UserHandle;
    ...
    .line 242
    instance-of v7, v0, Lcom/android/settings/i;

    if-eqz v7, :cond_2

    .line 243
    check-cast v0, Lcom/android/settings/i;

    invoke-virtual {v0}, Lcom/android/settings/i;->getAccount()Landroid/accounts/Account;
...
.method private b(Landroid/preference/PreferenceScreen;)V
    ...
    iget-object v5, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->CL:Landroid/os/UserHandle;
    ...
    iget-object v5, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->Fr:Landroid/accounts/Account;
...
.method private jw()V
    ...
    iget-object v2, v0, Lcom/android/settings/accounts/ManageAccountsSettings;->CL:Landroid/os/UserHandle;
    ...
    .line 299
    instance-of v3, v2, Lcom/android/settings/i;
    ...
    .line 303
    :cond_5
    check-cast v2, Lcom/android/settings/i;

    .line 304
    invoke-virtual {v2}, Lcom/android/settings/i;->getAccount()Landroid/accounts/Account;
    ...
    .line 308
    invoke-virtual {v2}, Lcom/android/settings/i;->u()Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/settings/i;->a(IZ)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings/i;->setSummary(Ljava/lang/CharSequence;)V
    ...
    iget-object v3, v0, Lcom/android/settings/accounts/ManageAccountsSettings;->EX:Landroid/widget/TextView;
...
.method private jx()V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->Fr:Landroid/accounts/Account;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/accounts/ManageAccountsSettings;->ad(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v4

    .line 402
    iget-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->EF:[Ljava/lang/String;
    ...
    .line 404
    iget-object v1, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->EF:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/accounts/ManageAccountsSettings;->ae(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 427
    iget-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->Fr:Landroid/accounts/Account;

    if-nez v0, :cond_1

    .line 428
    iput-object v2, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->Fr:Landroid/accounts/Account;
    ...
    .line 435
    invoke-direct {p0}, Lcom/android/settings/accounts/ManageAccountsSettings;->jy()V
...
.method public a(Landroid/os/UserHandle;)V
    ...
    .prologue
    .line 384
    invoke-direct {p0}, Lcom/android/settings/accounts/ManageAccountsSettings;->jx()V

    .line 385
    invoke-virtual {p0}, Lcom/android/settings/accounts/ManageAccountsSettings;->jk()V
...
.method protected jj()V
    ...
    .line 590
    instance-of v2, v0, Lcom/android/settings/i;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/accounts/ManageAccountsSettings;->af(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/android/settings/i;->setSummary(Ljava/lang/CharSequence;)V
...
.method protected jk()V
    ...
    .prologue
    .line 264
    invoke-direct {p0}, Lcom/android/settings/accounts/ManageAccountsSettings;->jw()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->EX:Landroid/widget/TextView;

    .line 144
    iget-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->EX:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->EF:[Ljava/lang/String;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    sget v1, Lcom/android/internal/R$drawable;->ic_menu_close_clear_cancel:I
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 224
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/settings/accounts/ManageAccountsSettings;->ad(Z)V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/accounts/ManageAccountsSettings;->ad(Z)V
...
.method public onPause()V
    ...
    .line 157
    iget-object v0, p0, Lcom/android/settings/accounts/ManageAccountsSettings;->tR:Lcom/android/settings/accounts/AuthenticatorHelper;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 178
    :cond_1
    instance-of v1, p2, Lcom/android/settings/i;

    if-eqz v1, :cond_0

    .line 180
    check-cast p2, Lcom/android/settings/i;

    invoke-direct {p0, p2}, Lcom/android/settings/accounts/ManageAccountsSettings;->a(Lcom/android/settings/i;)V
...
.method public onResume()V
    ...
    .line 120
    invoke-virtual {p0}, Lcom/android/settings/accounts/ManageAccountsSettings;->jl()V
