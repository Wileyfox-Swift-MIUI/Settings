...
# static fields
.field private static final adb:Ljava/util/HashMap;
...
.field private acz:Lmiui/app/Activity;

.field adc:Ljava/util/concurrent/ExecutorService;

.field add:Ljava/util/concurrent/Future;

.field private ade:Lmiui/preference/RadioButtonPreferenceCategory;

.field private adf:Landroid/preference/PreferenceCategory;

.field private adg:Landroid/view/MenuItem;

.field adh:Lcom/android/settings/dndmode/C;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/dndmode/v;->adb:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->adc:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->adh:Lcom/android/settings/dndmode/C;
...
.method static synthetic a(Lcom/android/settings/dndmode/v;)Lmiui/app/Activity;
    ...
    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->acz:Lmiui/app/Activity;
...
.method static synthetic access$100()Ljava/util/HashMap;
    ...
    .prologue
    .line 59
    sget-object v0, Lcom/android/settings/dndmode/v;->adb:Ljava/util/HashMap;
...
.method static synthetic b(Lcom/android/settings/dndmode/v;)V
    ...
    .prologue
    .line 59
    invoke-direct {p0}, Lcom/android/settings/dndmode/v;->qH()V
...
.method static synthetic c(Lcom/android/settings/dndmode/v;)V
    ...
    .prologue
    .line 59
    invoke-direct {p0}, Lcom/android/settings/dndmode/v;->qI()V
...
.method static synthetic d(Lcom/android/settings/dndmode/v;)Landroid/service/notification/ZenModeConfig;
    ...
    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->acm:Landroid/service/notification/ZenModeConfig;
...
.method private qF()V
    ...
    .line 148
    iget-object v1, p0, Lcom/android/settings/dndmode/v;->adc:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v1, v0}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/dndmode/v;->add:Ljava/util/concurrent/Future;
...
.method private qG()V
    ...
    .line 152
    iget-object v1, p0, Lcom/android/settings/dndmode/v;->acz:Lmiui/app/Activity;
    ...
    .line 153
    iget-object v1, p0, Lcom/android/settings/dndmode/v;->acm:Landroid/service/notification/ZenModeConfig;
    ...
    iget-object v4, p0, Lcom/android/settings/dndmode/v;->acz:Lmiui/app/Activity;
    ...
    .line 184
    iget-object v4, p0, Lcom/android/settings/dndmode/v;->ade:Lmiui/preference/RadioButtonPreferenceCategory;
    ...
    .line 186
    :cond_1
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->ade:Lmiui/preference/RadioButtonPreferenceCategory;
...
.method private qH()V
    ...
    .prologue
    .line 190
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->acr:Landroid/preference/PreferenceScreen;

    iget-object v1, p0, Lcom/android/settings/dndmode/v;->adf:Landroid/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    .line 191
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->adg:Landroid/view/MenuItem;
...
.method public a(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    .line 223
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->adf:Landroid/preference/PreferenceCategory;
    ...
    .line 227
    iget-object v1, p0, Lcom/android/settings/dndmode/v;->adh:Lcom/android/settings/dndmode/C;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->acz:Lmiui/app/Activity;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->acm:Landroid/service/notification/ZenModeConfig;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->acr:Landroid/preference/PreferenceScreen;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->ade:Lmiui/preference/RadioButtonPreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/v;->adf:Landroid/preference/PreferenceCategory;
    ...
    .line 106
    invoke-direct {p0}, Lcom/android/settings/dndmode/v;->qG()V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iput-object v2, p0, Lcom/android/settings/dndmode/v;->adg:Landroid/view/MenuItem;

    .line 288
    iget-object v2, p0, Lcom/android/settings/dndmode/v;->adg:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Lcom/android/settings/dndmode/v;->acm:Landroid/service/notification/ZenModeConfig;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 296
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/dndmode/v;->qJ()V
...
.method public onStop()V
    ...
    .line 118
    iget-object v0, p0, Lcom/android/settings/dndmode/v;->add:Ljava/util/concurrent/Future;
