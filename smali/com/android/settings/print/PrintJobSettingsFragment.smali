...
# instance fields
.field private aoa:Landroid/graphics/drawable/Drawable;

.field private final aob:Landroid/print/PrintManager$PrintJobStateChangeListener;

.field private aoc:Landroid/print/PrintManager;

.field private aod:Landroid/preference/Preference;

.field private aoe:Landroid/preference/Preference;

.field private aof:Landroid/print/PrintJobId;

.field private aog:Landroid/print/PrintJob;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aob:Landroid/print/PrintManager$PrintJobStateChangeListener;
...
.method static synthetic a(Lcom/android/settings/print/PrintJobSettingsFragment;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0}, Lcom/android/settings/print/PrintJobSettingsFragment;->aO()V
...
.method private aO()V
    ...
    .line 189
    invoke-direct {p0}, Lcom/android/settings/print/PrintJobSettingsFragment;->tI()Landroid/print/PrintJob;
    ...
    :goto_1
    :pswitch_0
    iget-object v7, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aod:Landroid/preference/Preference;
    ...
    iget-object v2, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoe:Landroid/preference/Preference;

    invoke-virtual {v1, v2}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    .line 253
    :cond_3
    iget-object v1, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoe:Landroid/preference/Preference;
    ...
    .line 207
    iget-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aod:Landroid/preference/Preference;
    ...
    iget-object v1, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoa:Landroid/graphics/drawable/Drawable;
...
.method private tH()V
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aof:Landroid/print/PrintJobId;

    .line 176
    iget-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aof:Landroid/print/PrintJobId;
...
.method private tI()Landroid/print/PrintJob;
    .locals 2

    .prologue
    .line 182
    iget-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aog:Landroid/print/PrintJob;

    if-nez v0, :cond_0

    .line 183
    iget-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoc:Landroid/print/PrintManager;

    iget-object v1, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aof:Landroid/print/PrintJobId;

    invoke-virtual {v0, v1}, Landroid/print/PrintManager;->getPrintJob(Landroid/print/PrintJobId;)Landroid/print/PrintJob;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aog:Landroid/print/PrintJob;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aod:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoe:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aoc:Landroid/print/PrintManager;

    .line 97
    invoke-direct {p0}, Lcom/android/settings/print/PrintJobSettingsFragment;->tH()V
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings/print/PrintJobSettingsFragment;->aob:Landroid/print/PrintManager$PrintJobStateChangeListener;
...
.method public onStart()V
    ...
    .line 113
    invoke-virtual {p0}, Lcom/android/settings/print/PrintJobSettingsFragment;->getActionBar()Lmiui/app/ActionBar;
