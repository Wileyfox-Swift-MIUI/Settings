...
.field private final aoA:Lcom/android/settings/print/s;

.field private aoB:Landroid/preference/PreferenceCategory;

.field private aoC:Landroid/preference/PreferenceCategory;

.field private aoD:Lcom/android/settings/print/p;

.field private aoE:Lcom/android/settings/iD;

.field private aoF:Landroid/widget/Button;

.field private mA:Landroid/widget/Spinner;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/print/PrintSettingsFragment;->ix:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->Do:Lcom/android/internal/content/PackageMonitor;
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoA:Lcom/android/settings/print/s;
...
.method static synthetic a(Lcom/android/settings/print/PrintSettingsFragment;)V
    ...
    .prologue
    .line 79
    invoke-direct {p0}, Lcom/android/settings/print/PrintSettingsFragment;->iR()V
...
.method static synthetic c(Lcom/android/settings/print/PrintSettingsFragment;)Landroid/preference/PreferenceCategory;
    ...
    .prologue
    .line 79
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoB:Landroid/preference/PreferenceCategory;
...
.method private iR()V
    ...
    iget-object v1, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoC:Landroid/preference/PreferenceCategory;
    ...
    .line 304
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoC:Landroid/preference/PreferenceCategory;
    ...
    .line 310
    :cond_7
    invoke-direct {p0}, Lcom/android/settings/print/PrintSettingsFragment;->tP()Landroid/preference/Preference;
...
.method private tP()Landroid/preference/Preference;
    .locals 3

    .prologue
    .line 318
    invoke-direct {p0}, Lcom/android/settings/print/PrintSettingsFragment;->tQ()Landroid/content/Intent;
...
.method private tQ()Landroid/content/Intent;
    .locals 3
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 374
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoF:Landroid/widget/Button;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoB:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoC:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoB:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoD:Lcom/android/settings/print/p;
    ...
    iget-object v2, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoD:Lcom/android/settings/print/p;
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 356
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoE:Lcom/android/settings/iD;

    invoke-virtual {v0, p3}, Lcom/android/settings/iD;->ap(I)Landroid/os/UserHandle;
    ...
    .line 363
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->mA:Landroid/widget/Spinner;
...
.method public onPause()V
    ...
    .prologue
    .line 185
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->Do:Lcom/android/internal/content/PackageMonitor;

    invoke-virtual {v0}, Lcom/android/internal/content/PackageMonitor;->unregister()V

    .line 186
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoA:Lcom/android/settings/print/s;

    invoke-virtual {p0}, Lcom/android/settings/print/PrintSettingsFragment;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/settings/print/s;->c(Landroid/content/ContentResolver;)V
...
.method public onResume()V
    ...
    .line 180
    invoke-direct {p0}, Lcom/android/settings/print/PrintSettingsFragment;->tR()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoF:Landroid/widget/Button;

    .line 202
    iget-object v1, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoF:Landroid/widget/Button;
    ...
    invoke-static {v0, v1}, Lcom/android/settings/iH;->a(Landroid/os/UserManager;Landroid/content/Context;)Lcom/android/settings/iD;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoE:Lcom/android/settings/iD;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/print/PrintSettingsFragment;->ah(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/Spinner;

    iput-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->mA:Landroid/widget/Spinner;

    .line 214
    iget-object v0, p0, Lcom/android/settings/print/PrintSettingsFragment;->mA:Landroid/widget/Spinner;

    iget-object v1, p0, Lcom/android/settings/print/PrintSettingsFragment;->aoE:Lcom/android/settings/iD;
