...
.field private pc:Lcom/android/settings/dK;
...
.method static synthetic a(Lcom/android/settings/KeyguardShortcutChooserSettings;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 18
    iput-object p1, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pe:Ljava/lang/String;
...
.method private ae()V
    ...
    .line 45
    new-instance v4, Lcom/android/settings/dJ;

    const/4 v1, 0x0

    invoke-direct {v4, v1}, Lcom/android/settings/dJ;-><init>(Lcom/android/settings/dI;)V
    ...
    iput-object v1, v4, Lcom/android/settings/dJ;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v4, Lcom/android/settings/dJ;->label:Ljava/lang/String;
    ...
    iput-object v0, v4, Lcom/android/settings/dJ;->pf:Ljava/lang/String;
...
.method static synthetic c(Lcom/android/settings/KeyguardShortcutChooserSettings;)Z
    ...
    .prologue
    .line 18
    iget-boolean v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pd:Z
...
.method static synthetic d(Lcom/android/settings/KeyguardShortcutChooserSettings;)Ljava/lang/String;
    ...
    .prologue
    .line 18
    iget-object v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pe:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic e(Lcom/android/settings/KeyguardShortcutChooserSettings;)Lcom/android/settings/dK;
    .locals 1

    .prologue
    .line 18
    iget-object v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pc:Lcom/android/settings/dK;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pd:Z
    ...
    iput-object v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pe:Ljava/lang/String;

    .line 33
    invoke-direct {p0}, Lcom/android/settings/KeyguardShortcutChooserSettings;->ae()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/dK;-><init>(Lcom/android/settings/KeyguardShortcutChooserSettings;Lcom/android/settings/dI;)V

    iput-object v0, p0, Lcom/android/settings/KeyguardShortcutChooserSettings;->pc:Lcom/android/settings/dK;
