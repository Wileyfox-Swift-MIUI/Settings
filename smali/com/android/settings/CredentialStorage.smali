...
# static fields
.field private static final gj:[I


# instance fields
.field private final dF:Landroid/security/KeyStore;

.field private gk:Landroid/os/Bundle;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/CredentialStorage;->gj:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;

    .line 125
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/settings/CredentialStorage;->gl:I
...
.method static synthetic a(Lcom/android/settings/CredentialStorage;I)I
    ...
    .prologue
    .line 92
    iput p1, p0, Lcom/android/settings/CredentialStorage;->gl:I
...
.method static synthetic a(Lcom/android/settings/CredentialStorage;)Landroid/security/KeyStore;
    ...
    .prologue
    .line 92
    iget-object v0, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
...
.method static synthetic access$400()[I
    ...
    .prologue
    .line 92
    sget-object v0, Lcom/android/settings/CredentialStorage;->gj:[I
...
.method static synthetic b(Lcom/android/settings/CredentialStorage;)I
    ...
    .prologue
    .line 92
    iget v0, p0, Lcom/android/settings/CredentialStorage;->gl:I
...
.method private bf()V
    ...
    .line 166
    :cond_0
    sget-object v0, Lcom/android/settings/ba;->gm:[I

    iget-object v1, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
    ...
    .line 168
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bg()V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/settings/be;-><init>(Lcom/android/settings/CredentialStorage;Lcom/android/settings/ba;)V

    goto :goto_0

    .line 176
    :pswitch_2
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bh()Z
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/settings/bb;-><init>(Lcom/android/settings/CredentialStorage;Lcom/android/settings/ba;)V

    goto :goto_0

    .line 180
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bi()V
...
.method private bg()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/bb;-><init>(Lcom/android/settings/CredentialStorage;Lcom/android/settings/ba;)V
    ...
    .line 201
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bk()Z
...
.method private bi()V
    ...
    .line 242
    iget-object v0, p0, Lcom/android/settings/CredentialStorage;->gk:Landroid/os/Bundle;
    ...
    .line 246
    :cond_1
    iget-object v3, p0, Lcom/android/settings/CredentialStorage;->gk:Landroid/os/Bundle;

    .line 247
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/CredentialStorage;->gk:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/CredentialStorage;->c([B)Z
    ...
    .line 281
    :goto_1
    iget-object v7, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
    ...
    .line 293
    iget-object v6, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
    ...
    iget-object v5, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
    ...
    iget-object v3, p0, Lcom/android/settings/CredentialStorage;->dF:Landroid/security/KeyStore;
...
.method private bk()Z
    ...
    invoke-virtual {v1, v3, v0, v3}, Lcom/android/settings/aL;->a(ILjava/lang/CharSequence;Z)Z
...
.method static synthetic d(Lcom/android/settings/CredentialStorage;)V
    ...
    .prologue
    .line 92
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bf()V
...
.method protected onResume()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/bc;-><init>(Lcom/android/settings/CredentialStorage;Lcom/android/settings/ba;)V
    ...
    invoke-direct {p0}, Lcom/android/settings/CredentialStorage;->bj()Z
