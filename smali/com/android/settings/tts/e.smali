...
# instance fields
.field private aiG:Landroid/widget/RadioButton;

.field private final avi:Lcom/android/settings/hs;

.field private final avj:Landroid/speech/tts/TextToSpeech$EngineInfo;

.field private final avk:Lcom/android/settings/tts/k;

.field private volatile avl:Z

.field private avm:Landroid/content/Intent;

.field private final avn:Landroid/widget/CompoundButton$OnCheckedChangeListener;

.field private bp:Landroid/view/View;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/speech/tts/TextToSpeech$EngineInfo;Lcom/android/settings/tts/k;Lcom/android/settings/hs;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/settings/tts/e;->avn:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    .line 108
    iput-object p3, p0, Lcom/android/settings/tts/e;->avk:Lcom/android/settings/tts/k;

    .line 109
    iput-object p4, p0, Lcom/android/settings/tts/e;->avi:Lcom/android/settings/hs;

    .line 110
    iput-object p2, p0, Lcom/android/settings/tts/e;->avj:Landroid/speech/tts/TextToSpeech$EngineInfo;

    .line 111
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/settings/tts/e;->avl:Z

    .line 113
    iget-object v0, p0, Lcom/android/settings/tts/e;->avj:Landroid/speech/tts/TextToSpeech$EngineInfo;
...
.method private a(Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    iget-object v2, p0, Lcom/android/settings/tts/e;->avj:Landroid/speech/tts/TextToSpeech$EngineInfo;
    ...
    iget-object v6, p0, Lcom/android/settings/tts/e;->avj:Landroid/speech/tts/TextToSpeech$EngineInfo;
...
.method private a(Landroid/widget/CompoundButton;Z)V
    ...
    .prologue
    .line 228
    iget-boolean v0, p0, Lcom/android/settings/tts/e;->avl:Z
    ...
    .line 234
    invoke-direct {p0}, Lcom/android/settings/tts/e;->vS()Z
    ...
    .line 252
    :cond_3
    iget-object v0, p0, Lcom/android/settings/tts/e;->bp:Landroid/view/View;
...
.method static synthetic b(Lcom/android/settings/tts/e;)Landroid/content/Intent;
    ...
    .prologue
    .line 43
    iget-object v0, p0, Lcom/android/settings/tts/e;->avm:Landroid/content/Intent;
...
.method private b(Landroid/widget/Checkable;)V
    ...
    .prologue
    .line 257
    iget-object v0, p0, Lcom/android/settings/tts/e;->avk:Lcom/android/settings/tts/k;

    invoke-interface {v0}, Lcom/android/settings/tts/k;->vQ()Landroid/widget/Checkable;
    ...
    invoke-interface {v0, v1}, Lcom/android/settings/tts/k;->cl(Ljava/lang/String;)V

    .line 262
    iget-object v0, p0, Lcom/android/settings/tts/e;->avk:Lcom/android/settings/tts/k;

    invoke-interface {v0}, Lcom/android/settings/tts/k;->vR()Ljava/lang/String;
...
.method static synthetic c(Lcom/android/settings/tts/e;)Lcom/android/settings/hs;
    .locals 1

    .prologue
    .line 43
    iget-object v0, p0, Lcom/android/settings/tts/e;->avi:Lcom/android/settings/hs;
...
.method public A(Landroid/content/Intent;)V
    ...
    .prologue
    .line 186
    iput-object p1, p0, Lcom/android/settings/tts/e;->avm:Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/android/settings/tts/e;->aiG:Landroid/widget/RadioButton;
...
.method public getView(Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 128
    iget-object v4, p0, Lcom/android/settings/tts/e;->avn:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iget-object v5, p0, Lcom/android/settings/tts/e;->avk:Lcom/android/settings/tts/k;

    invoke-interface {v5}, Lcom/android/settings/tts/k;->vR()Ljava/lang/String;
    ...
    .line 135
    :cond_1
    iput-boolean v1, p0, Lcom/android/settings/tts/e;->avl:Z

    .line 136
    invoke-virtual {v0, v4}, Landroid/widget/RadioButton;->setChecked(Z)V

    .line 137
    iput-boolean v2, p0, Lcom/android/settings/tts/e;->avl:Z

    .line 139
    iput-object v0, p0, Lcom/android/settings/tts/e;->aiG:Landroid/widget/RadioButton;
    ...
    iput-object v0, p0, Lcom/android/settings/tts/e;->bp:Landroid/view/View;

    .line 154
    iget-object v5, p0, Lcom/android/settings/tts/e;->bp:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/settings/tts/e;->aiG:Landroid/widget/RadioButton;
