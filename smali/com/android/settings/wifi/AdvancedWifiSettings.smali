...
# instance fields
.field private aBu:Landroid/net/NetworkScoreManager;

.field private aBv:Lcom/android/settings/AppListSwitchPreference;

.field private aBw:Landroid/app/Dialog;

.field private aBx:Landroid/preference/Preference;

.field private aBy:Landroid/preference/Preference;

.field private aBz:Landroid/preference/PreferenceCategory;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/wifi/d;-><init>(Lcom/android/settings/wifi/AdvancedWifiSettings;)V
...
.method static synthetic a(Lcom/android/settings/wifi/AdvancedWifiSettings;)V
    .locals 0

    .prologue
    .line 64
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->xK()V
...
.method private b(Ljava/util/Collection;)V
    ...
    .line 340
    :cond_0
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBv:Lcom/android/settings/AppListSwitchPreference;

    iget-object v1, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBu:Landroid/net/NetworkScoreManager;

    invoke-virtual {v1}, Landroid/net/NetworkScoreManager;->getActiveScorerPackage()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v2, v1}, Lcom/android/settings/AppListSwitchPreference;->a([Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method private jg()V
    ...
    check-cast v0, Lcom/android/settings/AppListSwitchPreference;

    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBv:Lcom/android/settings/AppListSwitchPreference;
    ...
    .line 210
    iget-object v4, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBv:Lcom/android/settings/AppListSwitchPreference;

    invoke-virtual {v4, p0}, Lcom/android/settings/AppListSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 211
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->b(Ljava/util/Collection;)V
    ...
    .line 244
    iget-object v4, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->jt:Landroid/net/wifi/WifiManager;
    ...
    .line 249
    invoke-direct {p0, v0, v4}, Lcom/android/settings/wifi/AdvancedWifiSettings;->b(Landroid/preference/Preference;I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->X(Ljava/lang/String;)V
...
.method private xK()V
    ...
    .line 493
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->jt:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 502
    invoke-static {v1}, Lcom/android/settings/iH;->aa(Landroid/content/Context;)Ljava/lang/String;
...
.method private xN()V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/wifi/ab;-><init>(Landroid/content/Context;)V

    .line 560
    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/settings/wifi/ab;->setMode(I)V

    .line 561
    const v1, 0x7f0a0e08

    invoke-virtual {v0, v1}, Lcom/android/settings/wifi/ab;->setTitle(I)V

    .line 562
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBw:Landroid/app/Dialog;

    .line 563
    invoke-virtual {v0}, Lcom/android/settings/wifi/ab;->show()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->jt:Landroid/net/wifi/WifiManager;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mV:Landroid/content/IntentFilter;

    .line 142
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mV:Landroid/content/IntentFilter;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBu:Landroid/net/NetworkScoreManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBx:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBy:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBz:Landroid/preference/PreferenceCategory;
...
.method public onDestroy()V
    ...
    .prologue
    .line 171
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBw:Landroid/app/Dialog;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 411
    iget-object v6, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->jt:Landroid/net/wifi/WifiManager;
    ...
    .line 412
    invoke-direct {p0, p1, v1}, Lcom/android/settings/wifi/AdvancedWifiSettings;->b(Landroid/preference/Preference;I)V
    :try_end_0
    ...
    .line 451
    invoke-direct {p0, p1, v1}, Lcom/android/settings/wifi/AdvancedWifiSettings;->a(Landroid/preference/Preference;Ljava/lang/String;)V
    :try_end_1
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBx:Landroid/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBy:Landroid/preference/Preference;
    ...
    .line 440
    :goto_3
    invoke-virtual {p0, v2}, Lcom/android/settings/wifi/AdvancedWifiSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 551
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->xN()V
    ...
    .line 553
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->xO()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/settings/wifi/AdvancedWifiSettings;->a(Landroid/app/Fragment;Ljava/lang/String;ILandroid/os/Bundle;I)Z
...
.method public onResume()V
    ...
    .line 151
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->jg()V
    ...
    .line 155
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->xL()V

    .line 156
    invoke-direct {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->xM()V
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mV:Landroid/content/IntentFilter;
    ...
    .line 157
    :cond_1
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBz:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBz:Landroid/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 159
    iput-object v2, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBx:Landroid/preference/Preference;

    .line 160
    iput-object v2, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBy:Landroid/preference/Preference;

    .line 161
    iput-object v2, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->aBz:Landroid/preference/PreferenceCategory;
