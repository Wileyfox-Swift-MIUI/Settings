...
# static fields
.field private static aEV:Z

.field private static aEW:Z
...
.method static constructor <clinit>()V
    ...
    .line 26
    sput-boolean v0, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEV:Z

    .line 27
    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEW:Z
...
.method private q(Landroid/content/Context;Z)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 111
    invoke-virtual {v5, v0, v1}, Lcom/android/settings/fE;->a(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/ScanResult;)Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 42
    sput-boolean v3, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEW:Z

    .line 43
    invoke-static {p1}, Lcom/android/settings/wifi/WifiConnectionDialog;->cM(Landroid/content/Context;)Z
    ...
    .line 46
    sput-boolean v2, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEW:Z
    ...
    .line 55
    sget-boolean v1, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEV:Z
    ...
    sget-boolean v0, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEV:Z
    ...
    .line 63
    sget-boolean v0, Lcom/android/settings/wifi/WifiConnectionReceiver;->aEW:Z

    if-nez v0, :cond_4

    invoke-static {p1}, Lcom/android/settings/wifi/WifiConnectionDialog;->cN(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lcom/android/settings/wifi/WifiConnectionDialog;->cL(Landroid/content/Context;)Z
