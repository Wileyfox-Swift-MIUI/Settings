...
# static fields
.field private static aHA:Landroid/app/Notification;

.field private static aHw:J

.field public static aHz:Ljava/lang/String;


# instance fields
.field protected final aHb:Ljava/lang/String;

.field protected final aHu:Ljava/lang/String;

.field private aHv:Landroid/net/Uri;

.field private aHx:Ljava/lang/String;

.field private aHy:Landroid/content/ServiceConnection;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHx:Ljava/lang/String;

    .line 105
    iput-object p1, p0, Lcom/android/settings/wifi/openwifi/l;->mContext:Landroid/content/Context;

    .line 106
    iput-object p2, p0, Lcom/android/settings/wifi/openwifi/l;->aHb:Ljava/lang/String;

    .line 107
    iput-object p3, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;
...
.method static synthetic a(Lcom/android/settings/wifi/openwifi/l;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 63
    iput-object p1, p0, Lcom/android/settings/wifi/openwifi/l;->aHx:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 461
    sget-object p1, Lcom/android/settings/wifi/MiuiWifiService;->aCI:Landroid/net/Uri;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/wifi/openwifi/l;
    ...
    .line 122
    :cond_1
    invoke-static {p3}, Lcom/android/settings/wifi/bm;->cF(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p3}, Lcom/android/settings/wifi/bm;->cG(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/android/settings/iH;->Y(Landroid/content/Context;)Z
    ...
    .line 125
    new-instance v0, Lcom/android/settings/wifi/openwifi/o;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/settings/wifi/openwifi/o;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static cR(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/android/b/e/a;->i(Landroid/net/wifi/ScanResult;)I
    ...
    .line 405
    invoke-virtual {v3, v1}, Lcom/android/settings/wifi/openwifi/l;->dU(I)Z
...
.method private static cS(Landroid/content/Context;)V
    ...
    .line 517
    invoke-static {v0}, Lcom/android/settings/wifi/bm;->b(Landroid/net/wifi/ScanResult;)Z
    ...
    invoke-static {p0, v0}, Lcom/android/settings/wifi/bm;->I(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/wifi/openwifi/l;
    .locals 1
...
.method private g(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v0, v2}, Lcom/android/settings/wifi/openwifi/n;->dT(I)V
...
.method public static m(Landroid/content/Context;Z)V
    ...
    .line 491
    invoke-static {p0}, Lcom/android/settings/wifi/openwifi/l;->cS(Landroid/content/Context;)V
    ...
    .line 496
    :cond_0
    sget-object v2, Lcom/android/settings/wifi/openwifi/l;->aHz:Ljava/lang/String;
    ...
    .line 497
    sget-object v1, Lcom/android/settings/wifi/openwifi/l;->aHA:Landroid/app/Notification;
    ...
    sput-wide v0, Lcom/android/settings/wifi/openwifi/l;->aHw:J
...
.method private zI()Ljava/lang/String;
    ...
    .line 281
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHx:Ljava/lang/String;
    ...
    .line 284
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/wifi/openwifi/l;->zJ()V
    ...
    iput-object v3, p0, Lcom/android/settings/wifi/openwifi/l;->aHy:Landroid/content/ServiceConnection;

    .line 303
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/settings/wifi/openwifi/l;->aHy:Landroid/content/ServiceConnection;
...
.method private zJ()V
    ...
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHy:Landroid/content/ServiceConnection;
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/openwifi/l;->aHy:Landroid/content/ServiceConnection;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHy:Landroid/content/ServiceConnection;

    goto :goto_0
.end method

.method public static zK()J
    .locals 2

    .prologue
    .line 334
    sget-wide v0, Lcom/android/settings/wifi/openwifi/l;->aHw:J
...
# virtual methods
.method public F(Ljava/lang/String;Ljava/lang/String;)Landroid/app/Notification;
    .locals 4
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;
...
.method public cH(Ljava/lang/String;)Landroid/app/Notification;
    .locals 5
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/settings/wifi/openwifi/l;->F(Ljava/lang/String;Ljava/lang/String;)Landroid/app/Notification;
...
.method public dU(I)Z
    ...
    .line 145
    iget-object v4, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;

    iput-object v4, v3, Landroid/net/wifi/WifiConfiguration;->SSID:Ljava/lang/String;

    .line 146
    iget-object v4, p0, Lcom/android/settings/wifi/openwifi/l;->aHb:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/openwifi/l;->aHb:Ljava/lang/String;
...
.method public getBssid()Ljava/lang/String;
    ...
    .prologue
    .line 342
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHb:Ljava/lang/String;
...
.method protected getPhoneNumber()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/fE;->L(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 255
    invoke-direct {p0}, Lcom/android/settings/wifi/openwifi/l;->zI()Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-static {v0}, Lcom/android/settings/wifi/openwifi/l;->cI(Ljava/lang/String;)Z
...
.method public getSsid()Ljava/lang/String;
    ...
    .prologue
    .line 346
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;
...
.method public h(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/wifi/openwifi/l;->F(Ljava/lang/String;Ljava/lang/String;)Landroid/app/Notification;

    .line 424
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/openwifi/l;->g(Ljava/util/ArrayList;)V

    .line 425
    invoke-virtual {p0}, Lcom/android/settings/wifi/openwifi/l;->zG()I
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/openwifi/l;->aHv:Landroid/net/Uri;

    iget-object v2, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/settings/wifi/openwifi/l;->aHb:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/openwifi/l;->cH(Ljava/lang/String;)Landroid/app/Notification;

    move-result-object v0

    sput-object v0, Lcom/android/settings/wifi/openwifi/l;->aHA:Landroid/app/Notification;

    .line 431
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;

    sput-object v0, Lcom/android/settings/wifi/openwifi/l;->aHz:Ljava/lang/String;
    ...
    .line 434
    invoke-direct {p0}, Lcom/android/settings/wifi/openwifi/l;->zP()V
...
.method public i(Landroid/net/Uri;)V
    ...
    .prologue
    .line 350
    iput-object p1, p0, Lcom/android/settings/wifi/openwifi/l;->aHv:Landroid/net/Uri;
...
.method public zM()Landroid/net/Uri;
    .locals 1

    .prologue
    .line 354
    iget-object v0, p0, Lcom/android/settings/wifi/openwifi/l;->aHv:Landroid/net/Uri;
...
.method public zO()Z
    ...
    .line 551
    iget-object v1, p0, Lcom/android/settings/wifi/openwifi/l;->aHu:Ljava/lang/String;
