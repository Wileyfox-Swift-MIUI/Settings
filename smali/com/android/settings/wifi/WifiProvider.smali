...
# static fields
.field private static final aFh:Landroid/content/UriMatcher;


# instance fields
.field private aFi:Lcom/android/settings/wifi/ap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/wifi/WifiProvider;->aFh:Landroid/content/UriMatcher;

    .line 27
    sget-object v0, Lcom/android/settings/wifi/WifiProvider;->aFh:Landroid/content/UriMatcher;
...
.method private h(Landroid/net/Uri;)V
    ...
    const-string v1, "com.xiaomi.permission.ACCESS_WIFI"
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 141
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/WifiProvider;->h(Landroid/net/Uri;)V

    .line 144
    iget-object v0, p0, Lcom/android/settings/wifi/WifiProvider;->aFi:Lcom/android/settings/wifi/ap;

    invoke-virtual {v0}, Lcom/android/settings/wifi/ap;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {p0, p2}, Lcom/android/settings/wifi/WifiProvider;->cD(Ljava/lang/String;)Ljava/lang/String;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 115
    sget-object v1, Lcom/android/settings/wifi/WifiProvider;->aFh:Landroid/content/UriMatcher;
...
.method public onCreate()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/wifi/ap;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/wifi/WifiProvider;->aFi:Lcom/android/settings/wifi/ap;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/ap;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 57
    :cond_0
    sget-object v2, Lcom/android/settings/wifi/WifiProvider;->aFh:Landroid/content/UriMatcher;
    ...
    invoke-direct {p0, p3}, Lcom/android/settings/wifi/WifiProvider;->cD(Ljava/lang/String;)Ljava/lang/String;
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v1, v3, v2, v0, p4}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 224
    :pswitch_4
    const-string v0, "share_upate_time"
    ...
    .line 231
    const-string v2, "share_upate_time"
