...
.field private aEU:Landroid/net/wifi/WifiConfiguration;
...
.method static cL(Landroid/content/Context;)Z
    .locals 6
...
.method static cN(Landroid/content/Context;)Z
    .locals 3
...
.method private getDialogTitle()Ljava/lang/CharSequence;
    ...
    iget v1, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aET:I

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aEU:Landroid/net/wifi/WifiConfiguration;
...
.method private getMessage()Ljava/lang/CharSequence;
    ...
    .line 85
    invoke-static {p0}, Lcom/android/settings/wifi/WifiConnectionDialog;->cN(Landroid/content/Context;)Z
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aEU:Landroid/net/wifi/WifiConfiguration;
    ...
    iget v2, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aET:I

    if-ne v1, v2, :cond_3

    .line 87
    iget-object v1, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aEU:Landroid/net/wifi/WifiConfiguration;
...
.method private oi()V
    ...
    .line 72
    invoke-static {p0}, Lcom/android/settings/wifi/WifiConnectionDialog;->cM(Landroid/content/Context;)Z
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 96
    iget v0, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aET:I
    ...
    .line 98
    invoke-direct {p0}, Lcom/android/settings/wifi/WifiConnectionDialog;->ze()V
    ...
    :goto_1
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/WifiConnectionDialog;->bO(Z)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/wifi/WifiConnectionDialog;->x(J)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 49
    iput v2, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aET:I
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aEU:Landroid/net/wifi/WifiConfiguration;
    ...
    iput v0, p0, Lcom/android/settings/wifi/WifiConnectionDialog;->aET:I
    ...
    .line 65
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/wifi/WifiConnectionDialog;->oi()V
