...
.field private aBE:Landroid/widget/TextView;

.field private aBF:I

.field private aBG:Landroid/widget/EditText;
...
.field uV:Landroid/net/wifi/WifiConfiguration;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBF:I

    .line 50
    const/4 v0, 0x0

    iput v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBJ:I
...
.method static synthetic a(Lcom/android/settings/wifi/EditTetherFragment;)I
    ...
    .prologue
    .line 33
    iget v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBJ:I
...
.method static synthetic a(Lcom/android/settings/wifi/EditTetherFragment;I)I
    ...
    .prologue
    .line 33
    iput p1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBJ:I
...
.method private validate()V
    ...
    .line 196
    iget-object v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBE:Landroid/widget/TextView;
    ...
    :cond_0
    iget v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBF:I

    if-ne v0, v2, :cond_2

    iget-object v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBG:Landroid/widget/EditText;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/EditTetherFragment;->bD(Z)V
    ...
    .line 201
    :cond_2
    invoke-virtual {p0, v2}, Lcom/android/settings/wifi/EditTetherFragment;->bD(Z)V
...
.method private xQ()V
    ...
    .line 207
    iget v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBF:I
...
.method private xR()V
    ...
    .prologue
    .line 215
    iget-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBH:Landroid/widget/ImageView;

    iget-boolean v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBI:Z
    ...
    .line 218
    iget-object v2, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBG:Landroid/widget/EditText;
...
.method public ak()V
    ...
    .prologue
    .line 180
    invoke-virtual {p0}, Lcom/android/settings/wifi/EditTetherFragment;->xP()Landroid/net/wifi/WifiConfiguration;
...
.method public onClick(Landroid/view/View;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBI:Z

    .line 231
    invoke-direct {p0}, Lcom/android/settings/wifi/EditTetherFragment;->xR()V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 252
    iput p3, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBF:I

    .line 253
    invoke-direct {p0}, Lcom/android/settings/wifi/EditTetherFragment;->xQ()V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBI:Z
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->uV:Landroid/net/wifi/WifiConfiguration;

    .line 63
    iget-object v0, p0, Lcom/android/settings/wifi/EditTetherFragment;->uV:Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-static {v0}, Lcom/android/settings/wifi/EditTetherFragment;->b(Landroid/net/wifi/WifiConfiguration;)I
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBE:Landroid/widget/TextView;

    .line 70
    iget-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBE:Landroid/widget/TextView;

    new-array v4, v3, [Landroid/text/InputFilter;

    new-instance v5, Lcom/android/settings/eq;

    const/16 v6, 0x20

    invoke-direct {v5, v6}, Lcom/android/settings/eq;-><init>(I)V
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBG:Landroid/widget/EditText;

    .line 73
    iget-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->uV:Landroid/net/wifi/WifiConfiguration;
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/EditTetherFragment;->uV:Landroid/net/wifi/WifiConfiguration;
    ...
    :goto_0
    iput v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBJ:I
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBE:Landroid/widget/TextView;
    ...
    .line 79
    iget-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBG:Landroid/widget/EditText;

    iget-object v3, p0, Lcom/android/settings/wifi/EditTetherFragment;->uV:Landroid/net/wifi/WifiConfiguration;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBH:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->jt:Landroid/net/wifi/WifiManager;

    .line 99
    iget-object v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->jt:Landroid/net/wifi/WifiManager;
    ...
    .line 113
    iget v1, p0, Lcom/android/settings/wifi/EditTetherFragment;->aBJ:I
