...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/WifiCallingSettings;->Dc:Z

    .line 62
    new-instance v0, Lcom/android/settings/iL;

    invoke-direct {v0, p0}, Lcom/android/settings/iL;-><init>(Lcom/android/settings/WifiCallingSettings;)V

    iput-object v0, p0, Lcom/android/settings/WifiCallingSettings;->yB:Landroid/telephony/PhoneStateListener;

    .line 132
    new-instance v0, Lcom/android/settings/iM;

    invoke-direct {v0, p0}, Lcom/android/settings/iM;-><init>(Lcom/android/settings/WifiCallingSettings;)V
...
.method static synthetic a(Lcom/android/settings/WifiCallingSettings;)Landroid/widget/Switch;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Lcom/android/settings/WifiCallingSettings;->tM:Landroid/widget/Switch;
...
.method private a(Landroid/content/Context;ZI)V
    ...
    .prologue
    .line 245
    iget-object v0, p0, Lcom/android/settings/WifiCallingSettings;->Da:Landroid/preference/ListPreference;

    invoke-static {p1, p3}, Lcom/android/settings/WifiCallingSettings;->k(Landroid/content/Context;I)I
    ...
    invoke-direct {p0}, Lcom/android/settings/WifiCallingSettings;->iH()Z
    ...
    .line 250
    iget-object v1, p0, Lcom/android/settings/WifiCallingSettings;->Da:Landroid/preference/ListPreference;
...
.method static synthetic a(Lcom/android/settings/WifiCallingSettings;Landroid/content/Intent;)V
    ...
    .prologue
    .line 45
    invoke-direct {p0, p1}, Lcom/android/settings/WifiCallingSettings;->r(Landroid/content/Intent;)V
...
.method static k(Landroid/content/Context;I)I
    ...
    .prologue
    .line 273
    sget v0, Lcom/android/internal/R$string;->wifi_calling_off_summary:I
    ...
    .line 277
    :pswitch_0
    sget v0, Lcom/android/internal/R$string;->wfc_mode_wifi_only_summary:I

    goto :goto_0

    .line 280
    :pswitch_1
    sget v0, Lcom/android/internal/R$string;->wfc_mode_cellular_preferred_summary:I

    goto :goto_0

    .line 283
    :pswitch_2
    sget v0, Lcom/android/internal/R$string;->wfc_mode_wifi_preferred_summary:I
...
.method public a(Landroid/widget/Switch;Z)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/WifiCallingSettings;->L()I
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/WifiCallingSettings;->mt:Lcom/android/settings/widget/SwitchBar;

    .line 101
    iget-object v0, p0, Lcom/android/settings/WifiCallingSettings;->mt:Lcom/android/settings/widget/SwitchBar;

    invoke-virtual {v0}, Lcom/android/settings/widget/SwitchBar;->xG()Lcom/android/settings/widget/ToggleSwitch;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/WifiCallingSettings;->tM:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Lcom/android/settings/WifiCallingSettings;->Db:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lcom/android/settings/WifiCallingSettings;->Db:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroid/widget/ListView;->setEmptyView(Landroid/view/View;)V

    .line 106
    iget-object v0, p0, Lcom/android/settings/WifiCallingSettings;->Db:Landroid/widget/TextView;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/WifiCallingSettings;->Da:Landroid/preference/ListPreference;
...
.method public onPause()V
    ...
    .line 214
    iget-boolean v0, p0, Lcom/android/settings/WifiCallingSettings;->Dc:Z

    if-eqz v0, :cond_0

    .line 215
    iput-boolean v3, p0, Lcom/android/settings/WifiCallingSettings;->Dc:Z
    ...
    .line 218
    iget-object v2, p0, Lcom/android/settings/WifiCallingSettings;->yB:Landroid/telephony/PhoneStateListener;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 260
    iget-object v2, p0, Lcom/android/settings/WifiCallingSettings;->Da:Landroid/preference/ListPreference;
    ...
    invoke-static {v1, v0}, Lcom/android/settings/WifiCallingSettings;->k(Landroid/content/Context;I)I
...
.method public onResume()V
    ...
    .line 179
    iget-object v4, p0, Lcom/android/settings/WifiCallingSettings;->yB:Landroid/telephony/PhoneStateListener;
    ...
    .line 183
    iput-boolean v1, p0, Lcom/android/settings/WifiCallingSettings;->Dc:Z
    ...
    .line 195
    :goto_0
    iget-object v1, p0, Lcom/android/settings/WifiCallingSettings;->tM:Landroid/widget/Switch;
    ...
    .line 197
    iget-object v4, p0, Lcom/android/settings/WifiCallingSettings;->Da:Landroid/preference/ListPreference;
    ...
    .line 204
    invoke-direct {p0, v0}, Lcom/android/settings/WifiCallingSettings;->r(Landroid/content/Intent;)V
